    ...
    <div class="projects-container">
        <div class="project-listing">
            ...
            <div class="detail-web-links">
                <a class="h:text-underline" href="https://www.visithalcyon.com" rel="noopener" target="_blank">visithalcyon.com</a>
            </div>
            <p>
        ...
        <div class="project-listing">
            ...
            <div class="detail-web-links">
                <a class="h:text-underline" href="https://www.stallionoilfield.com/" rel="noopener" target="_blank">stallionoilfield.com</a>
            </div>
            <p>
        ...
        <div class="project-listing">
            <p class="detail-preface skills-listing">React, Gatsby, GraphQL, Node Js, JavaScript, SASS, WordPress</p>
            <h3 class="detail-title">DI Repairs</h3>
            <div class="detail-web-links">
                <a class="h:text-underline" href="https://www.direpairs.com" rel="noopener" target="_blank">direpairs.com</a>
            </div>
            <p>
                As the only developer & designer I completely re-envisioned the site design & built the project from the ground up as an extremely performant SSG website.
            </p>
        </div>
        <div class="project-listing">
            <p class="detail-preface skills-listing">React, Redux, SCSS, JSX, SiteFinity, Stripe, Ucommerce</p>
            <h3 class="detail-title">Trinity Consulting</h3>
            <div class="detail-web-links">
                <a class="h:text-underline" href="https://www.trinityconsultants.com" rel="noopener" target="_blank">trinityconsultants.com</a>
            </div>
            <p>
                I was the Lead Front End Developer on the project. We redesigned their current website, and implemented multiple systems into a focused user experience.
            </p>
        </div>
        <div class="project-listing">
            ...
            <div class="detail-web-links">
                <a class="h:text-underline" href="https://www.uptexas.org" rel="noopener" target="_blank">uptexas.org</a>
            </div>
            <p>
        ...
        <div class="project-listing">
            ...
            <div class="detail-web-links">
                <a class="h:text-underline" href="https://www.creativerevolt.com" rel="noopener" target="_blank">creativerevolt.com</a>
            </div>
            <p>
