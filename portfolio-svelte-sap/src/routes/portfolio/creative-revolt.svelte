<script>
    ...
    let responsiveImg = {
        mobileSrc: '/images/creative-revolt/www.creativerevolt.com_(iPhone 6_7_8).png',
        tabletSrc: '/images/creative-revolt/www.creativerevolt.com_(iPad).png',
        desktopSrc: '/images/creative-revolt/www.creativerevolt.com_(iPad Pro).png'
    }
...
<section in:fadeIn>
    <div class="projects-container">
        <div bind:this={sections[0]} class="container">
            <SidePageHeroSection heroSrc={'/images/creative-revolt/www.creativerevolt.com_.png'} textHero={textHero} header={headerCta} text={textCta} />
        </div>
        <div bind:this={sections[1]} class="container">
            <SidePageTextLgImageSection textCta={textCta} headerCta={headerCta} lgImg={'/images/creative-revolt/screencapture-creativerevolt-about-2019-09-16-20_11_44.png'}  />
        </div>
