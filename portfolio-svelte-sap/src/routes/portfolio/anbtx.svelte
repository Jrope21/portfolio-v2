<script>
    ...
    let responsiveImg = {
        mobileSrc: '/images/anbtx/www.anbtx.com_mobile-deposit(iPhone 6_7_8).png',
        tabletSrc: '/images/anbtx/www.anbtx.com_mobile-deposit(iPad).png',
        desktopSrc: '/images/anbtx/www.anbtx.com_mobile-deposit(iPad Pro).png'
    }
...
<section in:fadeIn>
    <div class="projects-container">
        <div bind:this={sections[0]} class="container">
            <SidePageHeroSection heroSrc={'/images/anbtx/www.anbtx.com_mobile-deposit.png'} textHero={textHero} header={headerCta} text={textCta} />
        </div>
        <div bind:this={sections[1]} class="container">
            <SidePageTextLgImageSection textCta={textCta} headerCta={headerCta} lgImg={'/images/anbtx/www.anbtx.com_mobile-deposit(iPad Pro) (1).png'}  />
        </div>
