...
var app = (function () {
    ...
    const file$4 = "src/Components/FooterContainer.svelte";
    ...
    function create_fragment$4(ctx) {
    	var footer_1, div0, t0, div1, t1, div2, current;
    ...
    onMount(() => {
    	...
    	return { socialCtas, footer, footer_1_binding };
    }
    ...
    function create_fragment$5(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(span0, file$5, 71, 4, 1373);
    			attr(span1, "class", "svelte-1voz1ri");
    			add_location(span1, file$5, 73, 8, 1436);
    			attr(span2, "class", "svelte-1voz1ri");
    			add_location(span2, file$5, 74, 8, 1459);
    			attr(span3, "class", "letters svelte-1voz1ri");
    			add_location(span3, file$5, 72, 4, 1405);
    			attr(a, "class", "svelte-1voz1ri");
    			add_location(a, file$5, 70, 0, 1365);
    		},
    ...
    const file$6 = "src/Components/HeroImg.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file$6, 147, 4, 3061);
    			attr(span, "class", "gradient-animate svelte-194rokk");
    			add_location(span, file$6, 150, 5, 3113);
    			attr(div1, "class", "hero-image svelte-194rokk");
    			add_location(div1, file$6, 146, 0, 3032);
    		},
    ...
    const file$7 = "src/Components/HeroLeftText.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(span0, file$7, 102, 0, 1775);
    			attr(span1, "class", "svelte-3npmah");
    			add_location(span1, file$7, 103, 0, 1798);
    			attr(p, "class", "svelte-3npmah");
    			add_location(p, file$7, 101, 0, 1771);
    		},
    ...
    const file$8 = "src/Components/HeroRightText.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(span0, file$8, 73, 4, 1063);
    			attr(span1, "class", "seperator svelte-8nctdd");
    			add_location(span1, file$8, 73, 41, 1100);
    			attr(span2, "class", "text svelte-8nctdd");
    			add_location(span2, file$8, 74, 4, 1137);
    			attr(span3, "class", "seperator svelte-8nctdd");
    			add_location(span3, file$8, 74, 35, 1168);
    			attr(span4, "class", "text svelte-8nctdd");
    			add_location(span4, file$8, 75, 4, 1205);
    			attr(p, "class", "svelte-8nctdd");
    			add_location(p, file$8, 72, 0, 1055);
    		},
    ...
    const file$9 = "src/Components/HeroArrowDown.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(span, file$9, 71, 12, 1233);
    			attr(a, "href", "#");
    			attr(a, "class", "svelte-uzk7jb");
    			add_location(a, file$9, 71, 0, 1221);
    		},
    ...
    const file$a = "src/Components/HeroSocial.svelte";
    ...
    const file$b = "src/Components/HeroSection.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file$b, 22, 4, 517);
    			attr(div1, "class", "hero-text svelte-9k9vqb");
    			add_location(div1, file$b, 26, 4, 597);
    			attr(div2, "class", "hero-container center-all svelte-9k9vqb");
    			add_location(div2, file$b, 21, 0, 473);
    		},
    ...
    const file$c = "src/Components/SingleProjectText.svelte";
    ...
    function create_fragment$c(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(h2, file$c, 68, 4, 1253);
    			attr(h3, "class", "svelte-271wqk");
    			add_location(h3, file$c, 69, 4, 1278);
    			attr(p, "class", "svelte-271wqk");
    			add_location(p, file$c, 70, 4, 1320);
    			attr(span, "class", "circleIcon svelte-271wqk");
    			add_location(span, file$c, 75, 15, 1558);
    			attr(a, "href", "");
    			attr(a, "class", "svelte-271wqk");
    			add_location(a, file$c, 75, 4, 1547);
    			add_location(div, file$c, 67, 0, 1243);
    		},
    ...
    const file$d = "src/Components/SingleProjectImage.svelte";
    ...
    function create_fragment$d(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(img, file$d, 12, 0, 113);
    		},
    ...
    const file$e = "src/Components/SingleProjectSection.svelte";
    ...
    function create_fragment$e(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$e, 9, 0, 161);
    		},
    ...
    const file$f = "src/Components/MultiProjectCard.svelte";
    ...
    function create_fragment$f(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(img, file$f, 81, 6, 1688);
    			attr(div, "class", "img-container svelte-3sx4f4");
    			add_location(div, file$f, 80, 4, 1654);
    			attr(span, "class", "animateSick");
    			add_location(span, file$f, 83, 7, 1734);
    			attr(p, "class", "svelte-3sx4f4");
    			add_location(p, file$f, 83, 4, 1731);
    			attr(a, "class", "svelte-3sx4f4");
    			add_location(a, file$f, 79, 0, 1646);
    		},
    ...
    class MultiProjectCard extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$f, safe_not_equal, ["imgSrc", "projectName"]);
    ...
    const file$g = "src/Components/MultiProjectSection.svelte";
    ...
    function create_fragment$g(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(h2, file$g, 37, 4, 679);
    			attr(div0, "class", "card-container center-all svelte-mtja37");
    			add_location(div0, file$g, 38, 4, 705);
    			attr(div1, "class", "svelte-mtja37");
    			add_location(div1, file$g, 36, 0, 669);
    		},
    ...
    const file$h = "src/PageComponents/Home.svelte";
    ...
    function create_fragment$h(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(section0, file$h, 58, 0, 1490);
    			attr(section1, "class", "two center-all svelte-j6bcxt");
    			add_location(section1, file$h, 61, 0, 1554);
    			attr(section2, "class", "three center-all svelte-j6bcxt");
    			add_location(section2, file$h, 64, 0, 1627);
    		},
