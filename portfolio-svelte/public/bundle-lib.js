...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			label = element("label");
    			span = element("span");
    			attr(input, "class", "hide-for-medium hamburger-check svelte-4olvc0");
    			attr(input, "id", "hamburger");
    			attr(input, "name", "hamburger");
    			attr(input, "type", "checkbox");
    			add_location(input, file$1, 88, 0, 1970);
    			attr(span, "class", "hamburger-lines svelte-4olvc0");
    			add_location(span, file$1, 90, 4, 2156);
    			attr(label, "class", "hide-for-medium center-all svelte-4olvc0");
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			span2 = element("span");
    			span2.textContent = "R";
    			attr(span0, "class", "shape svelte-qezuix");
    			add_location(span0, file$3, 70, 4, 1354);
    			attr(span1, "class", "svelte-qezuix");
    			add_location(span1, file$3, 72, 8, 1417);
    			attr(span2, "class", "svelte-qezuix");
    			add_location(span2, file$3, 73, 8, 1440);
    			attr(span3, "class", "letters svelte-qezuix");
    			add_location(span3, file$3, 71, 4, 1386);
    			attr(a, "class", "svelte-qezuix");
    			add_location(a, file$3, 69, 0, 1346);
    		},
    ...
    function create_fragment$a(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(h2, file$a, 9, 4, 50);
    			add_location(h3, file$a, 10, 4, 75);
    			add_location(p, file$a, 11, 4, 117);
    			add_location(div, file$a, 8, 0, 40);
    		},
    ...
    const file$b = "src/Components/SingleProjectSection.svelte";
    ...
    const file$c = "src/PageComponents/Home.svelte";

    function create_fragment$c(ctx) {
    	var t0, t1, section0, t2, section1, current;
    	...
    	return {
    		c: function create() {
    			...
    			attr(section0, "class", "one center-all svelte-kc0mi");
    			add_location(section0, file$c, 36, 0, 864);
    			attr(section1, "class", "two center-all svelte-kc0mi");
    			add_location(section1, file$c, 39, 0, 928);
    		},
