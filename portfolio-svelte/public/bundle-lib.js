...
var app = (function () {
    ...
    function create_fragment$a(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			span = element("span");
    			t6 = text("Projects");
    			attr(h2, "class", "svelte-1gb29tn");
    			add_location(h2, file$a, 52, 4, 987);
    			attr(h3, "class", "svelte-1gb29tn");
    			add_location(h3, file$a, 53, 4, 1012);
    			add_location(p, file$a, 54, 4, 1054);
    			attr(span, "class", "circleIcon svelte-1gb29tn");
    			add_location(span, file$a, 59, 15, 1292);
    			attr(a, "href", "");
    			attr(a, "class", "svelte-1gb29tn");
    			add_location(a, file$a, 59, 4, 1281);
    			add_location(div, file$a, 51, 0, 977);
    		},
    ...
    function create_fragment$b(ctx) {
    	...
    	return {
    		c: function create() {
    			img = element("img");
    			attr(img, "src", "images/creativeShiz.png");
    			attr(img, "alt", "");
    ...
    const file$d = "src/PageComponents/Home.svelte";
    ...
    function create_fragment$d(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(section0, "class", "one center-all svelte-1wagz5c");
    			add_location(section0, file$d, 38, 0, 896);
    			attr(section1, "class", "two center-all svelte-1wagz5c");
    			add_location(section1, file$d, 41, 0, 960);
    		},
