...
const css$3 = {
	code: "a.svelte-uzax5l,div.svelte-uzax5l{max-width:100%}a.svelte-uzax5l{opacity:1}.img-container.svelte-uzax5l{position:relative;overflow:hidden;width:65vw;height:65vw;max-height:250px;box-shadow:3px 3px 3px lightgrey;transition:all .3s ease-in}@media screen and (min-width: 40em){.img-container.svelte-uzax5l{max-width:100%;width:25vw;height:25vw;max-width:350px;max-height:350px}.large.svelte-uzax5l .img-container.svelte-uzax5l{width:30vw;height:30vw;max-width:450px;max-height:450px}.full-width.svelte-uzax5l{width:100%}.full-width.svelte-uzax5l .img-container.svelte-uzax5l{width:calc(50% - 30vw + 60vw);height:30vw;margin:0 auto;max-width:1039px;max-height:450px}}a.svelte-uzax5l:hover .img-container.svelte-uzax5l{position:relative;transform:translateY(-3px);box-shadow:5px 5px 5px lightgrey}img.svelte-uzax5l{object-fit:cover;transition:all .3s ease-in;width:100%;height:100%}",
	map: "{\"version\":3,\"file\":\"Image.svelte\",\"sources\":[\"Image.svelte\"],\"sourcesContent\":[\"<script>\\nexport let imgSrc, alt;\\nexport let projectName;\\nexport let url;\\nexport let width;\\n</script>\\n\\n<style>\\n    a, div{\\n        max-width: 100%;\\n    }\\n\\n    a {\\n        opacity: 1;\\n    }\\n\\n    .img-container{\\n        position: relative;\\n        overflow: hidden;\\n        width: 65vw;\\n        height: 65vw;\\n        max-height: 250px;\\n        box-shadow: 3px 3px 3px lightgrey;\\n        transition: all .3s ease-in;\\n    }\\n\\n    @media screen and (min-width: 40em){\\n        .img-container{\\n            max-width:100%; \\n            width: 25vw;\\n            height: 25vw;\\n            max-width: 350px;\\n            max-height: 350px;\\n        } \\n\\n        .large .img-container {\\n            width: 30vw;\\n            height: 30vw;\\n            max-width: 450px;\\n            max-height: 450px;\\n        }\\n\\n        .full-width {\\n            width: 100%;\\n        }\\n\\n        .full-width .img-container { \\n            width: calc(50% - 30vw + 60vw);\\n            height: 30vw;\\n            margin: 0 auto;\\n            max-width: 1039px;\\n            max-height: 450px;\\n        }\\n    }\\n\\n    a:hover .img-container {\\n        position: relative;\\n        transform: translateY(-3px);\\n        box-shadow: 5px 5px 5px lightgrey;\\n    }\\n\\n    img {\\n        object-fit: cover;\\n        transition: all .3s ease-in;\\n        width: 100%;\\n        height: 100%;\\n    }\\n   \\n</style>\\n\\n<a target=\\\"blank\\\" class=\\\"{width}\\\" href=\\\"{url}\\\">\\n    <div class=\\\"img-container\\\">\\n      <img src=\\\"{imgSrc}\\\" alt=\\\"{alt}\\\">\\n    </div>\\n</a>\"],\"names\":[],\"mappings\":\"AAQI,eAAC,CAAE,iBAAG,CAAC,AACH,SAAS,CAAE,IAAI,AACnB,CAAC,AAED,CAAC,cAAC,CAAC,AACC,OAAO,CAAE,CAAC,AACd,CAAC,AAED,4BAAc,CAAC,AACX,QAAQ,CAAE,QAAQ,CAClB,QAAQ,CAAE,MAAM,CAChB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,KAAK,CACjB,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,SAAS,CACjC,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,OAAO,AAC/B,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,4BAAc,CAAC,AACX,UAAU,IAAI,CACd,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,SAAS,CAAE,KAAK,CAChB,UAAU,CAAE,KAAK,AACrB,CAAC,AAED,oBAAM,CAAC,cAAc,cAAC,CAAC,AACnB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,SAAS,CAAE,KAAK,CAChB,UAAU,CAAE,KAAK,AACrB,CAAC,AAED,WAAW,cAAC,CAAC,AACT,KAAK,CAAE,IAAI,AACf,CAAC,AAED,yBAAW,CAAC,cAAc,cAAC,CAAC,AACxB,KAAK,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,CAC9B,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,SAAS,CAAE,MAAM,CACjB,UAAU,CAAE,KAAK,AACrB,CAAC,AACL,CAAC,AAED,eAAC,MAAM,CAAC,cAAc,cAAC,CAAC,AACpB,QAAQ,CAAE,QAAQ,CAClB,SAAS,CAAE,WAAW,IAAI,CAAC,CAC3B,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,SAAS,AACrC,CAAC,AAED,GAAG,cAAC,CAAC,AACD,UAAU,CAAE,KAAK,CACjB,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,OAAO,CAC3B,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC\"}"
};
...
const Image = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<a target="blank" class="${escape(null_to_empty(width))} svelte-uzax5l"${add_attribute("href", url, 0)}>
	    <div class="img-container svelte-uzax5l">
	      <img${add_attribute("src", imgSrc, 0)}${add_attribute("alt", alt, 0)} class="svelte-uzax5l">
	    </div>
	</a>`;
});
...
const ImageGrid = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="image-grid svelte-4e5qhu">
	    ...
	    <div class="grid-element-container full-width svelte-4e5qhu">
	        ${validate_component(Image, 'Image').$$render($$result, {
		width: 'full-width',
		imgSrc: 'images/Jorden-Background-Gray.jpg',
		url: '',
	    ...
	    <div class="container footer-container svelte-ovb0i">
	        ...
	        <div class="right svelte-ovb0i">
	            ...
	            <div class="text-cta svelte-ovb0i">
	                ...
	                <a href="./images/resume-joshua-roper.pdf" download class="svelte-ovb0i">
