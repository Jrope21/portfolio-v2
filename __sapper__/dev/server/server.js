...
const css$8 = {
	code: "section.titles.svelte-1p9tzfs{margin-bottom:20rem}h1.svelte-1p9tzfs{color:#3B3B3B;font-weight:800;font-size:23px}h2.svelte-1p9tzfs{color:#3B3B3B;font-weight:800;font-size:18px;margin-bottom:5px;margin-top:-3px;opacity:.85}h3.svelte-1p9tzfs{display:flex;align-items:center;font-size:14px;font-weight:400;opacity:.8;margin-bottom:15px}h3.svelte-1p9tzfs::before{content:'';display:block;width:30px;border-bottom:3px solid black;margin-right:10px;opacity:.8}@media screen and (min-width: 40em){h1.svelte-1p9tzfs{font-size:28px}h2.svelte-1p9tzfs{font-size:22px;margin-bottom:7px}h3.svelte-1p9tzfs{margin-bottom:0}}@media screen and (min-width: 64em){h1.svelte-1p9tzfs{font-size:38px}h2.svelte-1p9tzfs{font-size:28px;margin-bottom:9px;margin-top:-5px}h3.svelte-1p9tzfs{font-size:18px}}@media screen and (min-width: 1366px){h1.svelte-1p9tzfs{font-size:45px}h2.svelte-1p9tzfs{font-size:38px}h3.svelte-1p9tzfs{font-size:23px}}",
	map: "{\"version\":3,\"file\":\"LogoText.svelte\",\"sources\":[\"LogoText.svelte\"],\"sourcesContent\":[\"<script>\\nexport let addClass;\\n</script>\\n\\n<style>\\nsection.titles {\\n    margin-bottom: 20rem;\\n}\\nh1 {\\n    color:#3B3B3B;\\n    font-weight: 800;\\n    font-size: 23px;\\n}\\nh2 {\\n    color:#3B3B3B;\\n    font-weight: 800;\\n    font-size: 18px;\\n    margin-bottom: 5px;\\n    margin-top: -3px;\\n    opacity: .85;\\n}\\n\\nh3 {\\n    display: flex;\\n    align-items: center;\\n    font-size: 14px;\\n    font-weight: 400;\\n    opacity: .8;\\n    margin-bottom: 15px;\\n}\\n\\nh3::before {\\n    content: '';\\n    display: block;\\n    width: 30px;\\n    border-bottom: 3px solid black;\\n    margin-right: 10px;\\n    opacity: .8;\\n}\\n\\n@media screen and (min-width: 40em){\\n    h1 {\\n        font-size: 28px;\\n    }\\n    h2 {\\n        font-size: 22px;\\n        margin-bottom: 7px;\\n    }\\n    h3 {\\n        margin-bottom: 0;\\n    }\\n}\\n\\n@media screen and (min-width: 64em) {\\n    h1 {\\n        font-size: 38px;\\n    }\\n    h2 {\\n        font-size: 28px;\\n        margin-bottom: 9px;\\n        margin-top: -5px;\\n    }\\n    h3 {\\n        font-size: 18px;\\n    }\\n}\\n\\n @media screen and (min-width: 1366px){\\n    h1 {\\n        font-size: 45px;\\n    }\\n    h2 {\\n        font-size: 38px;\\n    }\\n    h3 {\\n        font-size: 23px;\\n    }\\n }\\n</style>\\n\\n<section class=\\\"titles {addClass}\\\">\\n    <h1>Front End Developer</h1>\\n    <h2>React, Svelte, ES6</h2>\\n    <h3>Joshua Roper</h3>\\n</section>\"],\"names\":[],\"mappings\":\"AAKA,OAAO,OAAO,eAAC,CAAC,AACZ,aAAa,CAAE,KAAK,AACxB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,MAAM,OAAO,CACb,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,IAAI,AACnB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,MAAM,OAAO,CACb,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,IAAI,CACf,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,GAAG,AAChB,CAAC,AAED,EAAE,eAAC,CAAC,AACA,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,OAAO,CAAE,EAAE,CACX,aAAa,CAAE,IAAI,AACvB,CAAC,AAED,iBAAE,QAAQ,AAAC,CAAC,AACR,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CAC9B,YAAY,CAAE,IAAI,CAClB,OAAO,CAAE,EAAE,AACf,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,IAAI,AACnB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,IAAI,CACf,aAAa,CAAE,GAAG,AACtB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,aAAa,CAAE,CAAC,AACpB,CAAC,AACL,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACjC,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,IAAI,AACnB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,IAAI,CACf,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,IAAI,AACpB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,IAAI,AACnB,CAAC,AACL,CAAC,AAEA,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,CAAC,AACnC,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,IAAI,AACnB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,IAAI,AACnB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,IAAI,AACnB,CAAC,AACJ,CAAC\"}"
};
...
const LogoText = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="titles ${escape(addClass)} svelte-1p9tzfs">
	    <h1 class="svelte-1p9tzfs">Front End Developer</h1>
	    <h2 class="svelte-1p9tzfs">React, Svelte, ES6</h2>
	    <h3 class="svelte-1p9tzfs">Joshua Roper</h3>
	</section>`;
});
...
const Projects$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section>
	    <h2 class="headline">Projects</h2>
	    <div class="project-listing svelte-j5n2o9">
	        <p class="detail-preface skills-listing">Svelte, Sapper, JavaScript, Rollup, CSS, HTML</p>
	        <h3 class="detail-title svelte-j5n2o9">Personal Portfolio</h3>
	        <div class="detail-web-links svelte-j5n2o9">joshuaroper.com</div>
	        <p>
	            I created a personal portfolio website to showcase all of my recent works. I utilized advanced CSS animations, Svelte, and a static Sapper build.
	        </p>
	    </div>
	   <div class="project-listing svelte-j5n2o9">
	        <p class="detail-preface skills-listing">React, React Static, JavaScript, WebPack, SASS, JSX, WordPress</p>
	        <h3 class="detail-title svelte-j5n2o9">Halcyon</h3>
	        <div class="detail-web-links svelte-j5n2o9">visithalcyon.com</div>
	        <p>
	            As one of the Front End Developers on the project I was tasked with creating the movies, and events directory. I worked with multiple API’s, React Static, and developed clean code.
	        </p>
	    </div> 
	    <div class="project-listing svelte-j5n2o9">
	        <p class="detail-preface skills-listing">JavaScript, jQuery, SASS, Foundation, HTML, Kentico (CMS)</p>
	        <h3 class="detail-title svelte-j5n2o9">University Park</h3>
	        <div class="detail-web-links svelte-j5n2o9">uptexas.org</div>
	        <p>
	            I was the sole Front End Developer on the project, I implemented a dynamically generated content slider, filtered search, form verification, and multiple third party integrations.
	        </p>
	    </div>
	    <div class="project-listing svelte-j5n2o9">
	        <p class="detail-preface skills-listing">HTML, CSS, JavaScript, Jquery, WordPress, DiviBuilder</p>
	        <h3 class="detail-title svelte-j5n2o9">Creative Revolt</h3>
	        <div class="detail-web-links svelte-j5n2o9">creativerevolt.com</div>
	        <p>
	            This was a freelance project to completely rework the website layout and tailor the feel of the website to her personal writing style.
	        </p>
	    </div>
...
const Experience = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="experience container svelte-111e602">
	    <div class="left svelte-111e602">
	        ${validate_component(SideBar, 'SideBar').$$render($$result, {}, {}, {})}
	    </div>
	    <div class="right svelte-111e602">
