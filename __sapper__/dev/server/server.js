...
const css$j = {
	code: "@media screen and (min-width: 40em){.inner-container.svelte-mu6yvw{width:90%;margin:0 auto}}@media screen and (min-width: 40em){.project-description.svelte-mu6yvw{padding-left:12%;margin:50rem 0}}@media(min-width: 64em){.project-description.svelte-mu6yvw{margin:60rem 0}}.cta.svelte-mu6yvw{margin:60rem 0}@media(min-width: 40em){.cta.svelte-mu6yvw{margin:75rem 0;margin-left:15%}}@media(min-width: 64em){.cta.svelte-mu6yvw{margin:85rem 0;margin-left:17%}}.cta.svelte-mu6yvw p.svelte-mu6yvw{color:#58595b;font-size:18px;font-weight:600;font-style:italic}@media(min-width: 64em){.cta.svelte-mu6yvw p.svelte-mu6yvw{font-size:26px;font-weight:800}}.skills-container.svelte-mu6yvw{margin:40rem 0}@media(min-width: 40em){section.svelte-mu6yvw{padding-left:12%}}.project-detail.svelte-mu6yvw{margin-bottom:60px\n    }",
	map: "{\"version\":3,\"file\":\"creative-revolt.svelte\",\"sources\":[\"creative-revolt.svelte\"],\"sourcesContent\":[\"<script>\\nimport PageTransition from '../PageTransition.svelte';\\nimport PageTitle from '../../components/project-detail/PageTitle.svelte';\\nimport Description from '../../components/project-detail/Description.svelte';\\nimport Carousel from '../../components/project-detail/Carousel.svelte';\\nimport Skills from '../../components/project-detail/Skills.svelte';\\n\\n\\n\\nlet STATE = {\\n    title: `Creative Revolt`,\\n    url: 'https://www.creativerevolt.com',\\n    description: `This was a freelance project to <strong>rework the website layout</strong> and tailor the feel of the website to her personal writing style. I <strong>revamped the color palette</strong> to better match her personality, adjusted her website for <strong>SEO</strong>, and created the landing page as well as multiple pages across the platform.`,\\n    skills: ['JavaScript', 'CSS', 'HTML', 'PHP', 'DiviBuilder', 'WordPress', 'SEO', 'Googe Analytics', 'Canva', 'Adobe XD', 'MailChimp'],\\n    images: [\\n        {\\n            src: 'images/creative-revolt/home.png',\\n            visible: true,\\n            key: 0,\\n        },\\n        {\\n            src: 'images/creative-revolt/home-ctas.png',\\n            visible: false,\\n            key: 1,\\n        },\\n        {\\n            src: 'images/creative-revolt/about.png',\\n            visible: false,\\n            key: 2,\\n        },\\n        {\\n            src: 'images/creative-revolt/about-cta.png',\\n            visible: false,\\n            key: 3,\\n        },\\n        {\\n            src: 'images/creative-revolt/writing-class.png',\\n            visible: false,\\n            key: 4,\\n        },\\n    ]\\n}\\n\\n</script>\\n\\n<style>\\n    @media screen and (min-width: 40em){\\n        .inner-container {\\n            width: 90%;\\n            margin: 0 auto;\\n        }\\n    }\\n\\n    @media screen and (min-width: 40em){\\n        .project-description {\\n            padding-left: 12%;\\n            margin: 50rem 0;\\n        }\\n    }\\n\\n    @media (min-width: 64em) {\\n        .project-description {\\n            margin: 60rem 0;\\n        }\\n    }\\n    .cta {\\n        margin: 60rem 0;\\n    }\\n\\n    @media (min-width: 40em) {\\n        .cta {\\n            margin: 75rem 0;\\n            margin-left: 15%;\\n        }\\n    }\\n\\n    @media (min-width: 64em) {\\n        .cta {\\n            margin: 85rem 0;\\n            margin-left: 17%;\\n        }\\n    }\\n\\n    .cta p {\\n        color: #58595b;\\n        font-size: 18px;\\n        font-weight: 600;\\n        font-style: italic;\\n    }\\n\\n    @media (min-width: 64em) {\\n        .cta p {\\n            font-size: 26px;\\n            font-weight: 800;\\n        }\\n        \\n    }\\n\\n    .skills-container {\\n        margin: 40rem 0;\\n    }\\n\\n    @media (min-width: 40em) {\\n        section {\\n            padding-left: 12%;\\n        }\\n    }\\n    .project-detail {\\n        margin-bottom: 60px\\n    }\\n</style>\\n\\n<svelte:head>\\n\\t<title>Creative Revolt | Front End Developer - Joshua Roper</title>\\n</svelte:head>\\n\\n\\n<div class=\\\"project-detail\\\">\\n    <PageTransition>\\n        <div class=\\\"container\\\">\\n            <PageTitle title={'Creative Revolt'} />\\n            <div class=\\\"inner-container\\\">\\n                <Carousel images={STATE.images}/>\\n                <section class=\\\"project-description\\\">\\n                    <Description text={STATE.description} url={STATE.url} />  \\n                </section>\\n                <section class=\\\"skills-container\\\">\\n                    <Skills skills={STATE.skills}/>\\n                </section>\\n                <section class=\\\"cta\\\">\\n                    <p>Check The Site!</p>\\n                </section>\\n            </div>\\n        </div>\\n    </PageTransition>\\n</div>\"],\"names\":[],\"mappings\":\"AA8CI,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,gBAAgB,cAAC,CAAC,AACd,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,CAAC,CAAC,IAAI,AAClB,CAAC,AACL,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,oBAAoB,cAAC,CAAC,AAClB,YAAY,CAAE,GAAG,CACjB,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AACL,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,oBAAoB,cAAC,CAAC,AAClB,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AACL,CAAC,AACD,IAAI,cAAC,CAAC,AACF,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,IAAI,cAAC,CAAC,AACF,MAAM,CAAE,KAAK,CAAC,CAAC,CACf,WAAW,CAAE,GAAG,AACpB,CAAC,AACL,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,IAAI,cAAC,CAAC,AACF,MAAM,CAAE,KAAK,CAAC,CAAC,CACf,WAAW,CAAE,GAAG,AACpB,CAAC,AACL,CAAC,AAED,kBAAI,CAAC,CAAC,cAAC,CAAC,AACJ,KAAK,CAAE,OAAO,CACd,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,MAAM,AACtB,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,kBAAI,CAAC,CAAC,cAAC,CAAC,AACJ,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,AACpB,CAAC,AAEL,CAAC,AAED,iBAAiB,cAAC,CAAC,AACf,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,OAAO,cAAC,CAAC,AACL,YAAY,CAAE,GAAG,AACrB,CAAC,AACL,CAAC,AACD,eAAe,cAAC,CAAC,AACb,aAAa,CAAE,IAAI;IACvB,CAAC\"}"
};
...
const css$k = {
	code: "@media screen and (min-width: 40em){.inner-container.svelte-1riw4zc{width:90%;margin:0 auto}}@media screen and (min-width: 40em){.project-description.svelte-1riw4zc{padding-left:12%;margin:50rem 0}}@media(min-width: 64em){.project-description.svelte-1riw4zc{margin:60rem 0}}.cta.svelte-1riw4zc{margin:60rem 0}@media(min-width: 40em){.cta.svelte-1riw4zc{margin:75rem 0;margin-left:15%}}@media(min-width: 64em){.cta.svelte-1riw4zc{margin:85rem 0;margin-left:17%}}.cta.svelte-1riw4zc a.svelte-1riw4zc{color:#58595b;font-size:18px;font-weight:600;font-style:italic}@media(min-width: 64em){.cta.svelte-1riw4zc a.svelte-1riw4zc{font-size:26px;font-weight:800}}.skills-container.svelte-1riw4zc{margin:40rem 0}@media(min-width: 40em){section.svelte-1riw4zc{padding-left:12%}}.project-detail.svelte-1riw4zc{margin-bottom:60px\n    }",
	map: "{\"version\":3,\"file\":\"university-park.svelte\",\"sources\":[\"university-park.svelte\"],\"sourcesContent\":[\"<script>\\nimport PageTransition from '../PageTransition.svelte';\\nimport PageTitle from '../../components/project-detail/PageTitle.svelte';\\nimport Description from '../../components/project-detail/Description.svelte';\\nimport Carousel from '../../components/project-detail/Carousel.svelte';\\nimport Skills from '../../components/project-detail/Skills.svelte';\\n\\nlet STATE = {\\n    title: `University Park`,\\n    url: 'https://www.uptexas.org',\\n    description: `I was tasked with being the <strong>sole developer</strong> on a <strong>complete Front-End redesign</strong>. Keeping their current users in mind, the goal was to make the website feel more modern, and offer a better user experience when navigating to each individual page. Across the entire project I implemented several dynamically generated content pages / sliders, <strong>form verification</strong>, and several <strong>third party integrations</strong>.`,\\n    skills: ['Javascript (ES6+)', 'jQuery', 'API Integration', 'AJAX / JSON', 'SASS / SCSS', 'CSS', 'Foundation', 'HTML (WCAG 2.1)', 'Adobe Illustrator', 'SEO', 'Kentico (CMS)', 'BitBucket'],\\n    images: [\\n        {\\n            src: 'images/university-park/home.png',\\n            visible: true,\\n            key: 0,\\n        },\\n        \\n        {\\n            src: 'images/university-park/library.png',\\n            visible: false,\\n            key: 1,\\n        },\\n        {\\n            src: 'images/university-park/home-video.png',\\n            visible: false,\\n            key: 2,\\n        },\\n        {\\n            src: 'images/university-park/form.png',\\n            visible: false,\\n            key: 3,\\n        },\\n        {\\n            src: 'images/university-park/newsletter.png',\\n            visible: false,\\n            key: 4,\\n        },\\n    ]\\n}\\n\\n// {\\n//     url: 'https://www.uptexas.org',\\n//     imgSrc: 'images/uptexas-thumb.jpg',\\n//     alt: 'Thumbnail for the City of University Park complete Front End website redesign',\\n//     projectName: 'University Park',\\n//     projectYear: '2019',\\n//     projectText: `I was tasked with being the <strong>sole developer</strong> on a <strong>complete Front-End redesign</strong>. Keeping their current users in mind, the goal was to make the website feel more modern, and offer a better user experience when navigating to each individual page. Across the entire project I implemented several dynamically generated content pages / sliders, <strong>form verification</strong>, and several <strong>third party integrations</strong>.`,\\n// },\\n</script>\\n\\n<style>\\n    @media screen and (min-width: 40em){\\n        .inner-container {\\n            width: 90%;\\n            margin: 0 auto;\\n        }\\n    }\\n\\n    @media screen and (min-width: 40em){\\n        .project-description {\\n            padding-left: 12%;\\n            margin: 50rem 0;\\n        }\\n    }\\n\\n    @media (min-width: 64em) {\\n        .project-description {\\n            margin: 60rem 0;\\n        }\\n    }\\n    .cta {\\n        margin: 60rem 0;\\n    }\\n\\n    @media (min-width: 40em) {\\n        .cta {\\n            margin: 75rem 0;\\n            margin-left: 15%;\\n        }\\n    }\\n\\n    @media (min-width: 64em) {\\n        .cta {\\n            margin: 85rem 0;\\n            margin-left: 17%;\\n        }\\n    }\\n\\n    .cta a {\\n        color: #58595b;\\n        font-size: 18px;\\n        font-weight: 600;\\n        font-style: italic;\\n    }\\n\\n    @media (min-width: 64em) {\\n        .cta a {\\n            font-size: 26px;\\n            font-weight: 800;\\n        }\\n        \\n    }\\n\\n    .skills-container {\\n        margin: 40rem 0;\\n    }\\n\\n    @media (min-width: 40em) {\\n        section {\\n            padding-left: 12%;\\n        }\\n    }\\n    .project-detail {\\n        margin-bottom: 60px\\n    }\\n</style>\\n\\n<svelte:head>\\n\\t<title>Creative Revolt | Front End Developer - Joshua Roper</title>\\n</svelte:head>\\n\\n\\n<div class=\\\"project-detail\\\">\\n    <PageTransition>\\n        <div class=\\\"container\\\">\\n            <PageTitle title={STATE.title} />\\n            <div class=\\\"inner-container\\\">\\n                <Carousel images={STATE.images}/>\\n                <section class=\\\"project-description\\\">\\n                    <Description text={STATE.description} url={STATE.url} />    \\n                </section>\\n                <section class=\\\"skills-container\\\">\\n                    <Skills skills={STATE.skills}/>\\n                </section>\\n                <section class=\\\"cta\\\">\\n                    <a href={STATE.url} target=\\\"blank\\\">Check The Site!</a>\\n                </section>\\n            </div>\\n        </div>\\n    </PageTransition>\\n</div>\"],\"names\":[],\"mappings\":\"AAqDI,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,gBAAgB,eAAC,CAAC,AACd,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,CAAC,CAAC,IAAI,AAClB,CAAC,AACL,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,oBAAoB,eAAC,CAAC,AAClB,YAAY,CAAE,GAAG,CACjB,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AACL,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,oBAAoB,eAAC,CAAC,AAClB,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AACL,CAAC,AACD,IAAI,eAAC,CAAC,AACF,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,IAAI,eAAC,CAAC,AACF,MAAM,CAAE,KAAK,CAAC,CAAC,CACf,WAAW,CAAE,GAAG,AACpB,CAAC,AACL,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,IAAI,eAAC,CAAC,AACF,MAAM,CAAE,KAAK,CAAC,CAAC,CACf,WAAW,CAAE,GAAG,AACpB,CAAC,AACL,CAAC,AAED,mBAAI,CAAC,CAAC,eAAC,CAAC,AACJ,KAAK,CAAE,OAAO,CACd,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,MAAM,AACtB,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,mBAAI,CAAC,CAAC,eAAC,CAAC,AACJ,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,AACpB,CAAC,AAEL,CAAC,AAED,iBAAiB,eAAC,CAAC,AACf,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,OAAO,eAAC,CAAC,AACL,YAAY,CAAE,GAAG,AACrB,CAAC,AACL,CAAC,AACD,eAAe,eAAC,CAAC,AACb,aAAa,CAAE,IAAI;IACvB,CAAC\"}"
};
...
// },
	...
	<div class="project-detail svelte-1riw4zc">
	    ${validate_component(PageTransition, 'PageTransition').$$render($$result, {}, {}, {
		default: () => `
	        <div class="container">
	            ${validate_component(PageTitle, 'PageTitle').$$render($$result, { title: STATE.title }, {}, {})}
	            <div class="inner-container svelte-1riw4zc">
	                ${validate_component(Carousel, 'Carousel').$$render($$result, { images: STATE.images }, {}, {})}
	                <section class="project-description svelte-1riw4zc">
	                    ${validate_component(Description, 'Description').$$render($$result, { text: STATE.description, url: STATE.url }, {}, {})}    
	                </section>
	                <section class="skills-container svelte-1riw4zc">
	                    ${validate_component(Skills, 'Skills').$$render($$result, { skills: STATE.skills }, {}, {})}
	                </section>
	                <section class="cta svelte-1riw4zc">
	                    <a${add_attribute("href", STATE.url, 0)} target="blank" class="svelte-1riw4zc">Check The Site!</a>
	                </section>
	            </div>
	        </div>
	    `
...
const css$l = {
	code: "@media screen and (min-width: 40em){.inner-container.svelte-1riw4zc{width:90%;margin:0 auto}}@media screen and (min-width: 40em){.project-description.svelte-1riw4zc{padding-left:12%;margin:50rem 0}}@media(min-width: 64em){.project-description.svelte-1riw4zc{margin:60rem 0}}.cta.svelte-1riw4zc{margin:60rem 0}@media(min-width: 40em){.cta.svelte-1riw4zc{margin:75rem 0;margin-left:15%}}@media(min-width: 64em){.cta.svelte-1riw4zc{margin:85rem 0;margin-left:17%}}.cta.svelte-1riw4zc a.svelte-1riw4zc{color:#58595b;font-size:18px;font-weight:600;font-style:italic}@media(min-width: 64em){.cta.svelte-1riw4zc a.svelte-1riw4zc{font-size:26px;font-weight:800}}.skills-container.svelte-1riw4zc{margin:40rem 0}@media(min-width: 40em){section.svelte-1riw4zc{padding-left:12%}}.project-detail.svelte-1riw4zc{margin-bottom:60px\n    }",
	map: "{\"version\":3,\"file\":\"halcyon.svelte\",\"sources\":[\"halcyon.svelte\"],\"sourcesContent\":[\"<script>\\nimport PageTransition from '../PageTransition.svelte';\\nimport PageTitle from '../../components/project-detail/PageTitle.svelte';\\nimport Description from '../../components/project-detail/Description.svelte';\\nimport Carousel from '../../components/project-detail/Carousel.svelte';\\nimport Skills from '../../components/project-detail/Skills.svelte';\\n\\n\\nlet STATE = {\\n    title: `Halcyon`,\\n    url: 'https://www.visithalcyon.com',\\n    description: `I was one of the Front End Developers on the project primarily tasked with creating the movies page and events directory. Across the project I worked with <strong>multiple API’s</strong>, <strong>React Static</strong>, and developed <strong>clean code</strong> for other advanced React components.`,\\n    skills: ['React', 'React Static', 'JavaScript (ES6)', 'WordPress REST API', 'iShowtimes API', `Google API's`, 'AJAX / JSON', 'Bootstrap (React Bootstrap)', 'SCSS / SCSS', 'PostCSS', 'JSX (HTML WCAG 2.1)', 'PHP', 'WordPress', 'Adobe XD'],\\n    images: [\\n        {\\n            src: 'images/halcyon/home-cta.png',\\n            visible: true,\\n            key: 0,\\n        },\\n        {\\n            src: 'images/halcyon/home.png',\\n            visible: false,\\n            key: 1,\\n        },\\n        {\\n            src: 'images/halcyon/dining.png',\\n            visible: false,\\n            key: 2,\\n        },\\n        {\\n            src: 'images/halcyon/events.png',\\n            visible: false,\\n            key: 3,\\n        },\\n        {\\n            src: 'images/halcyon/spotlight.png',\\n            visible: false,\\n            key: 4,\\n        }, \\n    ]\\n}\\n\\n\\n// {\\n//     url: 'https://www.visithalcyon.com',\\n//     imgSrc: 'images/halcyon-5.jpg',\\n//     alt: 'Thumbnail for the Halcyon mall website rebuild',\\n//     projectName: 'Halcyon',\\n//     projectYear: '2019',\\n//     projectText: `I was one of the Front End Developers on the project primarily tasked with creating the movies page and events directory. Across the project I worked with <strong>multiple API’s</strong>, <strong>React Static</strong>, and developed <strong>clean code</strong> for other advanced React components.`\\n// },\\n</script>\\n\\n<style>\\n    @media screen and (min-width: 40em){\\n        .inner-container {\\n            width: 90%;\\n            margin: 0 auto;\\n        }\\n    }\\n\\n    @media screen and (min-width: 40em){\\n        .project-description {\\n            padding-left: 12%;\\n            margin: 50rem 0;\\n        }\\n    }\\n\\n    @media (min-width: 64em) {\\n        .project-description {\\n            margin: 60rem 0;\\n        }\\n    }\\n    .cta {\\n        margin: 60rem 0;\\n    }\\n\\n    @media (min-width: 40em) {\\n        .cta {\\n            margin: 75rem 0;\\n            margin-left: 15%;\\n        }\\n    }\\n\\n    @media (min-width: 64em) {\\n        .cta {\\n            margin: 85rem 0;\\n            margin-left: 17%;\\n        }\\n    }\\n\\n    .cta a {\\n        color: #58595b;\\n        font-size: 18px;\\n        font-weight: 600;\\n        font-style: italic;\\n    }\\n\\n    @media (min-width: 64em) {\\n        .cta a {\\n            font-size: 26px;\\n            font-weight: 800;\\n        }\\n        \\n    }\\n\\n    .skills-container {\\n        margin: 40rem 0;\\n    }\\n\\n    @media (min-width: 40em) {\\n        section {\\n            padding-left: 12%;\\n        }\\n    }\\n    .project-detail {\\n        margin-bottom: 60px\\n    }\\n</style>\\n\\n<svelte:head>\\n\\t<title>Creative Revolt | Front End Developer - Joshua Roper</title>\\n</svelte:head>\\n\\n\\n<div class=\\\"project-detail\\\">\\n    <PageTransition>\\n        <div class=\\\"container\\\">\\n            <PageTitle title={STATE.title} />\\n            <div class=\\\"inner-container\\\">\\n                <Carousel images={STATE.images}/>\\n                <section class=\\\"project-description\\\">\\n                    <Description text={STATE.description} url={STATE.url} /> \\n                </section>\\n                <section class=\\\"skills-container\\\">\\n                    <Skills skills={STATE.skills} />\\n                </section>\\n                <section class=\\\"cta\\\">\\n                    <a href={STATE.url} target=\\\"blank\\\">Check The Site!</a>\\n                </section>\\n            </div>\\n        </div>\\n    </PageTransition>\\n</div>\"],\"names\":[],\"mappings\":\"AAsDI,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,gBAAgB,eAAC,CAAC,AACd,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,CAAC,CAAC,IAAI,AAClB,CAAC,AACL,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,oBAAoB,eAAC,CAAC,AAClB,YAAY,CAAE,GAAG,CACjB,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AACL,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,oBAAoB,eAAC,CAAC,AAClB,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AACL,CAAC,AACD,IAAI,eAAC,CAAC,AACF,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,IAAI,eAAC,CAAC,AACF,MAAM,CAAE,KAAK,CAAC,CAAC,CACf,WAAW,CAAE,GAAG,AACpB,CAAC,AACL,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,IAAI,eAAC,CAAC,AACF,MAAM,CAAE,KAAK,CAAC,CAAC,CACf,WAAW,CAAE,GAAG,AACpB,CAAC,AACL,CAAC,AAED,mBAAI,CAAC,CAAC,eAAC,CAAC,AACJ,KAAK,CAAE,OAAO,CACd,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,MAAM,AACtB,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,mBAAI,CAAC,CAAC,eAAC,CAAC,AACJ,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,AACpB,CAAC,AAEL,CAAC,AAED,iBAAiB,eAAC,CAAC,AACf,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,OAAO,eAAC,CAAC,AACL,YAAY,CAAE,GAAG,AACrB,CAAC,AACL,CAAC,AACD,eAAe,eAAC,CAAC,AACb,aAAa,CAAE,IAAI;IACvB,CAAC\"}"
};
		...
		<header class="svelte-1j8jpxc">
			...
			this: $$value => { hamburger = $$value; $$settled = false; }
		        ...
		        <ul class="navigation ${escape(showModal ? 'modal-active' : '')} svelte-1j8jpxc">
		            ...
		            <li class="${escape(null_to_empty(activeNavigation.home ? 'selected' : ''))} svelte-1j8jpxc"><a rel="prefetch" href="/" class="svelte-1j8jpxc">Home</a></li>
		            <li class="${escape(null_to_empty(activeNavigation.about ? 'selected' : ''))} svelte-1j8jpxc"><a rel="prefetch" href="/about" class="svelte-1j8jpxc">About</a></li>
		            <li class="${escape(null_to_empty(activeNavigation.experience ? 'selected' : ''))} svelte-1j8jpxc"><a href="/experience" class="svelte-1j8jpxc">Experience</a></li>
...
const css$y = {
	code: "footer.svelte-1hk8i84{border-top:1px solid #d6d6d6;background:white;color:#3B3B3B}.footer-container.svelte-1hk8i84{margin-top:40px;display:flex;flex-direction:column;padding-bottom:0}@media screen and (min-width: 40em){.footer-container.svelte-1hk8i84{flex-direction:row}}.left.svelte-1hk8i84,.right.svelte-1hk8i84{margin-bottom:55rem}@media screen and (min-width: 40em){.left.svelte-1hk8i84,.right.svelte-1hk8i84{margin-bottom:60rem}.bottom-row.svelte-1hk8i84{display:flex}.left.svelte-1hk8i84,.copyright.svelte-1hk8i84{padding-right:80rem;width:60%}.right.svelte-1hk8i84{padding-top:20rem}}@media screen and (min-width: 64em){.left.svelte-1hk8i84,.copyright.svelte-1hk8i84{width:50%}.left.svelte-1hk8i84,.right.svelte-1hk8i84{margin-bottom:70rem}}.text-cta.svelte-1hk8i84:first-of-type{margin-bottom:20rem}.headline.svelte-1hk8i84{font-size:40px;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;line-height:45px;font-weight:700;max-width:420px}.headline.svelte-1hk8i84 a.svelte-1hk8i84{color:#58595b;transition:all .45s ease-in-out;opacity:.75}.headline.svelte-1hk8i84 a.svelte-1hk8i84:hover{color:black}.title.svelte-1hk8i84{font-weight:100;font-size:12rem}.text-cta.svelte-1hk8i84 a.svelte-1hk8i84{font-size:14rem}.bottom-row.svelte-1hk8i84{padding-top:0}.copyright.svelte-1hk8i84{font-size:12rem;font-style:italic;font-weight:300}.left.svelte-1hk8i84 p.svelte-1hk8i84:last-child{color:#58595b;font-size:18px;font-weight:800;margin-top:25rem}div.social-icons.svelte-1hk8i84{margin-top:8px;min-width:206px}i.svelte-1hk8i84{font-size:14px;margin-right:8px;color:#808080;transition:all .3s ease}a.svelte-1hk8i84:hover>i.svelte-1hk8i84{transform:translateY(-3px);color:#58595b}@media screen and (min-width: 40em){div.social-icons.svelte-1hk8i84{margin:0}i.svelte-1hk8i84{font-size:18px;margin-right:10px}.left.svelte-1hk8i84 p.svelte-1hk8i84:last-child{margin-top:60rem}}@media screen and (min-width: 64em){.title.svelte-1hk8i84{font-size:16rem\n    }.text-cta.svelte-1hk8i84 a.svelte-1hk8i84{font-size:18rem}.copyright.svelte-1hk8i84{font-size:14rem}.headline.svelte-1hk8i84{font-size:45px;max-width:440px}.left.svelte-1hk8i84 p.svelte-1hk8i84:last-child{font-size:22px;margin-top:70rem}i.svelte-1hk8i84{font-size:20px}}",
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<footer class="svelte-1hk8i84">
	    <div class="container footer-container svelte-1hk8i84">
	        <div class="left svelte-1hk8i84">
	            <p class="headline svelte-1hk8i84">
	                Feel free to shoot me an <a href="mailto:joshua.micah.roper@gmail.com" class="svelte-1hk8i84">email</a> &amp; connect through <a href="https://www.linkedin.com/in/jr-dev" target="blank" class="svelte-1hk8i84">social.</a>
	            </p>
	            <p class="svelte-1hk8i84">Reach out!</p>
	        </div>
	        <div class="right svelte-1hk8i84">
	            <div class="text-cta svelte-1hk8i84">
	                <p class="title svelte-1hk8i84">
	                    Get In Touch!
	                </p>
	                <a href="mailto:joshua.micah.roper@gmail.com" class="svelte-1hk8i84">
	            ...
	            <div class="text-cta svelte-1hk8i84">
	                ...
	                <a href="./images/resume-joshua-roper.pdf" download class="svelte-1hk8i84">
	                    ${validate_component(TextAnimation, 'TextAnimation').$$render($$result, { text: `Download PDF` }, {}, {})}
	                </a>
	            </div>
	        </div>
	    </div>
	    <div class="bottom-row container svelte-1hk8i84">
	        
	        <p class="copyright svelte-1hk8i84">@ 2019 Joshua Roper Development</p>
	        <div class="social-icons svelte-1hk8i84">
	            <a href="https://www.github.com/Jrope21" aria-label="link to Joshua Roper's GitHub account" target="blank" class="svelte-1hk8i84">
	                <i class="fab fa-github svelte-1hk8i84"></i>
	            </a>
	            <a href="https://www.linkedin.com/in/JR-dev" aria-label="link to Joshua Roper's LinkedIn account" target="blank" class="svelte-1hk8i84">
	                <i class="fab fa-linkedin svelte-1hk8i84"></i>
	            </a>
	            <a href="mailto:joshua.micah.roper@gmail.com" aria-label="link to send Joshua Roper an email" target="blank" class="svelte-1hk8i84">
	                <i class="fas fa-envelope svelte-1hk8i84"></i>
	            </a>
	        </div>
	    </div>
	</footer>`;
