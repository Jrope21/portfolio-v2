...
const css$9 = {
	code: ".image-grid.svelte-1uqg0r7{display:flex;flex-wrap:wrap;flex-direction:column;align-items:center;padding-top:8%}@media screen and (min-width: 40em){.image-grid.svelte-1uqg0r7{flex-direction:row;align-items:unset;width:90%;margin:0 auto}}.grid-element-container.svelte-1uqg0r7{width:250px;display:flex;justify-content:center;align-items:center;margin-bottom:8%}@media screen and (min-width: 40em){.grid-element-container.svelte-1uqg0r7{width:50%}.grid-element-container.full-width.svelte-1uqg0r7{width:100%}}",
	map: "{\"version\":3,\"file\":\"ImageGrid.svelte\",\"sources\":[\"ImageGrid.svelte\"],\"sourcesContent\":[\"<script>\\nimport Image from '../projects/Image.svelte';\\n</script>\\n\\n<style>\\n.image-grid {\\n    display: flex;\\n    flex-wrap: wrap;\\n    flex-direction: column;\\n    align-items: center;\\n    padding-top: 8%;\\n}\\n\\n@media screen and (min-width: 40em){\\n    .image-grid {\\n        flex-direction: row;\\n        align-items: unset;\\n        width: 90%;\\n        margin: 0 auto;\\n    }\\n}\\n\\n.grid-element-container {\\n    width: 250px;\\n    display: flex;\\n    justify-content: center;\\n    align-items: center;\\n    margin-bottom: 8%;\\n}\\n\\n@media screen and (min-width: 40em){\\n    .grid-element-container {\\n        width: 50%;\\n    }\\n    .grid-element-container.full-width {\\n        width: 100%;\\n    }\\n}\\n</style>\\n\\n<div class=\\\"image-grid\\\">\\n    <div class=\\\"grid-element-container\\\">\\n        <Image width={'large'} imgSrc={'images/Jorden-Background-Gray.jpg'} url={''} alt={''} />\\n    </div>\\n    <div class=\\\"grid-element-container\\\">\\n        <Image width={'large'} imgSrc={'images/Jorden-Background-Gray.jpg'} url={''} alt={''} />\\n    </div>\\n    <div class=\\\"grid-element-container\\\">\\n        <Image width={'large'} imgSrc={'images/Jorden-Background-Gray.jpg'} url={''} alt={''} />\\n    </div>\\n    <div class=\\\"grid-element-container\\\">\\n        <Image width={'large'} imgSrc={'images/Jorden-Background-Gray.jpg'} url={''} alt={''} />\\n    </div>\\n    <div class=\\\"grid-element-container full-width\\\">\\n        <Image width={'full-width'} imgSrc={'images/Jorden-Background-Gray.jpg'} url={''} alt={''} />\\n    </div>\\n</div>\"],\"names\":[],\"mappings\":\"AAKA,WAAW,eAAC,CAAC,AACT,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,IAAI,CACf,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,CACnB,WAAW,CAAE,EAAE,AACnB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,WAAW,eAAC,CAAC,AACT,cAAc,CAAE,GAAG,CACnB,WAAW,CAAE,KAAK,CAClB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,CAAC,CAAC,IAAI,AAClB,CAAC,AACL,CAAC,AAED,uBAAuB,eAAC,CAAC,AACrB,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,EAAE,AACrB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,uBAAuB,eAAC,CAAC,AACrB,KAAK,CAAE,GAAG,AACd,CAAC,AACD,uBAAuB,WAAW,eAAC,CAAC,AAChC,KAAK,CAAE,IAAI,AACf,CAAC,AACL,CAAC\"}"
};

const ImageGrid = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$9);

	return `<div class="image-grid svelte-1uqg0r7">
	    <div class="grid-element-container svelte-1uqg0r7">
	        ${validate_component(Image, 'Image').$$render($$result, {
		width: 'large',
		imgSrc: 'images/Jorden-Background-Gray.jpg',
		url: '',
	    ...
	    <div class="grid-element-container full-width svelte-1uqg0r7">
	        ${validate_component(Image, 'Image').$$render($$result, {
		width: 'full-width',
		imgSrc: 'images/Jorden-Background-Gray.jpg',
		url: '',
...
const css$a = {
	code: ".headline.svelte-186fxqj{font-size:40px;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;line-height:45px;font-weight:700;max-width:700px;color:#3B3B3B}",
	map: "{\"version\":3,\"file\":\"Description.svelte\",\"sources\":[\"Description.svelte\"],\"sourcesContent\":[\"<script>\\n\\n</script>\\n\\n<style>\\n.headline {\\n    font-size: 40px;\\n    font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;\\n    line-height: 45px;\\n    font-weight: 700;\\n    max-width: 700px;\\n    color: #3B3B3B;\\n}\\n</style>\\n\\n<p class=\\\"headline\\\">Lorem Ipsum wassup dis be me son dawg crazy does dis look good</p>\"],\"names\":[],\"mappings\":\"AAKA,SAAS,eAAC,CAAC,AACP,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,aAAa,CAAC,CAAC,kBAAkB,CAAC,CAAC,UAAU,CAAC,CAAC,QAAQ,CAAC,CAAC,QAAQ,CAAC,CAAC,QAAQ,CAAC,CAAC,WAAW,CAAC,CAAC,YAAY,CAAC,CAAC,gBAAgB,CAAC,CAAC,UAAU,CACjJ,WAAW,CAAE,IAAI,CACjB,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,KAAK,CAChB,KAAK,CAAE,OAAO,AAClB,CAAC\"}"
};

const Description = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$a);

	return `<p class="headline svelte-186fxqj">Lorem Ipsum wassup dis be me son dawg crazy does dis look good</p>`;
});
