...
// sidePage should be set to 'side-page' to toggle class
	...
	return `<div class="page-header svelte-z6jjnx">
	    <div class="title-container ${escape(sidePage)} svelte-z6jjnx">
	        <h1 class="svelte-z6jjnx">${escape(title)}</h1>
	        <span class="svelte-z6jjnx">${escape(title)}</span>
	    </div>
	</div>`;
});
...
const ContactModal = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${ showModal && hideModal === false ? `${validate_component(ModalTemplate, 'ModalTemplate').$$render($$result, { showModal: showModal }, {}, {
		default: () => `
	        <div class="form-container svelte-o1fxxa">
	            <div class="flex-container svelte-o1fxxa">
	                    <div class="text-container ${escape(formState.hideFields ? 'hide-content' : '')} ${escape(formState.hideFields ? 'hide-content' : '')} svelte-o1fxxa">
	                        <h2 class="svelte-o1fxxa">Get In Touch</h2>
	                        <p class="svelte-o1fxxa">
	                            Hi There! I’m Josh, 
	                            I bring projects to life by innovating across every aspect of the customer journey. 
	                            Send me a message if you are looking to hire a developer, collaborate on a project, or have a potential business opportunity.
	                        </p>
	                    ...
	                    <form class="gform ${escape(formState.hideFields ? 'hide-content' : '')}
	                        ${escape(formState.formSuccess ? 'hide-content' : '')} svelte-o1fxxa">
	                            <label class="svelte-o1fxxa"> <span class="svelte-o1fxxa">Name</span>
	                                <input name="name" type="text" class="svelte-o1fxxa"${add_attribute("this", fieldInputs[0], 1)}>
	                            </label>
	                        <label class="svelte-o1fxxa"> <span class="svelte-o1fxxa">Email</span>
	                            <input required name="email" type="email" class="svelte-o1fxxa"${add_attribute("this", fieldInputs[1], 1)}>
	                        </label>
	                        <label class="svelte-o1fxxa"> <span class="svelte-o1fxxa">Message</span>
	                            <textarea name="message" rows="6" type="textarea" class="svelte-o1fxxa"${add_attribute("this", fieldInputs[2], 1)}></textarea>
	                        </label>
	                        <input type="submit" value="Send Message" class="svelte-o1fxxa">
	                    </form>

	                ${ formState.submittingForm ? `${validate_component(BoxLoader, 'BoxLoader').$$render($$result, {}, {}, {})}` : `` }
	                ${ formState.formSuccess ? `<h2 class="success-message svelte-o1fxxa">
	                        SUCCESS
	                    </h2>` : `` }
	                ${ formState.formError ? `<h2 class="success-message svelte-o1fxxa">
	                        ERROR
	                    </h2>` : `` }
	            </div>
	        </div>
