...
const css$h = {
	code: "a.svelte-13juyna{display:flex;align-items:center;font-weight:300;text-transform:uppercase;font-size:12rem;width:fit-content;margin-top:10rem;color:#989898;font-weight:300;font-style:italic}h2.svelte-13juyna{position:relative;display:flex;align-items:center;margin:15rem 0rem 5rem 0rem;font-size:13rem;font-weight:900;text-transform:capitalize;transition:all .2s ease-in-out;color:#3B3B3B;z-index:2}p.svelte-13juyna{position:relative;line-height:16px;font-weight:300;font-size:13rem;z-index:1;color:#58595b;text-indent:10px}@media screen and (min-width: 40em){h2.svelte-13juyna{margin-top:0rem}}@media screen and (min-width: 64em){h2.svelte-13juyna{font-size:23rem}p.svelte-13juyna{font-size:18rem;line-height:21px}a.svelte-13juyna{font-size:14rem}}.text-container.svelte-13juyna{position:sticky;top:130px;width:90%}@media(min-width: 40em){.text-container.svelte-13juyna{width:100%}}",
	map: "{\"version\":3,\"file\":\"Description.svelte\",\"sources\":[\"Description.svelte\"],\"sourcesContent\":[\"<script>\\nimport TextAnimation from '../helper-components/TextAnimation.svelte';\\n\\n</script>\\n\\n<style>\\n  a{\\n        display: flex;\\n        align-items: center;\\n        font-weight: 300;\\n        text-transform: uppercase;\\n        font-size: 12rem;\\n        width: fit-content;\\n        margin-top: 10rem;\\n        color: #989898;\\n        font-weight: 300;\\n        font-style: italic;\\n    }\\n    h2 {\\n        position: relative;\\n        display: flex;\\n        align-items: center;\\n        margin: 15rem 0rem 5rem 0rem;\\n        font-size: 13rem;\\n        font-weight: 900;\\n        text-transform: capitalize;\\n        transition: all .2s ease-in-out;\\n        color: #3B3B3B;\\n        z-index: 2;\\n    }\\n\\n    p{\\n        position: relative;\\n        line-height: 16px;\\n        font-weight: 300;\\n        font-size: 13rem;\\n        z-index: 1;\\n        color: #58595b;\\n        text-indent: 10px;\\n    }\\n\\n    @media screen and (min-width: 40em) {\\n        h2 {\\n            margin-top: 0rem;\\n        }\\n    }\\n\\n@media screen and (min-width: 64em){\\n    h2 {\\n        font-size: 23rem;\\n    }\\n    p{\\n        font-size: 18rem;\\n        line-height: 21px;\\n    }\\n    a{\\n        font-size: 14rem;\\n    }\\n}\\n.text-container {\\n    position: sticky;\\n    top: 130px;\\n    width: 90%;\\n}\\n\\n@media (min-width: 40em) {\\n    .text-container {\\n        width: 100%;\\n    }\\n}\\n</style>\\n\\n<div class=\\\"text-container\\\">\\n    <h2>Project Details</h2>\\n    <p>I was tasked with being the <strong>sole developer</strong> on a <strong>complete Front-End redesign</strong>. Keeping their current users in mind, the goal was to make the website feel more modern, and offer a better user experience when navigating to each individual page. Across the entire project I implemented several dynamically generated content pages / sliders, <strong>form verification</strong>, and several <strong>third party integrations</strong>.</p>\\n    <a target=\\\"blank\\\" href=\\\"\\\">\\n        <TextAnimation text={`View Website`} />\\n    </a>\\n</div>\"],\"names\":[],\"mappings\":\"AAME,gBAAC,CAAC,AACI,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,WAAW,CAAE,GAAG,CAChB,cAAc,CAAE,SAAS,CACzB,SAAS,CAAE,KAAK,CAChB,KAAK,CAAE,WAAW,CAClB,UAAU,CAAE,KAAK,CACjB,KAAK,CAAE,OAAO,CACd,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,MAAM,AACtB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,MAAM,CAAE,KAAK,CAAC,IAAI,CAAC,IAAI,CAAC,IAAI,CAC5B,SAAS,CAAE,KAAK,CAChB,WAAW,CAAE,GAAG,CAChB,cAAc,CAAE,UAAU,CAC1B,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,WAAW,CAC/B,KAAK,CAAE,OAAO,CACd,OAAO,CAAE,CAAC,AACd,CAAC,AAED,gBAAC,CAAC,AACE,QAAQ,CAAE,QAAQ,CAClB,WAAW,CAAE,IAAI,CACjB,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,KAAK,CAChB,OAAO,CAAE,CAAC,CACV,KAAK,CAAE,OAAO,CACd,WAAW,CAAE,IAAI,AACrB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACjC,EAAE,eAAC,CAAC,AACA,UAAU,CAAE,IAAI,AACpB,CAAC,AACL,CAAC,AAEL,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,KAAK,AACpB,CAAC,AACD,gBAAC,CAAC,AACE,SAAS,CAAE,KAAK,CAChB,WAAW,CAAE,IAAI,AACrB,CAAC,AACD,gBAAC,CAAC,AACE,SAAS,CAAE,KAAK,AACpB,CAAC,AACL,CAAC,AACD,eAAe,eAAC,CAAC,AACb,QAAQ,CAAE,MAAM,CAChB,GAAG,CAAE,KAAK,CACV,KAAK,CAAE,GAAG,AACd,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,eAAe,eAAC,CAAC,AACb,KAAK,CAAE,IAAI,AACf,CAAC,AACL,CAAC\"}"
};

const Description = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$h);

	return `<div class="text-container svelte-13juyna">
	    <h2 class="svelte-13juyna">Project Details</h2>
	    <p class="svelte-13juyna">I was tasked with being the <strong>sole developer</strong> on a <strong>complete Front-End redesign</strong>. Keeping their current users in mind, the goal was to make the website feel more modern, and offer a better user experience when navigating to each individual page. Across the entire project I implemented several dynamically generated content pages / sliders, <strong>form verification</strong>, and several <strong>third party integrations</strong>.</p>
	    <a target="blank" href="" class="svelte-13juyna">
	        ${validate_component(TextAnimation, 'TextAnimation').$$render($$result, { text: `View Website` }, {}, {})}
	    </a>
	</div>`;
});
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="carousel-container svelte-wor1t1">

	    <div class="box svelte-wor1t1"></div> 
	    
	        ${each(STATE.images, (img) => `${ img.visible ? `<div class="slide svelte-wor1t1">
	                    <button class="back svelte-wor1t1">
	                        <span class="arrow-left svelte-wor1t1"></span>
	                    </button>
	                    <img${add_attribute("src", img.src, 0)} alt="wassup" class="svelte-wor1t1">
	                    <button class="next svelte-wor1t1">
	                        <span class="arrow-right svelte-wor1t1"></span>
	                    </button>
	                </div>` : `` }`)}
	    <div class="circles-container svelte-wor1t1">
	        ${each(STATE.images, (img, i) => `<span class="circle ${escape(img.visible ? 'active' : '')} svelte-wor1t1"></span>`)}
	    </div>
	</div>`;
});
...
const css$j = {
	code: "div.svelte-8accch{display:flex;flex-direction:column;margin:40rem 0}@media screen and (min-width: 40em){div.svelte-8accch{margin:50rem 0}}h3.svelte-8accch{position:relative;display:flex;align-items:center;margin:0rem 0rem 15rem 0rem;font-size:13rem;font-weight:900;text-transform:capitalize;transition:all .2s ease-in-out;color:#3B3B3B;z-index:2}@media screen and (min-width: 40em){h3.svelte-8accch{width:18%}}@media screen and (min-width: 64em){h3.svelte-8accch{font-size:23rem;width:20%}}ul.skills.svelte-8accch{padding-left:10px;position:relative;top:10rem;width:100%;display:flex;flex-wrap:wrap}@media screen and (min-width: 40em){ul.skills.svelte-8accch{width:60%}}ul.skills.svelte-8accch::before{content:'';height:100%;position:absolute;border-left:3px solid #e6e7e8;opacity:.4}li.svelte-8accch{width:100%;font-weight:300;font-size:13rem;color:#58595b;margin:0rem 0rem 25rem 0rem;padding:0rem 0rem 0rem 0rem;display:flex;align-items:center;margin-left:-2px;height:0;z-index:2}@media screen and (min-width: 64em){li.svelte-8accch{font-size:18rem}}ul.svelte-8accch li.svelte-8accch:last-child{margin-bottom:0rem}li.svelte-8accch::before{content:'';width:7px;height:7px;background:#58595b;margin-right:10rem;border-radius:100%\n    }",
	map: "{\"version\":3,\"file\":\"Skills.svelte\",\"sources\":[\"Skills.svelte\"],\"sourcesContent\":[\"<script>\\n\\n</script>\\n\\n<style>\\n\\n    div {\\n        display: flex;\\n        flex-direction: column;\\n        margin: 40rem 0;\\n    }\\n    \\n    @media screen and (min-width: 40em){\\n        div{\\n            margin: 50rem 0;\\n        }\\n    }\\n\\n    h3 {\\n        position: relative;\\n        display: flex;\\n        align-items: center;\\n        margin: 0rem 0rem 15rem 0rem;\\n\\n        font-size: 13rem;\\n        font-weight: 900;\\n        text-transform: capitalize;\\n        transition: all .2s ease-in-out;\\n        color: #3B3B3B;\\n        z-index: 2;\\n        \\n    }\\n\\n    @media screen and (min-width: 40em){\\n        h3 {\\n            width: 18%;\\n        }\\n    }\\n\\n    @media screen and (min-width: 64em){\\n        h3 {\\n            font-size: 23rem;\\n            width: 20%;\\n        }\\n    }\\n\\n    ul.skills{\\n        padding-left: 10px;\\n        position: relative;\\n        top: 10rem;\\n        width: 100%;\\n        display: flex;\\n        flex-wrap: wrap;\\n    }\\n\\n    @media screen and (min-width: 40em){\\n        ul.skills{\\n            width: 60%;\\n        }\\n    }\\n\\n    ul.skills::before {\\n        content: '';\\n        height: 100%;\\n        position: absolute;\\n        border-left: 3px solid #e6e7e8;\\n        opacity: .4;\\n    }\\n\\n    p {\\n        font-weight: 300;\\n        font-size: 13rem;\\n        color: #58595b;\\n    }\\n\\n    \\n    li {\\n        width: 100%;\\n        font-weight: 300;\\n        font-size: 13rem;\\n        color: #58595b;\\n        margin: 0rem 0rem 25rem 0rem;\\n        padding: 0rem 0rem 0rem 0rem;\\n        display: flex;\\n        align-items: center;\\n        margin-left: -2px;\\n        height: 0;\\n        z-index: 2;\\n    }\\n\\n\\n    @media screen and (min-width: 64em){\\n        li {\\n            font-size: 18rem;\\n        }\\n    }\\n\\n    span {\\n        color: #414042;\\n        font-weight: 500;\\n    }\\n\\n    ul li:last-child {\\n        margin-bottom: 0rem;\\n    }\\n\\n    li::before {\\n        content: '';\\n        width: 7px;\\n        height: 7px;\\n        background: #58595b;\\n        margin-right: 10rem;\\n        border-radius: 100%\\n    }\\n\\n</style>\\n\\n<div>\\n    <h3>\\n        Technology\\n    </h3>\\n        <ul class=\\\"skills\\\">\\n            <li>JavaScript</li>\\n            <li>jQuery</li>\\n            <li>CSS</li> \\n            <li>HTML (WCAG 2.1)</li>\\n            <li>WordPress</li>\\n            <li>Divi Builder</li>\\n            <li>Adobe Suite</li>\\n            <li>SEO</li>\\n            <li>Usability Testing</li> \\n            <li>HTML (WCAG 2.1)</li>\\n            <li>HTML Emails</li>\\n            <li>GitHub / BitBucket</li>\\n            <li>WordPress / Kentico</li>\\n            <li>Adobe Suite</li>\\n            <li>SEO</li>\\n            <li>Usability Testing</li> \\n        </ul>\\n</div>\"],\"names\":[],\"mappings\":\"AAMI,GAAG,cAAC,CAAC,AACD,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,iBAAG,CAAC,AACA,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AACL,CAAC,AAED,EAAE,cAAC,CAAC,AACA,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,MAAM,CAAE,IAAI,CAAC,IAAI,CAAC,KAAK,CAAC,IAAI,CAE5B,SAAS,CAAE,KAAK,CAChB,WAAW,CAAE,GAAG,CAChB,cAAc,CAAE,UAAU,CAC1B,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,WAAW,CAC/B,KAAK,CAAE,OAAO,CACd,OAAO,CAAE,CAAC,AAEd,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,EAAE,cAAC,CAAC,AACA,KAAK,CAAE,GAAG,AACd,CAAC,AACL,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,EAAE,cAAC,CAAC,AACA,SAAS,CAAE,KAAK,CAChB,KAAK,CAAE,GAAG,AACd,CAAC,AACL,CAAC,AAED,EAAE,qBAAO,CAAC,AACN,YAAY,CAAE,IAAI,CAClB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,KAAK,CACV,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,IAAI,AACnB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,EAAE,qBAAO,CAAC,AACN,KAAK,CAAE,GAAG,AACd,CAAC,AACL,CAAC,AAED,EAAE,qBAAO,QAAQ,AAAC,CAAC,AACf,OAAO,CAAE,EAAE,CACX,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,QAAQ,CAClB,WAAW,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CAC9B,OAAO,CAAE,EAAE,AACf,CAAC,AASD,EAAE,cAAC,CAAC,AACA,KAAK,CAAE,IAAI,CACX,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,KAAK,CAChB,KAAK,CAAE,OAAO,CACd,MAAM,CAAE,IAAI,CAAC,IAAI,CAAC,KAAK,CAAC,IAAI,CAC5B,OAAO,CAAE,IAAI,CAAC,IAAI,CAAC,IAAI,CAAC,IAAI,CAC5B,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,WAAW,CAAE,IAAI,CACjB,MAAM,CAAE,CAAC,CACT,OAAO,CAAE,CAAC,AACd,CAAC,AAGD,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,EAAE,cAAC,CAAC,AACA,SAAS,CAAE,KAAK,AACpB,CAAC,AACL,CAAC,AAOD,gBAAE,CAAC,gBAAE,WAAW,AAAC,CAAC,AACd,aAAa,CAAE,IAAI,AACvB,CAAC,AAED,gBAAE,QAAQ,AAAC,CAAC,AACR,OAAO,CAAE,EAAE,CACX,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,UAAU,CAAE,OAAO,CACnB,YAAY,CAAE,KAAK,CACnB,aAAa,CAAE,IAAI;IACvB,CAAC\"}"
};

const Skills = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$j);

	return `<div class="svelte-8accch">
	    <h3 class="svelte-8accch">
	        Technology
	    </h3>
	        <ul class="skills svelte-8accch">
	            <li class="svelte-8accch">JavaScript</li>
	            <li class="svelte-8accch">jQuery</li>
	            <li class="svelte-8accch">CSS</li> 
	            <li class="svelte-8accch">HTML (WCAG 2.1)</li>
	            <li class="svelte-8accch">WordPress</li>
	            <li class="svelte-8accch">Divi Builder</li>
	            <li class="svelte-8accch">Adobe Suite</li>
	            <li class="svelte-8accch">SEO</li>
	            <li class="svelte-8accch">Usability Testing</li> 
	            <li class="svelte-8accch">HTML (WCAG 2.1)</li>
	            <li class="svelte-8accch">HTML Emails</li>
	            <li class="svelte-8accch">GitHub / BitBucket</li>
	            <li class="svelte-8accch">WordPress / Kentico</li>
	            <li class="svelte-8accch">Adobe Suite</li>
	            <li class="svelte-8accch">SEO</li>
	            <li class="svelte-8accch">Usability Testing</li> 
	        </ul>
...
const css$k = {
	code: "@media screen and (min-width: 40em){.inner-container.svelte-1rpz0ty{width:90%;margin:0 auto}}@media screen and (min-width: 40em){.project-description.svelte-1rpz0ty{padding-left:12%;width:60%;margin:40rem 0}}@media(min-width: 64em){.project-description.svelte-1rpz0ty{width:50%}}@media screen and (min-width: 40em){}.cta.svelte-1rpz0ty{margin:50rem 0}@media(min-width: 40em){.cta.svelte-1rpz0ty{margin:65rem 0}}.cta.svelte-1rpz0ty p.svelte-1rpz0ty{color:#58595b;font-size:18px;font-weight:600;font-style:italic}@media(min-width: 64em){.cta.svelte-1rpz0ty p.svelte-1rpz0ty{font-size:26px;font-weight:800}}@media(min-width: 40em){section.svelte-1rpz0ty{padding-left:12%}}",
	map: "{\"version\":3,\"file\":\"ImageGrid.svelte\",\"sources\":[\"ImageGrid.svelte\"],\"sourcesContent\":[\"<script>\\nimport Image from './Image.svelte';\\nimport TopBar from './TopBar.svelte';\\nimport Description from './Description.svelte';\\nimport Carousel from './Carousel.svelte';\\nimport Skills from './Skills.svelte';\\n// import Summary from './Summary.svelte';\\n</script>\\n\\n<style>\\n@media screen and (min-width: 40em){\\n    .inner-container {\\n        width: 90%;\\n        margin: 0 auto;\\n    }\\n}\\n.image-grid {\\n    display: flex;\\n    flex-wrap: wrap;\\n    flex-direction: column;\\n    align-items: center;\\n    padding-top: 8%;\\n}\\n\\n@media screen and (min-width: 40em){\\n    .image-grid {\\n        box-sizing: border-box;\\n        flex-direction: row;\\n        align-items: unset;\\n        width: 50%;\\n        /* padding-left: 5%; */\\n        margin: 0 auto;\\n    }\\n    .project-description {\\n        /* padding-top: 8%; */\\n        padding-left: 12%;\\n        width: 60%;\\n        margin: 40rem 0;\\n    }\\n}\\n\\n@media (min-width: 64em) {\\n    .project-description {\\n        width: 50%;\\n    }\\n}\\n\\n.grid-element-container {\\n    width: 250px;\\n    display: flex;\\n    justify-content: center;\\n    align-items: center;\\n    margin-bottom: 8%;\\n}\\n\\n@media screen and (min-width: 40em){\\n    .grid-element-container {\\n        width: 50%;\\n    }\\n    .grid-element-container.full-width {\\n        width: 100%;\\n    }\\n    .grid-60 {\\n        width: 60%;\\n    }\\n    .grid-40 {\\n        width: 40%;\\n    }\\n}\\n\\n.cta {\\n    margin: 50rem 0;\\n}\\n\\n@media (min-width: 40em) {\\n    .cta {\\n        margin: 65rem 0;\\n    }\\n}\\n\\n.cta p {\\n    color: #58595b;\\n    font-size: 18px;\\n    font-weight: 600;\\n    font-style: italic;\\n}\\n\\n@media (min-width: 64em) {\\n    .cta p {\\n        font-size: 26px;\\n        font-weight: 800;\\n    }\\n}\\n\\n@media (min-width: 40em) {\\n    section {\\n        padding-left: 12%;\\n    }\\n}\\n</style>\\n\\n<div class=\\\"inner-container\\\">\\n    <!-- <TopBar /> -->\\n    <!-- <div class=\\\"grid-x\\\"> -->\\n    <!-- <Summary /> -->\\n        \\n        \\n        <Carousel />\\n        <section class=\\\"project-description\\\">\\n            <Description />\\n        </section>\\n        <section class=\\\"skills\\\">\\n            <Skills />\\n        </section>\\n        <section class=\\\"cta\\\">\\n            <p>Check The Site!</p>\\n        </section>\\n    <!-- </div> -->\\n</div>\"],\"names\":[],\"mappings\":\"AAUA,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,gBAAgB,eAAC,CAAC,AACd,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,CAAC,CAAC,IAAI,AAClB,CAAC,AACL,CAAC,AASD,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAShC,oBAAoB,eAAC,CAAC,AAElB,YAAY,CAAE,GAAG,CACjB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AACL,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,oBAAoB,eAAC,CAAC,AAClB,KAAK,CAAE,GAAG,AACd,CAAC,AACL,CAAC,AAUD,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAapC,CAAC,AAED,IAAI,eAAC,CAAC,AACF,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,IAAI,eAAC,CAAC,AACF,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AACL,CAAC,AAED,mBAAI,CAAC,CAAC,eAAC,CAAC,AACJ,KAAK,CAAE,OAAO,CACd,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,MAAM,AACtB,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,mBAAI,CAAC,CAAC,eAAC,CAAC,AACJ,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,AACpB,CAAC,AACL,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,OAAO,eAAC,CAAC,AACL,YAAY,CAAE,GAAG,AACrB,CAAC,AACL,CAAC\"}"
};

const ImageGrid = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$k);

	return `<div class="inner-container svelte-1rpz0ty">
	        ...
	        <section class="project-description svelte-1rpz0ty">
	            ${validate_component(Description, 'Description').$$render($$result, {}, {}, {})}
	        </section>
	        <section class="skills svelte-1rpz0ty">
	            ${validate_component(Skills, 'Skills').$$render($$result, {}, {}, {})}
	        </section>
	        <section class="cta svelte-1rpz0ty">
	            <p class="svelte-1rpz0ty">Check The Site!</p>
	        </section>
...
const Creative_revolt = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="project-detail svelte-a14vps">
	    ${validate_component(PageTransition, 'PageTransition').$$render($$result, {}, {}, {
		default: () => `
	    <div class="container svelte-a14vps">
