...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="carousel-container svelte-129iewz">
	    <div class="box svelte-129iewz">CREATIVE REVOLT</div> 
	    
	        ${each(STATE.images, (img) => `${ img.visible ? `<div class="slide svelte-129iewz">
	                    <img${add_attribute("src", img.src, 0)} alt="wassup" class="svelte-129iewz">
	                </div>` : `` }`)}
	    <div class="circles-container svelte-129iewz">
	        ${each(STATE.images, (img, i) => `<span class="circle ${escape(img.visible ? 'active' : '')} svelte-129iewz"></span>`)}
	    </div>
	</div>`;
});
