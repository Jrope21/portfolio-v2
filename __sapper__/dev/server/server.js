...
const css$8 = {
	code: "ul.svelte-wd06iy{margin-left:20rem;font-size:12rem}li.svelte-wd06iy{display:flex;align-items:center;margin:5rem 0}li.svelte-wd06iy::before{content:'';display:inline-block;width:5px;height:5px;border-radius:100%;background:gray;margin-right:15rem}h3.svelte-wd06iy{font-size:12rem;text-transform:uppercase;font-weight:400}",
	map: "{\"version\":3,\"file\":\"Skills.svelte\",\"sources\":[\"Skills.svelte\"],\"sourcesContent\":[\"<script>\\n\\n</script>\\n\\n<style lang=\\\"scss\\\">\\n ul {\\n    margin-left: 20rem;\\n    font-size: 12rem;\\n\\n    \\n}\\n\\nli {\\n    display: flex;\\n    align-items: center;\\n    margin: 5rem 0;\\n}\\n\\nli::before {\\n    content: '';\\n    display: inline-block;\\n    width: 5px;\\n    height: 5px;\\n    border-radius: 100%;\\n    background: gray;\\n    margin-right: 15rem;\\n}\\nh3 {\\n    font-size: 12rem;\\n    text-transform: uppercase;\\n    font-weight: 400;\\n} \\n</style>\\n\\n<section class=\\\"skills\\\">\\n    <h2 class=\\\"headline\\\">Skills</h2>\\n    <div class=\\\"development-section\\\">\\n        <h3>Development</h3>\\n        <ul class=\\\"skills-list\\\">\\n            <li>React</li>\\n            <li>Svelte 3</li>\\n            <li>Sapper</li>\\n            <li>JavaScript (ES6+)</li>\\n            <li>WebPack</li>\\n            <li>Git (Version Control)</li>\\n            <li>jQuery</li> \\n            <li>SASS / SCSS</li>\\n            <li>CSS</li>\\n            <li>Foundation</li>\\n            <li>Bootstrap</li>\\n            <li>HTML (WCAG 2.1)</li>\\n            <li>HTML Emails</li>\\n            <li>GitHub / BitBucket</li>\\n            <li>WordPress / Kentico</li>\\n            <li>Adobe Suite</li>\\n            <li>SEO</li>\\n            <li>Usability Testing</li> \\n        </ul>\\n    </div>\\n    <div class=\\\"design-section\\\">\\n        <h3>Design</h3>\\n        <ul class=\\\"skills-list\\\">\\n            <li>Adobe InDesign</li>\\n            <li>Adobe Illustrator</li>\\n            <li>Adobe XD</li>\\n            <li>Adobe Premiere</li>\\n            <li>Wireframing</li>\\n            <li>Canva</li>\\n        </ul>\\n    </div>\\n</section>\"],\"names\":[],\"mappings\":\"AAKC,EAAE,cAAC,CAAC,AACD,WAAW,CAAE,KAAK,CAClB,SAAS,CAAE,KAAK,AAGpB,CAAC,AAED,EAAE,cAAC,CAAC,AACA,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,MAAM,CAAE,IAAI,CAAC,CAAC,AAClB,CAAC,AAED,gBAAE,QAAQ,AAAC,CAAC,AACR,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,YAAY,CACrB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,aAAa,CAAE,IAAI,CACnB,UAAU,CAAE,IAAI,CAChB,YAAY,CAAE,KAAK,AACvB,CAAC,AACD,EAAE,cAAC,CAAC,AACA,SAAS,CAAE,KAAK,CAChB,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,GAAG,AACpB,CAAC\"}"
};
...
const Skills = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="skills">
	    <h2 class="headline">Skills</h2>
	    <div class="development-section">
	        <h3 class="svelte-wd06iy">Development</h3>
	        <ul class="skills-list svelte-wd06iy">
	            <li class="svelte-wd06iy">React</li>
	            <li class="svelte-wd06iy">Svelte 3</li>
	            <li class="svelte-wd06iy">Sapper</li>
	            <li class="svelte-wd06iy">JavaScript (ES6+)</li>
	            <li class="svelte-wd06iy">WebPack</li>
	            <li class="svelte-wd06iy">Git (Version Control)</li>
	            <li class="svelte-wd06iy">jQuery</li> 
	            <li class="svelte-wd06iy">SASS / SCSS</li>
	            <li class="svelte-wd06iy">CSS</li>
	            <li class="svelte-wd06iy">Foundation</li>
	            <li class="svelte-wd06iy">Bootstrap</li>
	            <li class="svelte-wd06iy">HTML (WCAG 2.1)</li>
	            <li class="svelte-wd06iy">HTML Emails</li>
	            <li class="svelte-wd06iy">GitHub / BitBucket</li>
	            <li class="svelte-wd06iy">WordPress / Kentico</li>
	            <li class="svelte-wd06iy">Adobe Suite</li>
	            <li class="svelte-wd06iy">SEO</li>
	            <li class="svelte-wd06iy">Usability Testing</li> 
	        </ul>
	    </div>
	    <div class="design-section">
	        <h3 class="svelte-wd06iy">Design</h3>
	        <ul class="skills-list svelte-wd06iy">
	            <li class="svelte-wd06iy">Adobe InDesign</li>
	            <li class="svelte-wd06iy">Adobe Illustrator</li>
	            <li class="svelte-wd06iy">Adobe XD</li>
	            <li class="svelte-wd06iy">Adobe Premiere</li>
	            <li class="svelte-wd06iy">Wireframing</li>
	            <li class="svelte-wd06iy">Canva</li>
	        </ul>
	    </div>
	</section>`;
});
...
const css$9 = {
	code: "h1.svelte-m6ichf{color:#3B3B3B;font-weight:800;font-size:23px}h2.svelte-m6ichf{color:#3B3B3B;font-weight:800;font-size:18px;margin-bottom:5px;margin-top:-3px;opacity:.85}h3.svelte-m6ichf{display:flex;align-items:center;font-size:14px;font-weight:400;opacity:.8;margin-bottom:15px}h3.svelte-m6ichf::before{content:'';display:block;width:30px;border-bottom:3px solid black;margin-right:10px;opacity:.8}@media screen and (min-width: 40em){h1.svelte-m6ichf{font-size:28px}h2.svelte-m6ichf{font-size:22px;margin-bottom:7px}h3.svelte-m6ichf{margin-bottom:0}}@media screen and (min-width: 64em){h1.svelte-m6ichf{font-size:38px}h2.svelte-m6ichf{font-size:28px;margin-bottom:9px;margin-top:-5px}h3.svelte-m6ichf{font-size:18px}}@media screen and (min-width: 1366px){h1.svelte-m6ichf{font-size:45px}h2.svelte-m6ichf{font-size:38px}h3.svelte-m6ichf{font-size:23px}}",
	map: "{\"version\":3,\"file\":\"SideBar.svelte\",\"sources\":[\"SideBar.svelte\"],\"sourcesContent\":[\"<script>\\nimport Skills from './Skills.svelte';\\nimport Contact from './Contact.svelte';\\n</script>\\n\\n<style>\\nh1 {\\n    color:#3B3B3B;\\n    font-weight: 800;\\n    font-size: 23px;\\n}\\nh2 {\\n    color:#3B3B3B;\\n    font-weight: 800;\\n    font-size: 18px;\\n    margin-bottom: 5px;\\n    margin-top: -3px;\\n    opacity: .85;\\n}\\n\\nh3 {\\n    display: flex;\\n    align-items: center;\\n    font-size: 14px;\\n    font-weight: 400;\\n    opacity: .8;\\n    margin-bottom: 15px;\\n}\\n\\nh3::before {\\n    content: '';\\n    display: block;\\n    width: 30px;\\n    border-bottom: 3px solid black;\\n    margin-right: 10px;\\n    opacity: .8;\\n}\\n\\n@media screen and (min-width: 40em){\\n    h1 {\\n        font-size: 28px;\\n    }\\n    h2 {\\n        font-size: 22px;\\n        margin-bottom: 7px;\\n    }\\n    h3 {\\n        margin-bottom: 0;\\n    }\\n}\\n\\n@media screen and (min-width: 64em) {\\n    h1 {\\n        font-size: 38px;\\n    }\\n    h2 {\\n        font-size: 28px;\\n        margin-bottom: 9px;\\n        margin-top: -5px;\\n    }\\n    h3 {\\n        font-size: 18px;\\n    }\\n}\\n\\n @media screen and (min-width: 1366px){\\n      h1 {\\n        font-size: 45px;\\n    }\\n    h2 {\\n        font-size: 38px;\\n    }\\n    h3 {\\n        font-size: 23px;\\n    }\\n }\\n</style>\\n\\n<aside>\\n    <div class=\\\"titles\\\">\\n        <h1>Front End Developer</h1>\\n        <h2>React, Svelte, ES6</h2>\\n        <h3>Joshua Roper</h3>\\n    </div>\\n    <Skills />\\n    <Contact />\\n</aside>\"],\"names\":[],\"mappings\":\"AAMA,EAAE,cAAC,CAAC,AACA,MAAM,OAAO,CACb,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,IAAI,AACnB,CAAC,AACD,EAAE,cAAC,CAAC,AACA,MAAM,OAAO,CACb,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,IAAI,CACf,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,GAAG,AAChB,CAAC,AAED,EAAE,cAAC,CAAC,AACA,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,OAAO,CAAE,EAAE,CACX,aAAa,CAAE,IAAI,AACvB,CAAC,AAED,gBAAE,QAAQ,AAAC,CAAC,AACR,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CAC9B,YAAY,CAAE,IAAI,CAClB,OAAO,CAAE,EAAE,AACf,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,EAAE,cAAC,CAAC,AACA,SAAS,CAAE,IAAI,AACnB,CAAC,AACD,EAAE,cAAC,CAAC,AACA,SAAS,CAAE,IAAI,CACf,aAAa,CAAE,GAAG,AACtB,CAAC,AACD,EAAE,cAAC,CAAC,AACA,aAAa,CAAE,CAAC,AACpB,CAAC,AACL,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACjC,EAAE,cAAC,CAAC,AACA,SAAS,CAAE,IAAI,AACnB,CAAC,AACD,EAAE,cAAC,CAAC,AACA,SAAS,CAAE,IAAI,CACf,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,IAAI,AACpB,CAAC,AACD,EAAE,cAAC,CAAC,AACA,SAAS,CAAE,IAAI,AACnB,CAAC,AACL,CAAC,AAEA,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,CAAC,AACjC,EAAE,cAAC,CAAC,AACF,SAAS,CAAE,IAAI,AACnB,CAAC,AACD,EAAE,cAAC,CAAC,AACA,SAAS,CAAE,IAAI,AACnB,CAAC,AACD,EAAE,cAAC,CAAC,AACA,SAAS,CAAE,IAAI,AACnB,CAAC,AACJ,CAAC\"}"
};
...
const SideBar = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<aside>
	    <div class="titles">
	        <h1 class="svelte-m6ichf">Front End Developer</h1>
	        <h2 class="svelte-m6ichf">React, Svelte, ES6</h2>
	        <h3 class="svelte-m6ichf">Joshua Roper</h3>
	    </div>
...
const JobExperience = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section>
	    <h2 class="headline">Experience</h2>
	    <div class="job-listing svelte-1igouow">
	        <p class="date-location detail-preface">Dallas, Texas (2019 - current)</p>
	        <h3 class="job-title detail-title">Front End Developer at Imaginuity</h3>
	        <ul class="job-details">
	            <li class="detail svelte-1igouow">
	                Developed the entire Front End for a high traffic, 99% up time website
	                <div class="detail-web-links">
	                    uptexas.org
	                </div>
...
const Experience = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="experience container svelte-1l2g6x9">
	    <div class="left svelte-1l2g6x9">
	        ${validate_component(SideBar, 'SideBar').$$render($$result, {}, {}, {})}
	    </div>
	    <div class="right svelte-1l2g6x9">
