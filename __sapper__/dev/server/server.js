...
const css$8 = {
	code: "section.titles.svelte-dybx98{margin-bottom:20rem}@media screen and (min-width: 40em){section.titles.svelte-dybx98{margin-bottom:60rem}}h1.svelte-dybx98{color:#3B3B3B;font-weight:800;font-size:23px}h2.svelte-dybx98{color:#3B3B3B;font-weight:800;font-size:18px;margin-bottom:5px;margin-top:-3px;opacity:.85}h3.svelte-dybx98{display:flex;align-items:center;font-size:14px;font-weight:400;opacity:.8;margin-bottom:15px}h3.svelte-dybx98::before{content:'';display:block;width:30px;border-bottom:3px solid black;margin-right:10px;opacity:.8}",
	map: "{\"version\":3,\"file\":\"LogoText.svelte\",\"sources\":[\"LogoText.svelte\"],\"sourcesContent\":[\"<script>\\nexport let addClass;\\n</script>\\n\\n<style>\\nsection.titles {\\n    margin-bottom: 20rem;\\n}\\n\\n@media screen and (min-width: 40em) {\\n    section.titles {\\n        margin-bottom: 60rem;\\n    }\\n}\\n\\nh1 {\\n    color:#3B3B3B;\\n    font-weight: 800;\\n    font-size: 23px;\\n}\\nh2 {\\n    color:#3B3B3B;\\n    font-weight: 800;\\n    font-size: 18px;\\n    margin-bottom: 5px;\\n    margin-top: -3px;\\n    opacity: .85;\\n}\\n\\nh3 {\\n    display: flex;\\n    align-items: center;\\n    font-size: 14px;\\n    font-weight: 400;\\n    opacity: .8;\\n    margin-bottom: 15px;\\n}\\n\\nh3::before {\\n    content: '';\\n    display: block;\\n    width: 30px;\\n    border-bottom: 3px solid black;\\n    margin-right: 10px;\\n    opacity: .8;\\n}\\n\\n/* @media screen and (min-width: 40em){\\n    h1 {\\n        font-size: 28px;\\n    }\\n    h2 {\\n        font-size: 22px;\\n        margin-bottom: 7px;\\n    }\\n    h3 {\\n        margin-bottom: 0;\\n    }\\n}\\n\\n@media screen and (min-width: 64em) {\\n    h1 {\\n        font-size: 38px;\\n    }\\n    h2 {\\n        font-size: 28px;\\n        margin-bottom: 9px;\\n        margin-top: -5px;\\n    }\\n    h3 {\\n        font-size: 18px;\\n    }\\n} */\\n\\n /* @media screen and (min-width: 1366px){\\n    h1 {\\n        font-size: 45px;\\n    }\\n    h2 {\\n        font-size: 38px;\\n    }\\n    h3 {\\n        font-size: 23px;\\n    }\\n } */\\n</style>\\n\\n<section class=\\\"titles {addClass}\\\">\\n    <h1>Front End Developer</h1>\\n    <h2>React, Svelte, ES6</h2>\\n    <h3>Joshua Roper</h3>\\n</section>\"],\"names\":[],\"mappings\":\"AAKA,OAAO,OAAO,cAAC,CAAC,AACZ,aAAa,CAAE,KAAK,AACxB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACjC,OAAO,OAAO,cAAC,CAAC,AACZ,aAAa,CAAE,KAAK,AACxB,CAAC,AACL,CAAC,AAED,EAAE,cAAC,CAAC,AACA,MAAM,OAAO,CACb,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,IAAI,AACnB,CAAC,AACD,EAAE,cAAC,CAAC,AACA,MAAM,OAAO,CACb,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,IAAI,CACf,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,GAAG,AAChB,CAAC,AAED,EAAE,cAAC,CAAC,AACA,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,OAAO,CAAE,EAAE,CACX,aAAa,CAAE,IAAI,AACvB,CAAC,AAED,gBAAE,QAAQ,AAAC,CAAC,AACR,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CAC9B,YAAY,CAAE,IAAI,CAClB,OAAO,CAAE,EAAE,AACf,CAAC\"}"
};
...
const LogoText = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="titles ${escape(addClass)} svelte-dybx98">
	    <h1 class="svelte-dybx98">Front End Developer</h1>
	    <h2 class="svelte-dybx98">React, Svelte, ES6</h2>
	    <h3 class="svelte-dybx98">Joshua Roper</h3>
	</section>`;
});
...
const Skills = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="skills">
	    <h2 class="headline alt">Skills</h2>
	    <div class="development-section">
	        <h3 class="svelte-1gequub">Development</h3>
	        <ul class="skills-list svelte-1gequub">
	            <li class="svelte-1gequub">React</li>
	            <li class="svelte-1gequub">Svelte 3</li>
	            <li class="svelte-1gequub">Sapper</li>
	            <li class="svelte-1gequub">JavaScript (ES6+)</li>
	            <li class="svelte-1gequub">WebPack</li>
	            <li class="svelte-1gequub">Git (Version Control)</li>
	            <li class="svelte-1gequub">jQuery</li> 
	            <li class="svelte-1gequub">SASS / SCSS</li>
	            <li class="svelte-1gequub">CSS</li>
	            <li class="svelte-1gequub">Foundation</li>
	            <li class="svelte-1gequub">Bootstrap</li>
	            <li class="svelte-1gequub">HTML (WCAG 2.1)</li>
	            <li class="svelte-1gequub">HTML Emails</li>
	            <li class="svelte-1gequub">GitHub / BitBucket</li>
	            <li class="svelte-1gequub">WordPress / Kentico</li>
	            <li class="svelte-1gequub">Adobe Suite</li>
	            <li class="svelte-1gequub">SEO</li>
	            <li class="svelte-1gequub">Usability Testing</li> 
	        </ul>
	    </div>
	    <div class="design-section svelte-1gequub">
	        <h3 class="svelte-1gequub">Design</h3>
	        <ul class="skills-list svelte-1gequub">
	            <li class="svelte-1gequub">Adobe InDesign</li>
	            <li class="svelte-1gequub">Adobe Illustrator</li>
	            <li class="svelte-1gequub">Adobe XD</li>
	            <li class="svelte-1gequub">Adobe Premiere</li>
	            <li class="svelte-1gequub">Wireframing</li>
	            <li class="svelte-1gequub">Canva</li>
	        </ul>
	    </div>
	</section>`;
});
...
const Contact = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="contact">
	    <h2 class="headline alt">Contact</h2>
	        <a href="https://www.linkedin.com/in/JR-dev" aria-label="link to Joshua Roper's LinkedIn account" target="blank" class="svelte-1iodl2i">linkedin.com/in/JR-dev</a>
	        <a href="mailto:joshua.micah.roper@gmail.com" aria-label="link to send Joshua Roper an email" target="blank" class="svelte-1iodl2i">Joshua.Micah.Roper@gmail.com</a>
	</section>`;
});
