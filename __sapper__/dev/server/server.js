...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="carousel-container svelte-njfn3i">

	    <div class="box svelte-njfn3i"></div> 
	    
	        ${each(STATE.images, (img) => `${ img.visible ? `<div class="slide svelte-njfn3i">
	                    <button class="back svelte-njfn3i">
	                        <span class="arrow-left svelte-njfn3i"></span>
	                    </button>
	                    <img${add_attribute("src", img.src, 0)} alt="wassup" class="svelte-njfn3i">
	                    <button class="next svelte-njfn3i">
	                        <span class="arrow-right svelte-njfn3i"></span>
	                    </button>
	                </div>` : `` }`)}
	    <div class="circles-container svelte-njfn3i">
	        ${each(STATE.images, (img, i) => `<span class="circle ${escape(img.visible ? 'active' : '')} svelte-njfn3i"></span>`)}
	    </div>
	</div>`;
});
...
const css$h = {
	...
	map: "{\"version\":3,\"file\":\"ImageGrid.svelte\",\"sources\":[\"ImageGrid.svelte\"],\"sourcesContent\":[\"<script>\\nimport Image from './Image.svelte';\\nimport TopBar from './TopBar.svelte';\\nimport Description from './Description.svelte';\\nimport Carousel from './Carousel.svelte';\\n</script>\\n\\n<style>\\n@media screen and (min-width: 40em){\\n    .inner-container {\\n        width: 90%;\\n        margin: 0 auto;\\n    }\\n}\\n.image-grid {\\n    display: flex;\\n    flex-wrap: wrap;\\n    flex-direction: column;\\n    align-items: center;\\n    padding-top: 8%;\\n}\\n\\n@media screen and (min-width: 40em){\\n    .image-grid {\\n        box-sizing: border-box;\\n        flex-direction: row;\\n        align-items: unset;\\n        width: 50%;\\n        /* padding-left: 5%; */\\n        margin: 0 auto;\\n    }\\n    .project-description {\\n        padding-top: 8%;\\n        width: 50%;\\n    }\\n}\\n\\n.grid-element-container {\\n    width: 250px;\\n    display: flex;\\n    justify-content: center;\\n    align-items: center;\\n    margin-bottom: 8%;\\n}\\n\\n@media screen and (min-width: 40em){\\n    .grid-element-container {\\n        width: 50%;\\n    }\\n    .grid-element-container.full-width {\\n        width: 100%;\\n    }\\n    .grid-60 {\\n        width: 60%;\\n    }\\n    .grid-40 {\\n        width: 40%;\\n    }\\n}\\n</style>\\n\\n<div class=\\\"inner-container\\\">\\n    <!-- <TopBar /> -->\\n    <!-- <div class=\\\"grid-x\\\"> -->\\n        <!-- <div class=\\\"project-description\\\">\\n            <Description />\\n        </div> -->\\n        \\n        <Carousel />\\n    <!-- </div> -->\\n</div>\"],\"names\":[],\"mappings\":\"AAQA,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,gBAAgB,cAAC,CAAC,AACd,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,CAAC,CAAC,IAAI,AAClB,CAAC,AACL,CAAC,AASD,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAapC,CAAC,AAUD,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAapC,CAAC\"}"
};
