...
const Image = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<a target="blank" class="${escape(null_to_empty(width))} svelte-196aamf"${add_attribute("href", url, 0)}>
	    <div class="img-container svelte-196aamf">
	      <img${add_attribute("src", imgSrc, 0)}${add_attribute("alt", alt, 0)} class="svelte-196aamf">
	    </div>
	</a>`;
});
