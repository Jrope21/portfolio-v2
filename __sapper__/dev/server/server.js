...
const css$i = {
	code: ".text-container.svelte-p07kta h2.svelte-p07kta{font-size:30rem;color:#808080}@media screen and (min-width: 64em){.text-container.svelte-p07kta h2.svelte-p07kta{font-size:36rem}}.text-container.svelte-p07kta h2.svelte-p07kta::after{content:'';display:block;height:7px;margin:5rem 0px 18rem 0px;background:lightgray}@media screen and (min-width: 40em){h2.svelte-p07kta::after{width:250px}}p.svelte-p07kta{margin:6rem 0rem 10rem 0rem;font-family:'Open Sans', sans-serif;font-weight:300;font-size:13rem;color:#58595b\n    }@media screen and (min-width: 64em){p.svelte-p07kta{font-size:16rem\n        }}div.form-container.svelte-p07kta{box-sizing:border-box;color:gray;width:100%;border-radius:4px;padding:15rem 20rem 40rem 20rem;border:1px solid gray;box-shadow:5px 5px 5px lightgray}@media screen and (min-width: 40em){div.form-container.svelte-p07kta{padding:30rem 20rem 40rem 20rem}}@media screen and (min-width: 64em){div.form-container.svelte-p07kta{padding:40rem 30rem 50rem 30rem}}div.flex-container.svelte-p07kta{display:flex;flex-direction:column}@media screen and (min-width: 40em){div.flex-container.svelte-p07kta{flex-direction:row}}div.text-container.svelte-p07kta{position:relative}@media screen and (min-width: 40em){div.text-container.svelte-p07kta{top:-20px;padding-right:30rem}}div.svelte-p07kta{flex:55%}form.svelte-p07kta{display:flex;flex-direction:column;flex:50%;padding-left:auto}label.svelte-p07kta{display:flex;flex-direction:column;margin:4rem 0px}span.svelte-p07kta{font-size:13rem;margin-bottom:5rem;font-weight:500}@media screen and (min-width: 64em){span.svelte-p07kta{font-size:14rem}}input[type=\"submit\"].svelte-p07kta{width:50%;min-width:96px;margin-top:12rem;padding:6rem;font-size:13rem;box-shadow:1px 1px 3px lightgrey;font-style:italic;background:rgba(88, 89, 91, 0.1);color:#58595B;font-weight:700;transition:all .3s ease-in;cursor:pointer}input[type=\"submit\"].svelte-p07kta:hover{position:relative;transform:translateY(-1px);box-shadow:2px 2px 3px lightgrey}@media screen and (min-width: 40em){input[type=\"submit\"].svelte-p07kta{width:35%;max-width:unset;padding:7rem 15rem 7rem 15rem}}@media screen and (min-width: 64em){input[type=\"submit\"].svelte-p07kta{font-size:13rem;box-shadow:1;width:fit-content}}div.contact-row.svelte-p07kta{display:flex;justify-content:space-between}input.svelte-p07kta,textarea.svelte-p07kta{border:1px solid lightgray;border-radius:2px;font-size:16rem;padding:3rem;box-shadow:.3px .3px .3px gray}.success-message.svelte-p07kta{font-size:50rem;color:#58595b;text-transform:uppercase;position:absolute;top:50%;transform:translate(-50%, -50%);left:50%}.gform.svelte-p07kta,.text-container.svelte-p07kta,.success-message.svelte-p07kta{transition:.35s opacity ease}.hide-content.svelte-p07kta{opacity:0}",
...
const ContactModal = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${ showModal && hideModal === false ? `${validate_component(ModalTemplate, 'ModalTemplate').$$render($$result, { showModal: showModal }, {}, {
		default: () => `
	        <div class="form-container svelte-p07kta">
	            <div class="flex-container svelte-p07kta">
	                    <div class="text-container ${escape(formState.hideFields ? 'hide-content' : '')} ${escape(formState.hideFields ? 'hide-content' : '')} svelte-p07kta">
	                        <h2 class="svelte-p07kta">Get In Touch</h2>
	                        <p class="svelte-p07kta">
	                            Hi There! I’m Josh, 
	                            I bring projects to life by innovating across every aspect of the customer journey. 
	                            Send me a message if you are looking to hire a developer, collaborate on a project, or have a potential business opportunity.
	                        </p>
	                    ...
	                    <form class="gform ${escape(formState.hideFields ? 'hide-content' : '')}
	                        ${escape(formState.formSuccess ? 'hide-content' : '')} svelte-p07kta">
	                        <label class="svelte-p07kta"> <span class="svelte-p07kta">Name</span>
	                            <input name="name" type="text" class="svelte-p07kta"${add_attribute("this", fieldInputs[0], 1)}>
	                        </label>
	                        <label class="svelte-p07kta"> <span class="svelte-p07kta">Email</span>
	                            <input required name="email" type="email" class="svelte-p07kta"${add_attribute("this", fieldInputs[1], 1)}>
	                        </label>
	                        <label class="svelte-p07kta"> <span class="svelte-p07kta">Message</span>
	                            <textarea name="message" rows="6" type="textarea" class="svelte-p07kta"${add_attribute("this", fieldInputs[2], 1)}></textarea>
	                        </label>
	                        <input type="submit" value="Send Message" class="svelte-p07kta">
	                    </form>

	                ${ formState.submittingForm ? `${validate_component(BoxLoader, 'BoxLoader').$$render($$result, {}, {}, {})}` : `` }
	                ${ formState.formSuccess ? `<h2 class="success-message svelte-p07kta">
	                        SUCCESS
	                    </h2>` : `` }
	                ${ formState.formError ? `<h2 class="success-message svelte-p07kta">
	                        ERROR
	                    </h2>` : `` }
	            </div>
	        </div>
