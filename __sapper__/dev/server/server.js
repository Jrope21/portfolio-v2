...
const css$g = {
	code: ".carousel-container.svelte-1h4ecj3{position:relative;display:flex;align-items:flex-end;margin:40rem 0;width:100%;min-height:250px}@media(min-width: 40em){.carousel-container.svelte-1h4ecj3{width:auto}}@media screen and (min-width: 40em){.box.svelte-1h4ecj3{position:relative;display:inline-block;z-index:-1;display:flex;align-items:center;justify-content:flex-end;width:300px;border:3px solid black;border-right:none;height:380px;opacity:0;background:transparent}.box.svelte-1h4ecj3::after{content:'';position:absolute;background:url('../images/so-white.png');background-position-x:1%;border-left:3px solid black;height:9%;width:120px;right:-5px;bottom:-3px}.box.svelte-1h4ecj3::before{content:'';position:absolute;border-right:3px solid black;height:9%;right:0;top:-3px}}@media(min-width: 64em){.box.svelte-1h4ecj3{width:400px;height:516px}.box.svelte-1h4ecj3::after{width:150px}}@media(min-width: 1366px){.box.svelte-1h4ecj3{width:500px;height:616px}}.title.svelte-1h4ecj3{display:none;font-size:40px;position:absolute;color:#58595b;transform:rotate(-90deg);margin-right:-15px;top:50%;left:-20%}@media(min-width: 40em){.title.svelte-1h4ecj3{display:inline;left:-25%\n    }}@media(min-width: 64em){.title.svelte-1h4ecj3{font-size:55px}}@media(min-width: 1366px){.title.svelte-1h4ecj3{font-size:67px}}.slide.svelte-1h4ecj3{position:absolute;left:50%;transform:translateX(-50%);width:450px;max-width:85vw;height:250px;box-shadow:3px 3px 3px lightgrey;margin:0 auto}@media(min-width: 40em){.slide.svelte-1h4ecj3{left:auto;position:absolute;width:88%;height:82%;right:0;top:50%;transform:translateY(-50%);margin:0}}.slide.svelte-1h4ecj3 img.svelte-1h4ecj3{width:100%;height:100%;object-fit:cover;object-position:top}div.circles-container.svelte-1h4ecj3{width:450px;bottom:-30px;margin:0 auto;max-width:85vw;position:absolute;left:50%;transform:translateX(-50%);display:flex;justify-content:flex-start;align-items:flex-start}@media(min-width: 40em){div.circles-container.svelte-1h4ecj3{height:auto;width:auto;transform:none;left:12%;bottom:0}}@media(min-width: 64em){div.circles-container.svelte-1h4ecj3{}}span.circle.svelte-1h4ecj3{position:relative;display:block;width:12px;height:12px;border:2px solid #3B3B3B;border-radius:50%;margin:0px 20px 0 0px;overflow:hidden;cursor:pointer}@media(min-width: 40em){span.circle.svelte-1h4ecj3{margin:0;margin-right:15px}}@media(min-width: 64em){span.circle.svelte-1h4ecj3{width:15px;height:15px}}@media(min-width: 1366px){span.circle.svelte-1h4ecj3{width:18px;height:18px;margin-right:20px}}span.circle.svelte-1h4ecj3::before{content:'';position:absolute;left:0;top:0;width:110%;height:110%;border-radius:50%;background:#3B3B3B;opacity:0;transition:opacity .3s ease}span.circle.active.svelte-1h4ecj3::before{opacity:1}button.next.svelte-1h4ecj3,button.back.svelte-1h4ecj3{position:absolute;width:150px;height:100%;opacity:.3;transition:all .3s ease-out}button.next.svelte-1h4ecj3{right:0;background:linear-gradient(to left,rgba(0,0,0,.65) 0,rgba(0,0,0,0) 100%) rgba(0,0,0,0)}button.back.svelte-1h4ecj3{left:0;background:linear-gradient(to right,rgba(0,0,0,.65) 0,rgba(0,0,0,0) 100%) rgba(0,0,0,0)\n}button.next.svelte-1h4ecj3:hover,button.back.svelte-1h4ecj3:hover{opacity:1}.arrow-left.svelte-1h4ecj3,.arrow-right.svelte-1h4ecj3{display:block;position:absolute;height:20px;width:20px;top:calc(50% - 10px);-webkit-transition:-webkit-transform .2s ease-out;-webkit-transition-delay:.2s;transition:transform .2s ease-out .2s}.arrow-left.svelte-1h4ecj3{left:30px}.arrow-right.svelte-1h4ecj3{right:30px}.arrow-left.svelte-1h4ecj3::before,.arrow-right.svelte-1h4ecj3::before,.arrow-left.svelte-1h4ecj3::after,.arrow-right.svelte-1h4ecj3::after{content:\" \";position:absolute;right:0;height:100%;width:2px;background-color:white;opacity:.7;-webkit-transform-origin:50% 100% 0;transform-origin:50% 100% 0;-webkit-transition:-webkit-transform .15s ease-out;transition:transform .15s ease-out}.arrow-left.svelte-1h4ecj3::before{top:-50%;-webkit-transform:rotate(45deg);transform:rotate(45deg)}.arrow-left.svelte-1h4ecj3::after{top:calc(-50% + -1px);-webkit-transform:rotate(135deg);transform:rotate(135deg)}.arrow-right.svelte-1h4ecj3::before{top:-50%;-webkit-transform:rotate(-45deg);transform:rotate(-45deg)}.arrow-right.svelte-1h4ecj3::after{top:calc(-50% + -1px);-webkit-transform:rotate(-135deg);transform:rotate(-135deg)}",
	map: "{\"version\":3,\"file\":\"Carousel.svelte\",\"sources\":[\"Carousel.svelte\"],\"sourcesContent\":[\"<script>\\nimport { fade, fly } from 'svelte/transition'\\n\\nlet STATE = {\\n    images: [\\n        {\\n            src: 'images/creative-revolt/home.png',\\n            visible: true,\\n            key: 'home',\\n        },\\n        {\\n            src: 'images/creative-revolt/home-ctas.png',\\n            visible: false,\\n            key: 'home-ctas',\\n        },\\n        {\\n            src: 'images/creative-revolt/about.png',\\n            visible: false,\\n            key: 'about',\\n        },\\n        {\\n            src: 'images/creative-revolt/about-cta.png',\\n            visible: false,\\n            key: 'about-ctas',\\n        },\\n        {\\n            src: 'images/creative-revolt/writing-class.png',\\n            visible: false,\\n            key: 'writing-class',\\n        },\\n    ]\\n}\\n\\nfunction switchSlides(key) {\\n    \\n    STATE.images.forEach(img => {\\n        if(key === img.key) {\\n            img.visible = true;\\n            \\n        } else {\\n            img.visible = false;\\n        }\\n    })\\n\\n    STATE = {...STATE};\\n}\\n\\n</script>\\n\\n<style>\\n.carousel-container {\\n    position: relative;\\n    display: flex;\\n    align-items: flex-end;\\n    margin: 40rem 0;\\n    width: 100%;\\n    min-height: 250px;\\n}\\n\\n@media (min-width: 40em) {\\n    .carousel-container {\\n        width: auto;\\n    }\\n}\\n\\n@media screen and (min-width: 40em){\\n    .box {\\n        position: relative;\\n        display: inline-block;\\n        z-index: -1;\\n        display: flex;\\n        align-items: center;\\n        justify-content: flex-end;\\n        width: 300px;\\n        border: 3px solid black;\\n        border-right: none;\\n        height: 380px;\\n        opacity: 0;\\n        background: transparent;\\n    }\\n\\n    .box::after {\\n        content: '';\\n        position: absolute;\\n        background: url('../images/so-white.png');\\n        background-position-x: 1%;\\n        border-left: 3px solid black;\\n        height: 9%;\\n        width: 120px;\\n        right: -5px;\\n        bottom: -3px;\\n    }\\n\\n    .box::before {\\n        content: '';\\n        position: absolute;\\n        border-right: 3px solid black;\\n        height: 9%;\\n        right: 0;\\n        top: -3px;\\n    }\\n}\\n\\n@media (min-width: 64em) {\\n    .box {\\n        width: 400px;\\n        height: 516px;\\n    }\\n    .box::after {\\n        width: 150px;\\n    }\\n}\\n\\n@media (min-width: 1366px) {\\n    .box {\\n        width: 500px;\\n        height: 616px;\\n    }\\n}\\n\\n.title {\\n    display: none;\\n    font-size: 40px;\\n    position: absolute;\\n    color: #58595b;\\n    transform: rotate(-90deg);\\n    margin-right: -15px;\\n    top: 50%;\\n    left: -20%;\\n}\\n\\n@media (min-width: 40em) {\\n    .title {\\n        display: inline;\\n        left: -25%\\n    }\\n}\\n\\n@media (min-width: 64em) {\\n    .title {\\n        font-size: 55px;\\n    }\\n}\\n\\n@media (min-width: 1366px) {\\n    .title {\\n        font-size: 67px;\\n    }\\n}\\n\\n\\n.slide {\\n    position: absolute;\\n    left: 50%;\\n    transform: translateX(-50%);\\n    width: 450px;\\n    max-width: 85vw;\\n    height: 250px;\\n    box-shadow: 3px 3px 3px lightgrey;\\n    margin: 0 auto;\\n}\\n\\n@media (min-width: 40em){\\n    .slide {\\n        left: auto;\\n        position: absolute;\\n        width: 88%;\\n        height: 82%;\\n        right: 0;\\n        top: 50%;\\n        transform: translateY(-50%);\\n        margin: 0;\\n    }\\n}\\n\\n.slide img {\\n    width: 100%;\\n    height: 100%;\\n    object-fit: cover;\\n    object-position: top;  \\n}\\n\\ndiv.circles-container {\\n    width: 450px;\\n    /* height: 250px; */\\n    bottom: -30px;\\n    margin: 0 auto;\\n    max-width: 85vw;\\n    position: absolute;\\n    left: 50%;\\n    transform: translateX(-50%);\\n    display: flex;\\n    justify-content: flex-start;\\n    align-items: flex-start;\\n    /* flex-direction: column; */\\n    /* background: rgba(0,0,0,0.3); */\\n}\\n\\n@media (min-width: 40em) {\\n    div.circles-container {\\n        height: auto;\\n        width: auto;\\n        /* position: static;\\n        margin-left: -10px;\\n        margin-bottom: 10px; */\\n        transform: none;\\n        left: 12%;\\n        bottom: 0;\\n        /* top: 9%; */\\n        /* justify-content: flex-start; */\\n        /* flex-direction: column; */\\n        \\n    }\\n}\\n\\n@media (min-width: 64em) {\\n\\n    div.circles-container {\\n        /* margin-left: -30px;\\n        margin-bottom: 20px; */\\n        \\n    }\\n}\\n\\nspan.circle {\\n    position: relative;\\n    display: block;\\n    width: 12px;\\n    height: 12px;\\n    border: 2px solid #3B3B3B;\\n    border-radius: 50%;\\n    margin: 0px 20px 0 0px;\\n    overflow: hidden;\\n    cursor: pointer;\\n}\\n\\n@media (min-width: 40em) {\\n    span.circle {\\n        margin: 0;\\n        margin-right: 15px;\\n        /* border: 1px solid #3B3B3B; */\\n    }\\n}\\n\\n@media (min-width: 64em) {\\n    span.circle {\\n        width: 15px;\\n        height: 15px;\\n    }\\n}\\n\\n@media (min-width: 1366px) {\\n    span.circle {\\n        width: 18px;\\n        height: 18px;\\n        margin-right: 20px;\\n    }\\n}\\n\\nspan.circle::before {\\n    content: '';\\n    position: absolute;\\n    left: 0;\\n    top: 0;\\n    width: 110%;\\n    height: 110%;\\n    border-radius: 50%;\\n    background: #3B3B3B;\\n    opacity: 0;\\n    transition: opacity .3s ease;\\n}\\n\\nspan.circle.active::before {\\n    opacity: 1;\\n}\\n\\nbutton.next, button.back {\\n    position: absolute;\\n    width: 150px;\\n    height: 100%;\\n    \\n    opacity: .3;\\n    transition: all .3s ease-out;\\n}\\n\\nbutton.next {\\n    right: 0;\\n    background: linear-gradient(to left,rgba(0,0,0,.65) 0,rgba(0,0,0,0) 100%) rgba(0,0,0,0);\\n}\\n\\nbutton.back {\\n    left: 0;\\n    background: linear-gradient(to right,rgba(0,0,0,.65) 0,rgba(0,0,0,0) 100%) rgba(0,0,0,0)\\n}\\n\\nbutton.next:hover, button.back:hover {\\n    opacity: 1;\\n}\\n\\n.arrow-left, .arrow-right {\\n    display: block;\\n    position: absolute;\\n    height: 20px;\\n    width: 20px;\\n    top: calc(50% - 10px);\\n    -webkit-transition: -webkit-transform .2s ease-out;\\n    -webkit-transition-delay: .2s;\\n    transition: transform .2s ease-out .2s;\\n}\\n\\n.arrow-left {\\n    left: 30px;\\n}\\n\\n.arrow-right {\\n    right: 30px;\\n}\\n\\n.arrow-left::before, .arrow-right::before, .arrow-left::after, .arrow-right::after {\\n    content: \\\" \\\";\\n    position: absolute;\\n    right: 0;\\n    height: 100%;\\n    width: 2px;\\n    background-color: white;\\n    opacity: .7;\\n    -webkit-transform-origin: 50% 100% 0;\\n    transform-origin: 50% 100% 0;\\n    -webkit-transition: -webkit-transform .15s ease-out;\\n    transition: transform .15s ease-out;\\n}\\n\\n.arrow-left::before {\\n    top: -50%;\\n    -webkit-transform: rotate(45deg);\\n    transform: rotate(45deg);\\n}\\n\\n.arrow-left::after {\\n    top: calc(-50% + -1px);\\n    -webkit-transform: rotate(135deg);\\n    transform: rotate(135deg);\\n}\\n\\n.arrow-right::before {\\n    top: -50%;\\n    -webkit-transform: rotate(-45deg);\\n    transform: rotate(-45deg);\\n}\\n\\n.arrow-right::after {\\n    top: calc(-50% + -1px);\\n    -webkit-transform: rotate(-135deg);\\n    transform: rotate(-135deg);\\n}\\n</style>\\n\\n<!-- notes to come back to -->\\n<!-- TODO -  -->\\n<div class=\\\"carousel-container\\\">\\n<span class=\\\"title\\\">CREATIVE REVOLT</span>\\n    <div class=\\\"box\\\"></div> <!-- <span class=\\\"title\\\">CREATIVE REVOLT</span> TODO style text to appear nice on fade out-->\\n    <!-- TODO - make top of box longer then bottom -->\\n        {#each STATE.images as img}\\n            {#if img.visible}\\n                <div transition:fly=\\\"{{ x: -40, duration: 550 }}\\\" class=\\\"slide\\\">\\n                    <button class=\\\"back\\\">\\n                        <span class=\\\"arrow-left\\\"></span>\\n                    </button>\\n                    <img src=\\\"{img.src}\\\" alt=\\\"wassup\\\">\\n                    <button class=\\\"next\\\">\\n                        <span class=\\\"arrow-right\\\"></span>\\n                    </button>\\n                </div>\\n            {/if}\\n        {/each}\\n    <div class=\\\"circles-container\\\">\\n        {#each STATE.images as img, i}\\n            <span \\n                on:click={() => {\\n                    switchSlides(img.key)\\n                }} \\n                class=\\\"circle {img.visible ? 'active' : ''}\\\"\\n            ></span>\\n        {/each}\\n    </div>\\n</div>\"],\"names\":[],\"mappings\":\"AAkDA,mBAAmB,eAAC,CAAC,AACjB,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,QAAQ,CACrB,MAAM,CAAE,KAAK,CAAC,CAAC,CACf,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,KAAK,AACrB,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,mBAAmB,eAAC,CAAC,AACjB,KAAK,CAAE,IAAI,AACf,CAAC,AACL,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,IAAI,eAAC,CAAC,AACF,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,YAAY,CACrB,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,QAAQ,CACzB,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CACvB,YAAY,CAAE,IAAI,CAClB,MAAM,CAAE,KAAK,CACb,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,WAAW,AAC3B,CAAC,AAED,mBAAI,OAAO,AAAC,CAAC,AACT,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,IAAI,wBAAwB,CAAC,CACzC,qBAAqB,CAAE,EAAE,CACzB,WAAW,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CAC5B,MAAM,CAAE,EAAE,CACV,KAAK,CAAE,KAAK,CACZ,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC,AAED,mBAAI,QAAQ,AAAC,CAAC,AACV,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,QAAQ,CAClB,YAAY,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CAC7B,MAAM,CAAE,EAAE,CACV,KAAK,CAAE,CAAC,CACR,GAAG,CAAE,IAAI,AACb,CAAC,AACL,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,IAAI,eAAC,CAAC,AACF,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,AACjB,CAAC,AACD,mBAAI,OAAO,AAAC,CAAC,AACT,KAAK,CAAE,KAAK,AAChB,CAAC,AACL,CAAC,AAED,MAAM,AAAC,YAAY,MAAM,CAAC,AAAC,CAAC,
MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,GAAG,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,CACrB,kBAAkB,CAAE,iBAAiB,CAAC,GAAG,CAAC,QAAQ,CAClD,wBAAwB,CAAE,GAAG,CAC7B,UAAU,CAAE,SAAS,CAAC,GAAG,CAAC,QAAQ,CAAC,GAAG,AAC1C,CAAC,AAED,WAAW,eAAC,CAAC,AACT,IAAI,CAAE,IAAI,AACd,CAAC,AAED,YAAY,eAAC,CAAC,AACV,KAAK,CAAE,IAAI,AACf,CAAC,AAED,0BAAW,QAAQ,CAAE,2BAAY,QAAQ,CAAE,0BAAW,OAAO,CAAE,2BAAY,OAAO,AAAC,CAAC,AAChF,OAAO,CAAE,GAAG,CACZ,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,GAAG,CACV,gBAAgB,CAAE,KAAK,CACvB,OAAO,CAAE,EAAE,CACX,wBAAwB,CAAE,GAAG,CAAC,IAAI,CAAC,CAAC,CACpC,gBAAgB,CAAE,GAAG,CAAC,IAAI,CAAC,CAAC,CAC5B,kBAAkB,CAAE,iBAAiB,CAAC,IAAI,CAAC,QAAQ,CACnD,UAAU,CAAE,SAAS,CAAC,IAAI,CAAC,QAAQ,AACvC,CAAC,AAED,0BAAW,QAAQ,AAAC,CAAC,AACjB,GAAG,CAAE,IAAI,CACT,iBAAiB,CAAE,OAAO,KAAK,CAAC,CAChC,SAAS,CAAE,OAAO,KAAK,CAAC,AAC5B,CAAC,AAED,0BAAW,OAAO,AAAC,CAAC,AAChB,GAAG,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,CACtB,iBAAiB,CAAE,OAAO,MAAM,CAAC,CACjC,SAAS,CAAE,OAAO,MAAM,CAAC,AAC7B,CAAC,AAED,2BAAY,QAAQ,AAAC,CAAC,AAClB,GAAG,CAAE,IAAI,CACT,iBAAiB,CAAE,OAAO,MAAM,CAAC,CACjC,SAAS,CAAE,OAAO,MAAM,CAAC,AAC7B,CAAC,AAED,2BAAY,OAAO,AAAC,CAAC,AACjB,GAAG,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,CACtB,iBAAiB,CAAE,OAAO,OAAO,CAAC,CAClC,SAAS,CAAE,OAAO,OAAO,CAAC,AAC9B,CAAC\"}"
};
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="carousel-container svelte-1h4ecj3">
	<span class="title svelte-1h4ecj3">CREATIVE REVOLT</span>
	    <div class="box svelte-1h4ecj3"></div> 
	    
	        ${each(STATE.images, (img) => `${ img.visible ? `<div class="slide svelte-1h4ecj3">
	                    <button class="back svelte-1h4ecj3">
	                        <span class="arrow-left svelte-1h4ecj3"></span>
	                    </button>
	                    <img${add_attribute("src", img.src, 0)} alt="wassup" class="svelte-1h4ecj3">
	                    <button class="next svelte-1h4ecj3">
	                        <span class="arrow-right svelte-1h4ecj3"></span>
	                    </button>
	                </div>` : `` }`)}
	    <div class="circles-container svelte-1h4ecj3">
	        ${each(STATE.images, (img, i) => `<span class="circle ${escape(img.visible ? 'active' : '')} svelte-1h4ecj3"></span>`)}
	    </div>
	</div>`;
});
