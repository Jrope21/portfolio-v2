...
const css$8 = {
	code: "ul.svelte-v9oc06{margin-left:20rem;font-size:12rem}h3.svelte-v9oc06{font-size:12rem;text-transform:uppercase;font-weight:400}",
	map: "{\"version\":3,\"file\":\"Skills.svelte\",\"sources\":[\"Skills.svelte\"],\"sourcesContent\":[\"<script>\\n\\n</script>\\n\\n<style type=\\\"text/scss\\\">\\nul {\\n    margin-left: 20rem;\\n    font-size: 12rem;\\n}\\nh3 {\\n    font-size: 12rem;\\n    text-transform: uppercase;\\n    font-weight: 400;\\n}\\n</style>\\n\\n<section class=\\\"skills\\\">\\n    <h2 class=\\\"headline\\\">Skills</h2>\\n    <div class=\\\"development-section\\\">\\n        <h3>Development</h3>\\n        <ul class=\\\"skills-list\\\">\\n            <li>React</li>\\n            <li>Svelte 3</li>\\n            <li>Sapper</li>\\n            <li>JavaScript (ES6+)</li>\\n            <li>WebPack</li>\\n            <li>Git (Version Control)</li>\\n            <li>jQuery</li> \\n            <li>SASS / SCSS</li>\\n            <li>CSS</li>\\n            <li>Foundation</li>\\n            <li>Bootstrap</li>\\n            <li>HTML (WCAG 2.1)</li>\\n            <li>HTML Emails</li>\\n            <li>GitHub / BitBucket</li>\\n            <li>WordPress / Kentico</li>\\n            <li>Adobe Suite</li>\\n            <li>SEO</li>\\n            <li>Usability Testing</li> \\n        </ul>\\n    </div>\\n    <div class=\\\"design-section\\\">\\n        <h3>Design</h3>\\n        <ul class=\\\"skills-list\\\">\\n            <li>Adobe InDesign</li>\\n            <li>Adobe Illustrator</li>\\n            <li>Adobe XD</li>\\n            <li>Adobe Premiere</li>\\n            <li>Wireframing</li>\\n            <li>Canva</li>\\n        </ul>\\n    </div>\\n</section>\"],\"names\":[],\"mappings\":\"AAKA,EAAE,cAAC,CAAC,AACA,WAAW,CAAE,KAAK,CAClB,SAAS,CAAE,KAAK,AACpB,CAAC,AACD,EAAE,cAAC,CAAC,AACA,SAAS,CAAE,KAAK,CAChB,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,GAAG,AACpB,CAAC\"}"
};
...
const Skills = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="skills">
	    <h2 class="headline">Skills</h2>
	    <div class="development-section">
	        <h3 class="svelte-v9oc06">Development</h3>
	        <ul class="skills-list svelte-v9oc06">
	            <li>React</li>
	            <li>Svelte 3</li>
	            <li>Sapper</li>
	            <li>JavaScript (ES6+)</li>
	    ...
	    <div class="design-section">
	        <h3 class="svelte-v9oc06">Design</h3>
	        <ul class="skills-list svelte-v9oc06">
	            <li>Adobe InDesign</li>
	            <li>Adobe Illustrator</li>
	            <li>Adobe XD</li>
