...
const css$g = {
	code: ".carousel-container.svelte-1jvmv1n{position:relative;display:flex;align-items:flex-end;margin:40rem 0}@media screen and (min-width: 40em){.box.svelte-1jvmv1n{position:relative;display:inline-block;z-index:-1;display:flex;align-items:center;justify-content:flex-end;width:237px;border:3px solid black;border-right:none;height:411px;background:transparent}.box.svelte-1jvmv1n::after{content:'';position:absolute;background:url('../images/so-white.png');background-position-x:1%;border-left:3px solid black;height:9%;width:150px;right:-5px;bottom:-3px}.box.svelte-1jvmv1n::before{content:'';position:absolute;border-right:3px solid black;height:9%;right:0;top:-3px}}@media screen and (min-width: 64em){.box.svelte-1jvmv1n{width:500px;height:616px}}.title.svelte-1jvmv1n{font-size:40px;color:#58595b;transform:rotate(-90deg);margin-right:-15px}.slide.svelte-1jvmv1n{position:absolute;width:88%;height:82%;right:0;top:50%;transform:translateY(-50%);box-shadow:3px 3px 3px lightgrey}img.svelte-1jvmv1n{width:100%;height:100%;object-fit:cover}div.circles-container.svelte-1jvmv1n{display:flex;margin-left:-70px;margin-bottom:20px}span.circle.svelte-1jvmv1n{position:relative;display:block;width:15px;height:15px;border:1px solid #3B3B3B;border-radius:50%;margin-right:25px;overflow:hidden;cursor:pointer}span.circle.svelte-1jvmv1n::before{content:'';position:absolute;left:0;top:0;width:110%;height:110%;border-radius:50%;background:#3B3B3B;opacity:0;transition:opacity .3s ease}span.circle.active.svelte-1jvmv1n::before{opacity:1}",
	map: "{\"version\":3,\"file\":\"Carousel.svelte\",\"sources\":[\"Carousel.svelte\"],\"sourcesContent\":[\"<script>\\nimport { fade, fly } from 'svelte/transition'\\n\\nlet STATE = {\\n    images: [\\n        {\\n            src: 'images/halcyon-5.jpg',\\n            visible: true,\\n            key: 'desktop',\\n        },\\n        {\\n            src: 'images/uptexas-thumb.jpg',\\n            visible: false,\\n            key: 'tablet',\\n        },\\n        {\\n            src: 'images/Jorden-Background-Gray.jpg',\\n            visible: false,\\n            key: 'mobile',\\n        },\\n    ]\\n}\\n\\nfunction switchSlides(key) {\\n    \\n    STATE.images.forEach(img => {\\n        if(key === img.key) {\\n            img.visible = true;\\n            \\n        } else {\\n            img.visible = false;\\n        }\\n    })\\n\\n    STATE = {...STATE};\\n}\\n\\n</script>\\n\\n<style>\\n.carousel-container {\\n    position: relative;\\n    display: flex;\\n    align-items: flex-end;\\n    margin: 40rem 0;\\n}\\n\\n@media screen and (min-width: 40em){\\n    .box {\\n        position: relative;\\n        display: inline-block;\\n        z-index: -1;\\n        display: flex;\\n        align-items: center;\\n        justify-content: flex-end;\\n        width: 237px;\\n        border: 3px solid black;\\n        border-right: none;\\n        height: 411px;\\n        background: transparent;\\n    }\\n\\n    .box::after {\\n        content: '';\\n        position: absolute;\\n        background: url('../images/so-white.png');\\n        background-position-x: 1%;\\n        border-left: 3px solid black;\\n        height: 9%;\\n        width: 150px;\\n        right: -5px;\\n        bottom: -3px;\\n    }\\n\\n    .box::before {\\n        content: '';\\n        position: absolute;\\n        border-right: 3px solid black;\\n        height: 9%;\\n        right: 0;\\n        top: -3px;\\n    }\\n}\\n\\n@media screen and (min-width: 64em) {\\n    .box {\\n        width: 500px;\\n        height: 616px;\\n    }\\n}\\n\\n.title {\\n    font-size: 40px;\\n    color: #58595b;\\n    transform: rotate(-90deg);\\n    margin-right: -15px;\\n}\\n\\n.slide {\\n    position: absolute;\\n    width: 88%;\\n    height: 82%;\\n    right: 0;\\n    top: 50%;\\n    transform: translateY(-50%);\\n    box-shadow: 3px 3px 3px lightgrey;\\n}\\n\\nimg {\\n    width: 100%;\\n    height: 100%;\\n    object-fit: cover;  \\n}\\n\\ndiv.circles-container {\\n    display: flex;\\n    margin-left: -70px;\\n    margin-bottom: 20px;\\n}\\n\\nspan.circle {\\n    position: relative;\\n    display: block;\\n    width: 15px;\\n    height: 15px;\\n    border: 1px solid #3B3B3B;\\n    border-radius: 50%;\\n    margin-right: 25px;\\n    overflow: hidden;\\n    cursor: pointer;\\n    /* transition: opacity .3s ease; */\\n}\\n\\nspan.circle::before {\\n    content: '';\\n    position: absolute;\\n    left: 0;\\n    top: 0;\\n    width: 110%;\\n    height: 110%;\\n    border-radius: 50%;\\n    background: #3B3B3B;\\n    opacity: 0;\\n    transition: opacity .3s ease;\\n}\\n\\nspan.circle.active::before {\\n    opacity: 1;\\n}\\n</style>\\n\\n<!-- notes to come back to -->\\n<!-- TODO -  -->\\n<div class=\\\"carousel-container\\\">\\n    <div class=\\\"box\\\"><span class=\\\"title\\\">CREATIVE REVOLT</span></div> <!-- TODO style text to appear nice on fade out-->\\n    <!-- TODO - make top of box longer then bottom -->\\n        {#each STATE.images as img}\\n            {#if img.visible}\\n                <div transition:fly=\\\"{{ x: -80, duration: 1050 }}\\\" class=\\\"slide\\\">\\n                    <img src=\\\"{img.src}\\\" alt=\\\"wassup\\\">\\n                </div>\\n            {/if}\\n        {/each}\\n    <div class=\\\"circles-container\\\">\\n        {#each STATE.images as img, i}\\n            <span \\n                on:click={() => {\\n                    switchSlides(img.key)\\n                }} \\n                class=\\\"circle {img.visible ? 'active' : ''}\\\"\\n            ></span>\\n        {/each}\\n    </div>\\n</div>\"],\"names\":[],\"mappings\":\"AAwCA,mBAAmB,eAAC,CAAC,AACjB,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,QAAQ,CACrB,MAAM,CAAE,KAAK,CAAC,CAAC,AACnB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,IAAI,eAAC,CAAC,AACF,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,YAAY,CACrB,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,QAAQ,CACzB,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CACvB,YAAY,CAAE,IAAI,CAClB,MAAM,CAAE,KAAK,CACb,UAAU,CAAE,WAAW,AAC3B,CAAC,AAED,mBAAI,OAAO,AAAC,CAAC,AACT,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,IAAI,wBAAwB,CAAC,CACzC,qBAAqB,CAAE,EAAE,CACzB,WAAW,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CAC5B,MAAM,CAAE,EAAE,CACV,KAAK,CAAE,KAAK,CACZ,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC,AAED,mBAAI,QAAQ,AAAC,CAAC,AACV,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,QAAQ,CAClB,YAAY,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CAC7B,MAAM,CAAE,EAAE,CACV,KAAK,CAAE,CAAC,CACR,GAAG,CAAE,IAAI,AACb,CAAC,AACL,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACjC,IAAI,eAAC,CAAC,AACF,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,AACjB,CAAC,AACL,CAAC,AAED,MAAM,eAAC,CAAC,AACJ,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,OAAO,CACd,SAAS,CAAE,OAAO,MAAM,CAAC,CACzB,YAAY,CAAE,KAAK,AACvB,CAAC,AAED,MAAM,eAAC,CAAC,AACJ,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,KAAK,CAAE,CAAC,CACR,GAAG,CAAE,GAAG,CACR,SAAS,CAAE,WAAW,IAAI,CAAC,CAC3B,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,SAAS,AACrC,CAAC,AAED,GAAG,eAAC,CAAC,AACD,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,KAAK,AACrB,CAAC,AAED,GAAG,kBAAkB,eAAC,CAAC,AACnB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,KAAK,CAClB,aAAa,CAAE,IAAI,AACvB,CAAC,AAED,IAAI,OAAO,eAAC,CAAC,AACT,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CACzB,aAAa,CAAE,GAAG,CAClB,YAAY,CAAE,IAAI,CAClB,QAAQ,CAAE,MAAM,CAChB,MAAM,CAAE,OAAO,AAEnB,CAAC,AAED,IAAI,sBAAO,QAAQ,AAAC,CAAC,AACjB,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,CAAC,CACP,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,OAAO,CACnB,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,OAAO,CAAC,GAAG,CAAC,IAAI,AAChC,CAAC,AAED,IAAI,OAAO,sBAAO,QAAQ,AAAC,CAAC,AACxB,OAAO,CAAE,CAAC,AACd,CAAC\"}"
};
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="carousel-container svelte-1jvmv1n">
	    <div class="box svelte-1jvmv1n"><span class="title svelte-1jvmv1n">CREATIVE REVOLT</span></div> 
	    
	        ${each(STATE.images, (img) => `${ img.visible ? `<div class="slide svelte-1jvmv1n">
	                    <img${add_attribute("src", img.src, 0)} alt="wassup" class="svelte-1jvmv1n">
	                </div>` : `` }`)}
	    <div class="circles-container svelte-1jvmv1n">
	        ${each(STATE.images, (img, i) => `<span class="circle ${escape(img.visible ? 'active' : '')} svelte-1jvmv1n"></span>`)}
	    </div>
	</div>`;
});
