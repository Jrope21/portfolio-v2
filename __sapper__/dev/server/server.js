...
const css$9 = {
	code: ".image-grid.svelte-gtxurd{display:flex;flex-wrap:wrap;flex-direction:column;align-items:center;padding-top:8%}@media screen and (min-width: 40em){.image-grid.svelte-gtxurd{flex-direction:row;align-items:unset;width:90%;margin:0 auto}}.grid-element-container.svelte-gtxurd{width:250px;display:flex;justify-content:center;align-items:center;margin-bottom:8%}@media screen and (min-width: 40em){.grid-element-container.svelte-gtxurd{width:50%}.grid-element-container.full-width.svelte-gtxurd{width:100%}.grid-60.svelte-gtxurd{width:60%}.grid-40.svelte-gtxurd{width:40%}}",
	map: "{\"version\":3,\"file\":\"ImageGrid.svelte\",\"sources\":[\"ImageGrid.svelte\"],\"sourcesContent\":[\"<script>\\nimport Image from '../projects/Image.svelte';\\n</script>\\n\\n<style>\\n.image-grid {\\n    display: flex;\\n    flex-wrap: wrap;\\n    flex-direction: column;\\n    align-items: center;\\n    padding-top: 8%;\\n}\\n\\n@media screen and (min-width: 40em){\\n    .image-grid {\\n        flex-direction: row;\\n        align-items: unset;\\n        width: 90%;\\n        margin: 0 auto;\\n    }\\n}\\n\\n.grid-element-container {\\n    width: 250px;\\n    display: flex;\\n    justify-content: center;\\n    align-items: center;\\n    margin-bottom: 8%;\\n}\\n\\n@media screen and (min-width: 40em){\\n    .grid-element-container {\\n        width: 50%;\\n    }\\n    .grid-element-container.full-width {\\n        width: 100%;\\n    }\\n    .grid-60 {\\n        width: 60%;\\n    }\\n    .grid-40 {\\n        width: 40%;\\n    }\\n}\\n</style>\\n\\n<div class=\\\"image-grid\\\">\\n<div class=\\\"grid-element-container full-width\\\"> <!-- this should be a cool designer image (logo shiz) -->\\n        <Image width={'full-width'} imgSrc={'images/Jorden-Background-Gray.jpg'} url={''} alt={''} />\\n    </div>\\n    <div class=\\\"grid-element-container grid-60\\\"> <!-- TODO fix image sizing -- should stay in container -->\\n        <Image width={'large'} imgSrc={'images/Jorden-Background-Gray.jpg'} url={''} alt={''} /> <!-- this should be a tablet view  -- maybe wrap in a curved white border (mimic tablet view) -->\\n    </div>\\n    <div class=\\\"grid-element-container grid-40\\\"> <!-- TODO fix image sizing -- should stay in container -->\\n        <Image width={'large'} imgSrc={'images/Jorden-Background-Gray.jpg'} url={''} alt={''} /> <!-- this should be a mobile view -- maybe wrap in a curved white border (mimic mobile view)-->\\n    </div>\\n    <!-- <div class=\\\"grid-element-container\\\">\\n        <Image width={'large'} imgSrc={'images/Jorden-Background-Gray.jpg'} url={''} alt={''} />\\n    </div>\\n    <div class=\\\"grid-element-container\\\">\\n        <Image width={'large'} imgSrc={'images/Jorden-Background-Gray.jpg'} url={''} alt={''} />\\n    </div> -->\\n    <div class=\\\"grid-element-container full-width\\\">\\n        <Image width={'full-width'} imgSrc={'images/Jorden-Background-Gray.jpg'} url={''} alt={''} /> <!-- this should be a desktop view -- maybe make this one taller then first one??? (max-height 550px?)-->\\n    </div>\\n    <!-- <div class=\\\"grid-element-container full-width\\\">\\n        <Image width={'full-width'} imgSrc={'images/Jorden-Background-Gray.jpg'} url={''} alt={''} />\\n    </div>\\n    <div class=\\\"grid-element-container full-width\\\">\\n        <Image width={'full-width'} imgSrc={'images/Jorden-Background-Gray.jpg'} url={''} alt={''} />\\n    </div> -->\\n</div>\"],\"names\":[],\"mappings\":\"AAKA,WAAW,cAAC,CAAC,AACT,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,IAAI,CACf,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,CACnB,WAAW,CAAE,EAAE,AACnB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,WAAW,cAAC,CAAC,AACT,cAAc,CAAE,GAAG,CACnB,WAAW,CAAE,KAAK,CAClB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,CAAC,CAAC,IAAI,AAClB,CAAC,AACL,CAAC,AAED,uBAAuB,cAAC,CAAC,AACrB,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,EAAE,AACrB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,uBAAuB,cAAC,CAAC,AACrB,KAAK,CAAE,GAAG,AACd,CAAC,AACD,uBAAuB,WAAW,cAAC,CAAC,AAChC,KAAK,CAAE,IAAI,AACf,CAAC,AACD,QAAQ,cAAC,CAAC,AACN,KAAK,CAAE,GAAG,AACd,CAAC,AACD,QAAQ,cAAC,CAAC,AACN,KAAK,CAAE,GAAG,AACd,CAAC,AACL,CAAC\"}"
};

const ImageGrid = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$9);

	return `<div class="image-grid svelte-gtxurd">
	<div class="grid-element-container full-width svelte-gtxurd"> 
	        ${validate_component(Image, 'Image').$$render($$result, {
		width: 'full-width',
		imgSrc: 'images/Jorden-Background-Gray.jpg',
		url: '',
	    ...
	    <div class="grid-element-container grid-60 svelte-gtxurd"> 
	        ${validate_component(Image, 'Image').$$render($$result, {
		width: 'large',
		imgSrc: 'images/Jorden-Background-Gray.jpg',
		url: '',
	    ...
	    <div class="grid-element-container grid-40 svelte-gtxurd"> 
	        ${validate_component(Image, 'Image').$$render($$result, {
		width: 'large',
		imgSrc: 'images/Jorden-Background-Gray.jpg',
		url: '',
...
const Contact = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="svelte-moxglw">
	    ...
	    <div class="social-container svelte-moxglw">
	        <a href="https://www.github.com/Jrope21" aria-label="link to Joshua Roper's GitHub account" target="blank" class="svelte-moxglw"><i class="fab fa-github svelte-moxglw"><span class="svelte-moxglw">www.github.com/Jrope21</span></i></a>
	        <a href="https://www.linkedin.com/in/JR-dev" aria-label="link to Joshua Roper's LinkedIn account" target="blank" class="svelte-moxglw"><i class="fab fa-linkedin svelte-moxglw"><span class="svelte-moxglw">www.linkedin.com/in/JR-dev</span></i></a>
	        <a href="mailto:joshua.micah.roper@gmail.com" aria-label="link to send Joshua Roper an email" target="blank" class="svelte-moxglw"><i class="fas fa-envelope svelte-moxglw"><span class="svelte-moxglw">Joshua.Micah.Roper@gmail.com</span></i></a>
	    </div>
	</div>`;
});
...
const css$m = {
	code: "a.svelte-1pena59{color:#58595b;transition:all .45s ease-in-out;opacity:.75}a.svelte-1pena59:hover{color:black}",
	map: "{\"version\":3,\"file\":\"InlineLink.svelte\",\"sources\":[\"InlineLink.svelte\"],\"sourcesContent\":[\"<script> \\nexport let url, target, text;\\n</script>\\n\\n<style>\\na {\\n    color: #58595b;\\n    transition: all .45s ease-in-out;\\n    opacity: .75;\\n}\\n\\na:hover {\\n    color: black;\\n}\\n</style>\\n\\n<a href=\\\"{url}\\\" target={target}>{text}</a>\"],\"names\":[],\"mappings\":\"AAKA,CAAC,eAAC,CAAC,AACC,KAAK,CAAE,OAAO,CACd,UAAU,CAAE,GAAG,CAAC,IAAI,CAAC,WAAW,CAChC,OAAO,CAAE,GAAG,AAChB,CAAC,AAED,gBAAC,MAAM,AAAC,CAAC,AACL,KAAK,CAAE,KAAK,AAChB,CAAC\"}"
};

const InlineLink = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<a${add_attribute("href", url, 0)}${add_attribute("target", target, 0)} class="svelte-1pena59">${escape(text)}</a>`;
});

/* src/components/footer/Footer.svelte generated by Svelte v3.9.1 */

const css$n = {
	code: "footer.svelte-116wp3q{border-top:1px solid #d6d6d6;background:white;color:#3B3B3B}.footer-container.svelte-116wp3q{margin-top:40px;display:flex;flex-direction:column}@media screen and (min-width: 40em){.footer-container.svelte-116wp3q{flex-direction:row}}.left.svelte-116wp3q,.right.svelte-116wp3q{margin-bottom:40rem}@media screen and (min-width: 40em){.left.svelte-116wp3q{padding-right:80rem;width:60%}.right.svelte-116wp3q{padding-top:20rem}}@media screen and (min-width: 64em){.left.svelte-116wp3q{width:50%}}.text-cta.svelte-116wp3q:first-of-type{margin-bottom:20rem}.headline.svelte-116wp3q{font-size:40px;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;line-height:45px;font-weight:700;max-width:400px}.title.svelte-116wp3q{font-weight:100;font-size:12rem}.text-cta.svelte-116wp3q a.svelte-116wp3q{font-size:14rem}.copyright.svelte-116wp3q{font-size:12rem;font-style:italic;font-weight:300}@media screen and (min-width: 64em){.title.svelte-116wp3q{font-size:16rem\n    }.text-cta.svelte-116wp3q a.svelte-116wp3q{font-size:18rem}.copyright.svelte-116wp3q{font-size:14rem}.headline.svelte-116wp3q{font-size:45px}}",
	map: "{\"version\":3,\"file\":\"Footer.svelte\",\"sources\":[\"Footer.svelte\"],\"sourcesContent\":[\"<script>\\nimport TextAnimation from '../helper-components/TextAnimation.svelte';\\nimport InlineLink from '../helper-components/InlineLink.svelte';\\n</script>\\n\\n<style>\\nfooter {\\n    border-top: 1px solid #d6d6d6;\\n    background: white;\\n    color: #3B3B3B;\\n}\\n\\n.footer-container {\\n    margin-top: 40px;\\n    display: flex;\\n    flex-direction: column;\\n}\\n\\n@media screen and (min-width: 40em){\\n    .footer-container {\\n        flex-direction: row;\\n    }\\n}\\n\\n.left, .right {\\n    margin-bottom: 40rem;\\n}\\n\\n@media screen and (min-width: 40em){\\n    .left{\\n        padding-right: 80rem;\\n        width:60%;\\n    }\\n    .right {\\n        padding-top: 20rem;\\n    }\\n}\\n\\n@media screen and (min-width: 64em){\\n    .left {\\n        width: 50%;\\n    }\\n}\\n\\n.text-cta:first-of-type {\\n    margin-bottom: 20rem;\\n}\\n\\n.headline {\\n    font-size: 40px;\\n    font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;\\n    line-height: 45px;\\n    font-weight: 700;\\n    max-width: 400px;\\n}\\n\\n.title {\\n    font-weight: 100;\\n    font-size: 12rem;\\n}\\n\\n.text-cta a {\\n    font-size: 14rem;\\n}\\n\\n.copyright {\\n    font-size: 12rem;\\n    font-style: italic;\\n    font-weight: 300;\\n}\\n\\n@media screen and (min-width: 64em){\\n    .title{\\n        font-size: 16rem\\n    }\\n    .text-cta a {\\n        font-size: 18rem;\\n    }\\n    .copyright {\\n        font-size: 14rem;\\n    }\\n    .headline {\\n        font-size: 45px;\\n    }\\n}\\n\\n</style>\\n\\n<footer>\\n    <div class=\\\"container footer-container\\\">\\n        <div class=\\\"left\\\">\\n            <p class=\\\"headline\\\">\\n                Feel free to shoot me an <InlineLink url={'mailto:joshua.micah.roper@gmail.com'} text={'email'} /> & connect on <InlineLink url={'mailto:joshua.micah.roper@gmail.com'} text={'social'} target={'blank'} />\\n            </p>\\n            \\n        </div>\\n        <div class=\\\"right\\\">\\n            <div class=\\\"text-cta\\\">\\n                <p class=\\\"title\\\">\\n                    Get In Touch!\\n                </p>\\n                <a href=\\\"mailto:joshua.micah.roper@gmail.com\\\">\\n                    <TextAnimation text={`Joshua.micah.roper@gmail.com`} />\\n                </a>\\n            </div>\\n            <div class=\\\"text-cta\\\">\\n                <p class=\\\"title\\\">\\n                    View Resume\\n                </p>\\n                <a href=\\\"./images/resume-joshua-roper.pdf\\\" download>\\n                    <TextAnimation text={`Download PDF`} />\\n                </a>\\n            </div>\\n        </div>\\n    </div>\\n    <p class=\\\"copyright container\\\">\\n        @ 2019 Joshua Roper Development\\n    </p>\\n</footer>\"],\"names\":[],\"mappings\":\"AAMA,MAAM,eAAC,CAAC,AACJ,UAAU,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CAC7B,UAAU,CAAE,KAAK,CACjB,KAAK,CAAE,OAAO,AAClB,CAAC,AAED,iBAAiB,eAAC,CAAC,AACf,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,AAC1B,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,iBAAiB,eAAC,CAAC,AACf,cAAc,CAAE,GAAG,AACvB,CAAC,AACL,CAAC,AAED,oBAAK,CAAE,MAAM,eAAC,CAAC,AACX,aAAa,CAAE,KAAK,AACxB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,oBAAK,CAAC,AACF,aAAa,CAAE,KAAK,CACpB,MAAM,GAAG,AACb,CAAC,AACD,MAAM,eAAC,CAAC,AACJ,WAAW,CAAE,KAAK,AACtB,CAAC,AACL,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,KAAK,eAAC,CAAC,AACH,KAAK,CAAE,GAAG,AACd,CAAC,AACL,CAAC,AAED,wBAAS,cAAc,AAAC,CAAC,AACrB,aAAa,CAAE,KAAK,AACxB,CAAC,AAED,SAAS,eAAC,CAAC,AACP,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,aAAa,CAAC,CAAC,kBAAkB,CAAC,CAAC,UAAU,CAAC,CAAC,QAAQ,CAAC,CAAC,QAAQ,CAAC,CAAC,QAAQ,CAAC,CAAC,WAAW,CAAC,CAAC,YAAY,CAAC,CAAC,gBAAgB,CAAC,CAAC,UAAU,CACjJ,WAAW,CAAE,IAAI,CACjB,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,KAAK,AACpB,CAAC,AAED,MAAM,eAAC,CAAC,AACJ,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,KAAK,AACpB,CAAC,AAED,wBAAS,CAAC,CAAC,eAAC,CAAC,AACT,SAAS,CAAE,KAAK,AACpB,CAAC,AAED,UAAU,eAAC,CAAC,AACR,SAAS,CAAE,KAAK,CAChB,UAAU,CAAE,MAAM,CAClB,WAAW,CAAE,GAAG,AACpB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AAChC,qBAAM,CAAC,AACH,SAAS,CAAE,KAAK;IACpB,CAAC,AACD,wBAAS,CAAC,CAAC,eAAC,CAAC,AACT,SAAS,CAAE,KAAK,AACpB,CAAC,AACD,UAAU,eAAC,CAAC,AACR,SAAS,CAAE,KAAK,AACpB,CAAC,AACD,SAAS,eAAC,CAAC,AACP,SAAS,CAAE,IAAI,AACnB,CAAC,AACL,CAAC\"}"
};

const Footer = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$n);

	return `<footer class="svelte-116wp3q">
	    <div class="container footer-container svelte-116wp3q">
	        <div class="left svelte-116wp3q">
	            <p class="headline svelte-116wp3q">
	                Feel free to shoot me an ${validate_component(InlineLink, 'InlineLink').$$render($$result, { url: 'mailto:joshua.micah.roper@gmail.com', text: 'email' }, {}, {})} &amp; connect on ${validate_component(InlineLink, 'InlineLink').$$render($$result, {
		...
		target: 'blank'
	        ...
	        <div class="right svelte-116wp3q">
	            <div class="text-cta svelte-116wp3q">
	                <p class="title svelte-116wp3q">
	                    Get In Touch!
	                </p>
	                <a href="mailto:joshua.micah.roper@gmail.com" class="svelte-116wp3q">
	            ...
	            <div class="text-cta svelte-116wp3q">
	                ...
	                <a href="./images/resume-joshua-roper.pdf" download class="svelte-116wp3q">
	                    ${validate_component(TextAnimation, 'TextAnimation').$$render($$result, { text: `Download PDF` }, {}, {})}
	                </a>
	            </div>
	        </div>
	    </div>
	    <p class="copyright container svelte-116wp3q">
	        @ 2019 Joshua Roper Development
	    </p>
	</footer>`;
});
