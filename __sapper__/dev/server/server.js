...
const css$i = {
	code: ".text-container.svelte-1g2xpsi h2.svelte-1g2xpsi{font-size:30rem;color:#808080}@media screen and (min-width: 64em){.text-container.svelte-1g2xpsi h2.svelte-1g2xpsi{font-size:36rem}}.text-container.svelte-1g2xpsi h2.svelte-1g2xpsi::after{content:'';display:block;height:7px;margin:5rem 0px 18rem 0px;background:lightgray}@media screen and (min-width: 40em){h2.svelte-1g2xpsi::after{width:250px}}p.svelte-1g2xpsi{margin:6rem 0rem 10rem 0rem;font-family:'Open Sans', sans-serif;font-weight:300;font-size:13rem;color:#58595b\n    }@media screen and (min-width: 64em){p.svelte-1g2xpsi{font-size:16rem\n        }}div.form-container.svelte-1g2xpsi{box-sizing:border-box;color:gray;width:100%;border-radius:4px;padding:15rem 20rem 40rem 20rem;border:1px solid gray;box-shadow:5px 5px 5px lightgray}@media screen and (min-width: 40em){div.form-container.svelte-1g2xpsi{padding:30rem 20rem 40rem 20rem}}@media screen and (min-width: 64em){div.form-container.svelte-1g2xpsi{padding:40rem 30rem 50rem 30rem}}div.flex-container.svelte-1g2xpsi{display:flex;flex-direction:column}@media screen and (min-width: 40em){div.flex-container.svelte-1g2xpsi{flex-direction:row}}div.text-container.svelte-1g2xpsi{position:relative}@media screen and (min-width: 40em){div.text-container.svelte-1g2xpsi{top:-20px;padding-right:30rem}}div.svelte-1g2xpsi{flex:55%}form.svelte-1g2xpsi{display:flex;flex-direction:column;flex:50%;padding-left:auto}label.svelte-1g2xpsi{display:flex;flex-direction:column;margin:4rem 0px}span.svelte-1g2xpsi{font-size:13rem;margin-bottom:5rem;font-weight:500}@media screen and (min-width: 64em){span.svelte-1g2xpsi{font-size:14rem}}input[type=\"submit\"].svelte-1g2xpsi{width:50%;min-width:96px;margin-top:12rem;padding:6rem;font-size:13rem;box-shadow:1px 1px 3px lightgrey;font-style:italic;background:rgba(88, 89, 91, 0.1);color:#58595B;font-weight:700;transition:all .3s ease-in;cursor:pointer}input[type=\"submit\"].svelte-1g2xpsi:hover{position:relative;transform:translateY(-1px);box-shadow:2px 2px 3px lightgrey}@media screen and (min-width: 40em){input[type=\"submit\"].svelte-1g2xpsi{width:35%}}@media screen and (min-width: 64em){input[type=\"submit\"].svelte-1g2xpsi{font-size:13rem;max-width:unset;padding:7rem 15rem 7rem 15rem;box-shadow:1;width:fit-content}}div.contact-row.svelte-1g2xpsi{display:flex;justify-content:space-between}input.svelte-1g2xpsi,textarea.svelte-1g2xpsi{border:1px solid lightgray;border-radius:2px;font-size:16rem;padding:3rem;box-shadow:.3px .3px .3px gray}.success-message.svelte-1g2xpsi{font-size:50rem;color:#58595b;text-transform:uppercase;position:absolute;top:50%;transform:translate(-50%, -50%);left:50%}.gform.svelte-1g2xpsi,.text-container.svelte-1g2xpsi,.success-message.svelte-1g2xpsi{transition:.35s opacity ease}.hide-content.svelte-1g2xpsi{opacity:0}",
...
const ContactModal = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${ showModal && hideModal === false ? `${validate_component(ModalTemplate, 'ModalTemplate').$$render($$result, { showModal: showModal }, {}, {
		default: () => `
	        <div class="form-container svelte-1g2xpsi">
	            <div class="flex-container svelte-1g2xpsi">
	                    <div class="text-container ${escape(formState.hideFields ? 'hide-content' : '')} ${escape(formState.hideFields ? 'hide-content' : '')} svelte-1g2xpsi">
	                        <h2 class="svelte-1g2xpsi">Get In Touch</h2>
	                        <p class="svelte-1g2xpsi">
	                            Hi There! I’m Josh, 
	                            I bring projects to life by innovating across every aspect of the customer journey. 
	                            Send me a message if you are looking to hire a developer, collaborate on a project, or have a potential business opportunity.
	                        </p>
	                    ...
	                    <form class="gform ${escape(formState.hideFields ? 'hide-content' : '')}
	                        ${escape(formState.formSuccess ? 'hide-content' : '')} svelte-1g2xpsi">
	                        <label class="svelte-1g2xpsi"> <span class="svelte-1g2xpsi">Name</span>
	                            <input name="name" type="text" class="svelte-1g2xpsi"${add_attribute("this", fieldInputs[0], 1)}>
	                        </label>
	                        <label class="svelte-1g2xpsi"> <span class="svelte-1g2xpsi">Email</span>
	                            <input required name="email" type="email" class="svelte-1g2xpsi"${add_attribute("this", fieldInputs[1], 1)}>
	                        </label>
	                        <label class="svelte-1g2xpsi"> <span class="svelte-1g2xpsi">Message</span>
	                            <textarea name="message" rows="6" type="textarea" class="svelte-1g2xpsi"${add_attribute("this", fieldInputs[2], 1)}></textarea>
	                        </label>
	                        <input type="submit" value="Send Message" class="svelte-1g2xpsi">
	                    </form>

	                ${ formState.submittingForm ? `${validate_component(BoxLoader, 'BoxLoader').$$render($$result, {}, {}, {})}` : `` }
	                ${ formState.formSuccess ? `<h2 class="success-message svelte-1g2xpsi">
	                        SUCCESS
	                    </h2>` : `` }
	                ${ formState.formError ? `<h2 class="success-message svelte-1g2xpsi">
	                        ERROR
	                    </h2>` : `` }
	            </div>
	        </div>
