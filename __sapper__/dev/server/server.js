...
const Creative_revolt_route = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return ``;
});
...
const manifest = {
	...
	pages: [
		...
		{
			// projects/creative-revolt.route.svelte
			pattern: /^\/projects\/creative-revolt.route\/?$/,
			parts: [
				null,
				{ name: "projects_creative$45revolt_route", file: "projects/creative-revolt.route.svelte", component: Creative_revolt_route }
			]
		},
