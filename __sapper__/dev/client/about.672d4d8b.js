...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-10s6808");
			add_location(h3, file$1, 80, 4, 1278);
			add_location(strong0, file$1, 84, 43, 1361);
			add_location(strong1, file$1, 85, 12, 1450);
			add_location(strong2, file$1, 86, 30, 1592);
			add_location(strong3, file$1, 87, 28, 1671);
			add_location(strong4, file$1, 88, 30, 1791);
			attr(p, "class", "svelte-10s6808");
			add_location(p, file$1, 83, 4, 1314);
			attr(div, "class", "svelte-10s6808");
			add_location(div, file$1, 79, 0, 1268);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-1cjafcw");
			add_location(h3, file$3, 84, 4, 1365);
			attr(span0, "class", "svelte-1cjafcw");
			add_location(span0, file$3, 88, 141, 1572);
			attr(i0, "class", "fab fa-github svelte-1cjafcw");
			add_location(i0, file$3, 88, 116, 1547);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-1cjafcw");
			add_location(a0, file$3, 88, 8, 1439);
			attr(span1, "class", "svelte-1cjafcw");
			add_location(span1, file$3, 89, 149, 1765);
			attr(i1, "class", "fab fa-linkedin svelte-1cjafcw");
			add_location(i1, file$3, 89, 122, 1738);
			...
			attr(a1, "class", "svelte-1cjafcw");
			add_location(a1, file$3, 89, 8, 1624);
			attr(span2, "class", "svelte-1cjafcw");
			add_location(span2, file$3, 90, 145, 1958);
			attr(i2, "class", "fas fa-envelope svelte-1cjafcw");
			add_location(i2, file$3, 90, 118, 1931);
			...
			attr(a2, "class", "svelte-1cjafcw");
			add_location(a2, file$3, 90, 8, 1821);
			attr(div0, "class", "social-container svelte-1cjafcw");
			add_location(div0, file$3, 87, 4, 1400);
			attr(div1, "class", "svelte-1cjafcw");
			add_location(div1, file$3, 83, 0, 1355);
		},
