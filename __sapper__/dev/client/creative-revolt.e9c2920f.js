...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-ntp0wy");
			add_location(img, file$3, 102, 20, 1927);
			attr(div, "class", "slide svelte-ntp0wy");
			add_location(div, file$3, 101, 16, 1842);
		},
...
// (100:8) {#each STATE.images as img}
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-ntp0wy");
			add_location(span, file$3, 108, 12, 2096);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-ntp0wy")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-ntp0wy");
			add_location(div0, file$3, 98, 4, 1736);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 106, 4, 2023);
			attr(div2, "class", "carousel-container svelte-ntp0wy");
			add_location(div2, file$3, 97, 0, 1699);
		},
