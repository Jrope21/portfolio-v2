...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1wzjkp3");
			add_location(img, file$3, 128, 20, 2347);
			attr(div, "class", "slide svelte-1wzjkp3");
			add_location(div, file$3, 127, 16, 2262);
		},
...
// (126:8) {#each STATE.images as img}
...
// (134:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1wzjkp3");
			add_location(span, file$3, 134, 12, 2526);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1wzjkp3")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-1wzjkp3");
			add_location(div0, file$3, 124, 4, 2156);
			attr(div1, "class", "circles-container svelte-1wzjkp3");
			add_location(div1, file$3, 132, 4, 2443);
			attr(div2, "class", "carousel-container svelte-1wzjkp3");
			add_location(div2, file$3, 123, 0, 2119);
		},
