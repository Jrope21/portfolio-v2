...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span0, file, 32, 4, 527);
			attr(span1, "class", "hover-animation svelte-1qap1g0");
			add_location(span1, file, 31, 0, 492);
		},
