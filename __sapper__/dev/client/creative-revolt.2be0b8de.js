...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h10, "class", "title svelte-1bjhozf");
			add_location(h10, file$2, 73, 12, 1631);
			attr(section0, "class", "");
			add_location(section0, file$2, 77, 8, 1689);
			attr(h11, "class", "svelte-1bjhozf");
			add_location(h11, file$2, 81, 12, 1807);
			attr(p, "class", "svelte-1bjhozf");
			add_location(p, file$2, 82, 12, 1836);
			attr(section1, "class", "inner-container svelte-1bjhozf");
			add_location(section1, file$2, 80, 8, 1761);
			attr(div, "class", "container");
			add_location(div, file$2, 72, 8, 1595);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file$2, 69, 0, 1480);
		},
