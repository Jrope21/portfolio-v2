...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1tybr47");
			add_location(img, file$3, 151, 20, 3023);
			attr(div, "class", "slide svelte-1tybr47");
			add_location(div, file$3, 150, 16, 2938);
		},
...
// (149:8) {#each STATE.images as img}
...
// (157:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1tybr47");
			add_location(span, file$3, 157, 12, 3202);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1tybr47")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-1tybr47");
			add_location(span, file$3, 146, 21, 2701);
			attr(div0, "class", "box svelte-1tybr47");
			add_location(div0, file$3, 146, 4, 2684);
			attr(div1, "class", "circles-container svelte-1tybr47");
			add_location(div1, file$3, 155, 4, 3119);
			attr(div2, "class", "carousel-container svelte-1tybr47");
			add_location(div2, file$3, 145, 0, 2647);
		},
