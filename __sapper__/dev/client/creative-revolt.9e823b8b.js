...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h10, "class", "title svelte-127sers");
			add_location(h10, file$2, 63, 12, 1496);
			attr(section0, "class", "");
			add_location(section0, file$2, 67, 8, 1554);
			attr(h11, "class", "svelte-127sers");
			add_location(h11, file$2, 71, 12, 1672);
			attr(section1, "class", "inner-container svelte-127sers");
			add_location(section1, file$2, 70, 8, 1626);
			attr(div, "class", "container");
			add_location(div, file$2, 62, 8, 1460);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file$2, 59, 0, 1345);
		},
