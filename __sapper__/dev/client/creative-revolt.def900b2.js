...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1yks5vg");
			add_location(img, file$3, 127, 20, 2313);
			attr(div, "class", "slide svelte-1yks5vg");
			add_location(div, file$3, 126, 16, 2228);
		},
...
// (125:8) {#each STATE.images as img}
...
// (133:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1yks5vg");
			add_location(span, file$3, 133, 12, 2492);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1yks5vg")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-1yks5vg");
			add_location(div0, file$3, 123, 4, 2122);
			attr(div1, "class", "circles-container svelte-1yks5vg");
			add_location(div1, file$3, 131, 4, 2409);
			attr(div2, "class", "carousel-container svelte-1yks5vg");
			add_location(div2, file$3, 122, 0, 2085);
		},
