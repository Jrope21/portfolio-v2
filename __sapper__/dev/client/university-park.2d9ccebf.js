...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(section0, file, 123, 16, 3140);
			attr(section1, "class", "skills-container svelte-mu6yvw");
			add_location(section1, file, 126, 16, 3261);
			attr(p, "class", "svelte-mu6yvw");
			add_location(p, file, 130, 20, 3412);
			attr(section2, "class", "cta svelte-mu6yvw");
			add_location(section2, file, 129, 16, 3370);
			attr(div0, "class", "inner-container svelte-mu6yvw");
			add_location(div0, file, 121, 12, 3050);
			attr(div1, "class", "container");
			add_location(div1, file, 119, 8, 2962);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file, 117, 0, 2904);
		},
