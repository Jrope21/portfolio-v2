...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "svelte-c1recs");
			add_location(h1, file$2, 47, 8, 1122);
			attr(section, "class", "container");
			add_location(section, file$2, 50, 8, 1157);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file$2, 44, 0, 1007);
		},
