...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-m6510m");
			add_location(div0, file$3, 50, 4, 842);
			attr(img, "src", "images/Jorden-Background-Gray.jpg");
			attr(img, "alt", "wassup");
			add_location(img, file$3, 52, 8, 898);
			attr(div1, "class", "slide svelte-m6510m");
			add_location(div1, file$3, 51, 4, 870);
			attr(div2, "class", "carousel-container svelte-m6510m");
			add_location(div2, file$3, 49, 0, 805);
		},
