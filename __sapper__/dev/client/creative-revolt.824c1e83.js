...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(button0, file$1, 300, 20, 5766);
			attr(img, "src", img_src_value = ctx.img.src);
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-d2icjp");
			add_location(img, file$1, 301, 20, 5822);
			attr(button1, "class", "next svelte-d2icjp");
			add_location(button1, file$1, 302, 20, 5877);
			attr(div, "class", "slide svelte-d2icjp");
			add_location(div, file$1, 299, 16, 5681);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-d2icjp");
			add_location(span, file$1, 308, 12, 6053);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-d2icjp")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-d2icjp");
			add_location(span, file$1, 294, 0, 5379);
			attr(div0, "class", "box svelte-d2icjp");
			add_location(div0, file$1, 295, 4, 5426);
			attr(div1, "class", "circles-container svelte-d2icjp");
			add_location(div1, file$1, 306, 4, 5970);
			attr(div2, "class", "carousel-container svelte-d2icjp");
			add_location(div2, file$1, 293, 0, 5346);
		},
