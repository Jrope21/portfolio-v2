import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.7b6ec29c.js';
import { P as Projects } from './Projects.22daba61.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-1jx8tk");
			add_location(div0, file$3, 74, 4, 2199);
			attr_dev(h2, "class", "svelte-1jx8tk");
			add_location(h2, file$3, 78, 8, 2284);
			attr_dev(h3, "class", "subheading svelte-1jx8tk");
			add_location(h3, file$3, 79, 8, 2333);
			attr_dev(br, "class", "svelte-1jx8tk");
			add_location(br, file$3, 81, 287, 2680);
			attr_dev(p, "class", "svelte-1jx8tk");
			add_location(p, file$3, 80, 8, 2389);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn svelte-1jx8tk");
			add_location(a, file$3, 84, 8, 2953);
			attr_dev(div1, "class", "text-content svelte-1jx8tk");
			add_location(div1, file$3, 77, 4, 2249);
			attr_dev(section, "class", "text-with-image-cta svelte-1jx8tk");
			add_location(section, file$3, 73, 0, 2157);
		},
		m: function mount(target, anchor) {
