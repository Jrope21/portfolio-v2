import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.95da6f37.js';
import { P as Projects } from './Projects.f8532619.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-db72vf");
			add_location(div0, file$3, 88, 4, 2609);
			attr_dev(h2, "class", "svelte-db72vf");
			add_location(h2, file$3, 92, 8, 2694);
			attr_dev(h3, "class", "subheading svelte-db72vf");
			add_location(h3, file$3, 93, 8, 2743);
			attr_dev(br, "class", "svelte-db72vf");
			add_location(br, file$3, 95, 287, 3090);
			attr_dev(p, "class", "svelte-db72vf");
			add_location(p, file$3, 94, 8, 2799);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn svelte-db72vf");
			add_location(a, file$3, 98, 8, 3363);
			attr_dev(div1, "class", "text-content svelte-db72vf");
			add_location(div1, file$3, 91, 4, 2659);
			attr_dev(section, "class", "text-with-image-cta svelte-db72vf");
			add_location(section, file$3, 87, 0, 2567);
		},
		m: function mount(target, anchor) {
