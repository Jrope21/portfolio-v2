...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1j82mjh");
			add_location(img, file$3, 108, 20, 2000);
			attr(div, "class", "slide svelte-1j82mjh");
			add_location(div, file$3, 107, 16, 1915);
		},
...
// (106:8) {#each STATE.images as img}
...
// (114:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1j82mjh");
			add_location(span, file$3, 114, 12, 2179);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1j82mjh")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-1j82mjh");
			add_location(div0, file$3, 104, 4, 1809);
			attr(div1, "class", "circles-container svelte-1j82mjh");
			add_location(div1, file$3, 112, 4, 2096);
			attr(div2, "class", "carousel-container svelte-1j82mjh");
			add_location(div2, file$3, 103, 0, 1772);
		},
