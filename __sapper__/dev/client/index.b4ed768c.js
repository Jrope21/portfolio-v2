import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.38d3cb00.js';
import { P as Projects } from './Projects.2decaa7c.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-mbu3zy");
			add_location(img, file$3, 155, 8, 4023);
			attr_dev(div0, "class", "image-container svelte-mbu3zy");
			add_location(div0, file$3, 154, 4, 3985);
			attr_dev(h2, "class", "heading svelte-mbu3zy");
			add_location(h2, file$3, 158, 8, 4128);
			attr_dev(h3, "class", "subheading svelte-mbu3zy");
			add_location(h3, file$3, 159, 8, 4202);
			attr_dev(p, "class", "svelte-mbu3zy");
			add_location(p, file$3, 160, 8, 4276);
			attr_dev(a, "class", "button svelte-mbu3zy");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 166, 8, 4880);
			attr_dev(div1, "class", "text-content svelte-mbu3zy");
			add_location(div1, file$3, 157, 4, 4093);
			attr_dev(section, "class", "text-with-image-cta svelte-mbu3zy");
			add_location(section, file$3, 153, 0, 3943);
		},
		m: function mount(target, anchor) {
