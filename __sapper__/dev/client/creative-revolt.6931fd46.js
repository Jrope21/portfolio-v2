...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 99, 20, 1822);
			attr(div, "class", "slide svelte-1rkoq0s");
			add_location(div, file$3, 98, 16, 1782);
		},
...
// (105:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 105, 12, 1991);
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$3, 95, 4, 1676);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 103, 4, 1918);
			attr(div2, "class", "carousel-container svelte-1rkoq0s");
			add_location(div2, file$3, 94, 0, 1639);
		},
