...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-smav9d");
			add_location(h3, file$2, 103, 4, 1742);
			attr(li0, "class", "svelte-smav9d");
			add_location(li0, file$2, 107, 12, 1812);
			attr(li1, "class", "svelte-smav9d");
			add_location(li1, file$2, 108, 12, 1839);
			attr(li2, "class", "svelte-smav9d");
			add_location(li2, file$2, 109, 12, 1869);
			attr(li3, "class", "svelte-smav9d");
			add_location(li3, file$2, 110, 12, 1897);
			attr(li4, "class", "svelte-smav9d");
			add_location(li4, file$2, 111, 12, 1936);
			attr(li5, "class", "svelte-smav9d");
			add_location(li5, file$2, 112, 12, 1965);
			attr(li6, "class", "svelte-smav9d");
			add_location(li6, file$2, 113, 12, 2008);
			attr(li7, "class", "svelte-smav9d");
			add_location(li7, file$2, 114, 12, 2037);
			attr(li8, "class", "svelte-smav9d");
			add_location(li8, file$2, 115, 12, 2070);
			attr(li9, "class", "svelte-smav9d");
			add_location(li9, file$2, 116, 12, 2095);
			attr(li10, "class", "svelte-smav9d");
			add_location(li10, file$2, 117, 12, 2127);
			attr(li11, "class", "svelte-smav9d");
			add_location(li11, file$2, 118, 12, 2158);
			attr(li12, "class", "svelte-smav9d");
			add_location(li12, file$2, 119, 12, 2195);
			attr(li13, "class", "svelte-smav9d");
			add_location(li13, file$2, 120, 12, 2228);
			attr(li14, "class", "svelte-smav9d");
			add_location(li14, file$2, 121, 12, 2268);
			attr(li15, "class", "svelte-smav9d");
			add_location(li15, file$2, 122, 12, 2309);
			attr(li16, "class", "svelte-smav9d");
			add_location(li16, file$2, 123, 12, 2342);
			attr(li17, "class", "svelte-smav9d");
			add_location(li17, file$2, 124, 12, 2367);
			attr(ul, "class", "skills svelte-smav9d");
			add_location(ul, file$2, 106, 8, 1780);
			attr(div, "class", "svelte-smav9d");
			add_location(div, file$2, 102, 0, 1732);
		},
