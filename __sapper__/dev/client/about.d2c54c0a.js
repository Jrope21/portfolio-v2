...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "svelte-z6jjnx");
			add_location(h1, file, 141, 8, 2889);
			attr(span, "class", "svelte-z6jjnx");
			add_location(span, file, 142, 8, 2914);
			attr(div0, "class", div0_class_value = "title-container " + ctx.sidePage + " svelte-z6jjnx");
			add_location(div0, file, 140, 4, 2840);
			attr(div1, "class", "page-header svelte-z6jjnx");
			add_location(div1, file, 139, 0, 2810);
		},
		...
		p: function update(changed, ctx) {
			...
			if ((changed.sidePage) && div0_class_value !== (div0_class_value = "title-container " + ctx.sidePage + " svelte-z6jjnx")) {
