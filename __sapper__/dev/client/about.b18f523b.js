...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-r114fo");
			add_location(h3, file$1, 101, 4, 2613);
			attr(strong0, "class", "svelte-r114fo");
			add_location(strong0, file$1, 105, 43, 2696);
			attr(strong1, "class", "svelte-r114fo");
			add_location(strong1, file$1, 106, 12, 2785);
			attr(strong2, "class", "svelte-r114fo");
			add_location(strong2, file$1, 107, 30, 2927);
			attr(strong3, "class", "svelte-r114fo");
			add_location(strong3, file$1, 108, 28, 3006);
			attr(strong4, "class", "svelte-r114fo");
			add_location(strong4, file$1, 109, 30, 3126);
			attr(p, "class", "svelte-r114fo");
			add_location(p, file$1, 104, 4, 2649);
			attr(div, "class", "svelte-r114fo");
			add_location(div, file$1, 100, 0, 2603);
		},
