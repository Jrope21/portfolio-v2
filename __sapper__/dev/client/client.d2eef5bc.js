...
/* src/node_modules/@sapper/internal/error.svelte generated by Svelte v3.9.1 */
const { Error: Error_1 } = globals;

const file$7 = "src/node_modules/@sapper/internal/error.svelte";
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(pre, file$7, 10, 1, 141);
		},
...
function create_fragment$7(ctx) {
	...
	var if_block =  create_if_block$1(ctx);
	...
	return {
		...
		h: function hydrate() {
			add_location(h1, file$7, 5, 0, 59);
			add_location(p, file$7, 7, 0, 78);
		},
...
class Error$1 extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$5, create_fragment$7, safe_not_equal, ["error", "status"]);
