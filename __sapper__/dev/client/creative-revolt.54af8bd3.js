...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$3, 72, 4, 1217);
			attr(img, "src", "images/Jorden-Background-Gray.jpg");
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1rkoq0s");
			add_location(img, file$3, 74, 12, 1281);
			attr(div1, "class", "slide svelte-1rkoq0s");
			add_location(div1, file$3, 73, 8, 1249);
			attr(span0, "class", "circle");
			add_location(span0, file$3, 77, 8, 1389);
			attr(span1, "class", "circle");
			add_location(span1, file$3, 78, 8, 1433);
			attr(span2, "class", "circle");
			add_location(span2, file$3, 79, 8, 1477);
			attr(div2, "class", "circles");
			add_location(div2, file$3, 76, 4, 1359);
			attr(div3, "class", "carousel-container svelte-1rkoq0s");
			add_location(div3, file$3, 71, 0, 1180);
		},
