import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.cf41d185.js';
import { P as Projects } from './Projects.96885bbd.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1esav4v");
			add_location(img, file$3, 135, 8, 3568);
			attr_dev(div0, "class", "image-container svelte-1esav4v");
			add_location(div0, file$3, 134, 4, 3530);
			attr_dev(h2, "class", "heading svelte-1esav4v");
			add_location(h2, file$3, 138, 8, 3673);
			attr_dev(h3, "class", "subheading svelte-1esav4v");
			add_location(h3, file$3, 139, 8, 3747);
			attr_dev(p, "class", "svelte-1esav4v");
			add_location(p, file$3, 140, 8, 3821);
			attr_dev(a, "class", "button svelte-1esav4v");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 146, 8, 4414);
			attr_dev(div1, "class", "text-content svelte-1esav4v");
			add_location(div1, file$3, 137, 4, 3638);
			attr_dev(section, "class", "text-with-image-cta svelte-1esav4v");
