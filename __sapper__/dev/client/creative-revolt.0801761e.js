...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 96, 20, 1800);
			attr(div, "class", "slide svelte-1rkoq0s");
			add_location(div, file$3, 95, 16, 1760);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 105, 12, 2092);
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$3, 92, 4, 1654);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 103, 4, 2019);
			attr(div2, "class", "carousel-container svelte-1rkoq0s");
			add_location(div2, file$3, 91, 0, 1617);
		},
