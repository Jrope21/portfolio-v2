import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.7339368a.js';
import { P as Projects } from './Projects.14c6886d.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-mdxgvw");
			add_location(img, file$3, 143, 8, 3717);
			attr_dev(div0, "class", "image-container svelte-mdxgvw");
			add_location(div0, file$3, 142, 4, 3679);
			attr_dev(h2, "class", "heading svelte-mdxgvw");
			add_location(h2, file$3, 146, 8, 3822);
			attr_dev(h3, "class", "subheading svelte-mdxgvw");
			add_location(h3, file$3, 147, 8, 3896);
			attr_dev(p, "class", "svelte-mdxgvw");
			add_location(p, file$3, 148, 8, 3970);
			attr_dev(a, "class", "button svelte-mdxgvw");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 154, 8, 4651);
			attr_dev(div1, "class", "text-content svelte-mdxgvw");
			add_location(div1, file$3, 145, 4, 3787);
			attr_dev(section, "class", "text-with-image-cta svelte-mdxgvw");
			add_location(section, file$3, 141, 0, 3637);
		},
		m: function mount(target, anchor) {
