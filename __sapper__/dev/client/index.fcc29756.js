import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.cb7f5347.js';
import { P as Projects } from './Projects.a655394e.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-8dkq2b");
			add_location(img, file$3, 166, 8, 4322);
			attr_dev(div0, "class", "image-container svelte-8dkq2b");
			add_location(div0, file$3, 165, 4, 4284);
			attr_dev(h2, "class", "heading svelte-8dkq2b");
			add_location(h2, file$3, 169, 8, 4427);
			attr_dev(h3, "class", "subheading svelte-8dkq2b");
			add_location(h3, file$3, 170, 8, 4501);
			attr_dev(p, "class", "svelte-8dkq2b");
			add_location(p, file$3, 171, 8, 4575);
			attr_dev(a, "class", "button svelte-8dkq2b");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 177, 8, 5179);
			attr_dev(div1, "class", "text-content svelte-8dkq2b");
			add_location(div1, file$3, 168, 4, 4392);
			attr_dev(section, "class", "text-with-image-cta svelte-8dkq2b");
