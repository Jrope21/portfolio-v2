...
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 84, 16, 1522);
			attr(div, "class", "slide svelte-1rkoq0s");
			add_location(div, file$3, 83, 12, 1486);
		},
...
// (92:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 92, 12, 1792);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$3, 81, 4, 1414);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 90, 4, 1719);
			attr(div2, "class", "carousel-container svelte-1rkoq0s");
			add_location(div2, file$3, 80, 0, 1377);
		},
