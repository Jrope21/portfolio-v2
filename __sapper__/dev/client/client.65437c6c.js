...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-122zesv");
			add_location(h1, file$b, 42, 1, 1489);
			attr_dev(h2, "class", "svelte-122zesv");
			add_location(h2, file$b, 43, 1, 1506);
			attr_dev(div, "class", "text-container container svelte-122zesv");
...
const components = [
	{
		js: () => Promise.all([import('./index.031c6864.js'), __inject_styles(["client-53946229.css","halcyon-5-min-9ec22285.css","index-f9894ff4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./experience.e6ab79ff.js'), __inject_styles(["client-53946229.css","experience-7af911e7.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./creative-revolt.804e1964.js'), __inject_styles(["client-53946229.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css","creative-revolt-387c384c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./university-park.8452847b.js'), __inject_styles(["client-53946229.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./di-repairs.efcd49f6.js'), __inject_styles(["client-53946229.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./stallion.81554bb1.js'), __inject_styles(["client-53946229.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./halcyon.9a737b2d.js'), __inject_styles(["client-53946229.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./projects.724fd6bc.js'), __inject_styles(["client-53946229.css","halcyon-5-min-9ec22285.css","PageTitle-fbf706b4.css","projects-61f9fec4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./about.c53dad46.js'), __inject_styles(["client-53946229.css","about-3acc9d53.css"])]).then(function(x) { return x[0]; })
	}
];
