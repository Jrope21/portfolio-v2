...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-7k6un8");
			add_location(img, file$3, 138, 20, 2710);
			attr(div, "class", "slide svelte-7k6un8");
			add_location(div, file$3, 137, 16, 2625);
		},
		...
		i: function intro(local) {
			if (current) return;
			add_render_callback(() => {
				if (!div_transition) div_transition = create_bidirectional_transition(div, fly$1, { x: -70, duration: 750 }, true);
		...
		o: function outro(local) {
			if (!div_transition) div_transition = create_bidirectional_transition(div, fly$1, { x: -70, duration: 750 }, false);
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-7k6un8");
			add_location(span, file$3, 144, 12, 2889);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-7k6un8")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-7k6un8");
			add_location(span, file$3, 133, 21, 2388);
			attr(div0, "class", "box svelte-7k6un8");
			add_location(div0, file$3, 133, 4, 2371);
			attr(div1, "class", "circles-container svelte-7k6un8");
			add_location(div1, file$3, 142, 4, 2806);
			attr(div2, "class", "carousel-container svelte-7k6un8");
			add_location(div2, file$3, 132, 0, 2334);
		},
