import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.463c8194.js';
import { P as Projects } from './Projects.fb1a8105.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-bl8h8l");
			add_location(div0, file$3, 101, 4, 2875);
			attr_dev(h2, "class", "heading svelte-bl8h8l");
			add_location(h2, file$3, 105, 8, 2960);
			attr_dev(h3, "class", "subheading svelte-bl8h8l");
			add_location(h3, file$3, 106, 8, 3025);
			attr_dev(br0, "class", "svelte-bl8h8l");
			add_location(br0, file$3, 108, 287, 3390);
			attr_dev(br1, "class", "svelte-bl8h8l");
			add_location(br1, file$3, 108, 293, 3396);
			attr_dev(p, "class", "svelte-bl8h8l");
			add_location(p, file$3, 107, 8, 3099);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn svelte-bl8h8l");
			add_location(a, file$3, 111, 8, 3669);
			attr_dev(div1, "class", "text-content svelte-bl8h8l");
			add_location(div1, file$3, 104, 4, 2925);
			attr_dev(section, "class", "text-with-image-cta svelte-bl8h8l");
			add_location(section, file$3, 100, 0, 2833);
		},
		m: function mount(target, anchor) {
