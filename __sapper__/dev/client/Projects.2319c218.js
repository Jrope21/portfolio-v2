...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file$2, 176, 4, 6815);
			attr_dev(div, "class", "projects-container svelte-lb4k03");
			add_location(div, file$2, 177, 4, 6843);
			attr_dev(section, "class", "svelte-lb4k03");
			add_location(section, file$2, 175, 0, 6801);
		},
		m: function mount(target, anchor) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	let portfolioCards = [
		...
		},
		{
			...
			projectYear: "2020",
			projectText: `As the only developer & designer on this freelance project. I completely re-envisioned the site design & built the project from the ground up as an extremely performant SSG website. I utilized development & design best practices latest best practices to offer the user the best experience possible.`
		},
		{
