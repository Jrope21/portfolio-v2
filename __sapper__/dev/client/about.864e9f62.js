...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-1fgckj7");
			add_location(h3, file$3, 89, 4, 1550);
			attr(span0, "class", "svelte-1fgckj7");
			add_location(span0, file$3, 93, 141, 1757);
			attr(i0, "class", "fab fa-github svelte-1fgckj7");
			add_location(i0, file$3, 93, 116, 1732);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-1fgckj7");
			add_location(a0, file$3, 93, 8, 1624);
			attr(span1, "class", "svelte-1fgckj7");
			add_location(span1, file$3, 94, 149, 1950);
			attr(i1, "class", "fab fa-linkedin svelte-1fgckj7");
			add_location(i1, file$3, 94, 122, 1923);
			...
			attr(a1, "class", "svelte-1fgckj7");
			add_location(a1, file$3, 94, 8, 1809);
			attr(span2, "class", "svelte-1fgckj7");
			add_location(span2, file$3, 95, 145, 2143);
			attr(i2, "class", "fas fa-envelope svelte-1fgckj7");
			add_location(i2, file$3, 95, 118, 2116);
			...
			attr(a2, "class", "svelte-1fgckj7");
			add_location(a2, file$3, 95, 8, 2006);
			attr(div0, "class", "social-container svelte-1fgckj7");
			add_location(div0, file$3, 92, 4, 1585);
			attr(div1, "class", "svelte-1fgckj7");
			add_location(div1, file$3, 88, 0, 1540);
		},
