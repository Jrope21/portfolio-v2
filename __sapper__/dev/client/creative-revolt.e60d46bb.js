...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-q5yu0j");
			add_location(img, file$3, 154, 20, 3020);
			attr(div, "class", "slide svelte-q5yu0j");
			add_location(div, file$3, 153, 16, 2935);
		},
...
// (152:8) {#each STATE.images as img}
...
// (160:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-q5yu0j");
			add_location(span, file$3, 160, 12, 3199);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-q5yu0j")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-q5yu0j");
			add_location(span, file$3, 149, 21, 2698);
			attr(div0, "class", "box svelte-q5yu0j");
			add_location(div0, file$3, 149, 4, 2681);
			attr(div1, "class", "circles-container svelte-q5yu0j");
			add_location(div1, file$3, 158, 4, 3116);
			attr(div2, "class", "carousel-container svelte-q5yu0j");
			add_location(div2, file$3, 148, 0, 2644);
		},
