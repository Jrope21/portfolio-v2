import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.3537ae65.js';
import { P as Projects } from './Projects.c495b9e2.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-r3c2hn");
			add_location(img, file$3, 132, 8, 3505);
			attr_dev(div0, "class", "image-container svelte-r3c2hn");
			add_location(div0, file$3, 131, 4, 3467);
			attr_dev(h2, "class", "heading svelte-r3c2hn");
			add_location(h2, file$3, 135, 8, 3610);
			attr_dev(h3, "class", "subheading svelte-r3c2hn");
			add_location(h3, file$3, 136, 8, 3684);
			attr_dev(br0, "class", "svelte-r3c2hn");
			add_location(br0, file$3, 139, 12, 4062);
			attr_dev(br1, "class", "svelte-r3c2hn");
			add_location(br1, file$3, 139, 18, 4068);
			attr_dev(p, "class", "svelte-r3c2hn");
			add_location(p, file$3, 137, 8, 3758);
			attr_dev(a, "class", "button svelte-r3c2hn");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 143, 8, 4342);
			attr_dev(div1, "class", "text-content svelte-r3c2hn");
			add_location(div1, file$3, 134, 4, 3575);
			attr_dev(section, "class", "text-with-image-cta svelte-r3c2hn");
			add_location(section, file$3, 130, 0, 3425);
		},
		m: function mount(target, anchor) {
