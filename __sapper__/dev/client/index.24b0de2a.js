...
function create_fragment$4(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h2, file$4, 81, 4, 1576);
			attr(span, "class", "year svelte-1jek2ir");
			add_location(span, file$4, 83, 8, 1615);
			html_tag = new HtmlTag(ctx.projectText, null);
			attr(p, "class", "svelte-1jek2ir");
			add_location(p, file$4, 82, 4, 1603);
			attr(a, "target", "blank");
			attr(a, "href", ctx.url);
			attr(a, "class", "svelte-1jek2ir");
			add_location(a, file$4, 86, 4, 1696);
			add_location(div, file$4, 80, 0, 1566);
		},
