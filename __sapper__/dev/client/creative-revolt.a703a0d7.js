...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			add_location(img, file$1, 236, 20, 4521);
			attr(div, "class", "slide svelte-1oy87h3");
			add_location(div, file$1, 235, 16, 4436);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 242, 12, 4700);
