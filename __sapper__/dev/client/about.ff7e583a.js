...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h3, file$2, 109, 4, 1796);
			attr(li0, "class", "svelte-1yh9nhf");
			add_location(li0, file$2, 113, 12, 1866);
			attr(li1, "class", "svelte-1yh9nhf");
			add_location(li1, file$2, 114, 12, 1893);
			attr(li2, "class", "svelte-1yh9nhf");
			add_location(li2, file$2, 115, 12, 1923);
			attr(li3, "class", "svelte-1yh9nhf");
			add_location(li3, file$2, 116, 12, 1951);
			attr(li4, "class", "svelte-1yh9nhf");
			add_location(li4, file$2, 117, 12, 1990);
			attr(li5, "class", "svelte-1yh9nhf");
			add_location(li5, file$2, 118, 12, 2019);
			attr(li6, "class", "svelte-1yh9nhf");
			add_location(li6, file$2, 119, 12, 2062);
			attr(li7, "class", "svelte-1yh9nhf");
			add_location(li7, file$2, 120, 12, 2091);
			attr(li8, "class", "svelte-1yh9nhf");
			add_location(li8, file$2, 121, 12, 2124);
			attr(li9, "class", "svelte-1yh9nhf");
			add_location(li9, file$2, 122, 12, 2149);
			attr(li10, "class", "svelte-1yh9nhf");
			add_location(li10, file$2, 123, 12, 2181);
			attr(li11, "class", "svelte-1yh9nhf");
			add_location(li11, file$2, 124, 12, 2212);
			attr(li12, "class", "svelte-1yh9nhf");
			add_location(li12, file$2, 125, 12, 2249);
			attr(li13, "class", "svelte-1yh9nhf");
			add_location(li13, file$2, 126, 12, 2282);
			attr(li14, "class", "svelte-1yh9nhf");
			add_location(li14, file$2, 127, 12, 2322);
			attr(li15, "class", "svelte-1yh9nhf");
			add_location(li15, file$2, 128, 12, 2363);
			attr(li16, "class", "svelte-1yh9nhf");
			add_location(li16, file$2, 129, 12, 2396);
			attr(li17, "class", "svelte-1yh9nhf");
			add_location(li17, file$2, 130, 12, 2421);
			attr(ul, "class", "skills svelte-1yh9nhf");
			add_location(ul, file$2, 112, 8, 1834);
			attr(div, "class", "svelte-1yh9nhf");
			add_location(div, file$2, 108, 0, 1786);
		},
