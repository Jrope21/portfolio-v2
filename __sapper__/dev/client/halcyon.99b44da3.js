...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(a, file, 138, 20, 3725);
			attr(section2, "class", "cta svelte-1riw4zc");
			add_location(section2, file, 137, 16, 3683);
