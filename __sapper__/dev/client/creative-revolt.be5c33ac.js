...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "container svelte-11cz145");
			add_location(h1, file$2, 59, 12, 1446);
			attr(div, "class", "container title-container svelte-11cz145");
