...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div, "class", "container svelte-wumcr3");
			add_location(div, file, 65, 0, 3725);
		},
