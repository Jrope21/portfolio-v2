...
// (100:12) {#if img.visible}
function create_if_block(ctx) {
	var div, t, img, img_src_value, div_transition, current;
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1rkoq0s");
			add_location(img, file$3, 102, 20, 1936);
			attr(div, "class", "slide svelte-1rkoq0s");
			add_location(div, file$3, 100, 16, 1829);
		},
		...
		i: function intro(local) {
			if (current) return;
			add_render_callback(() => {
				if (!div_transition) div_transition = create_bidirectional_transition(div, fly$1, { x: -200, duration: 1000 }, true);
		...
		o: function outro(local) {
			if (!div_transition) div_transition = create_bidirectional_transition(div, fly$1, { x: -200, duration: 1000 }, false);
...
// (108:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	var span, t0, t1, t2, span_class_value, dispose;
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(span_nodes, "circle ");
			t1 = claim_text(span_nodes, ctx.i);
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1rkoq0s");
			add_location(span, file$3, 108, 12, 2105);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1rkoq0s")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-1rkoq0s");
			add_location(div0, file$3, 97, 4, 1723);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 106, 4, 2032);
			attr(div2, "class", "carousel-container svelte-1rkoq0s");
			add_location(div2, file$3, 96, 0, 1686);
		},
