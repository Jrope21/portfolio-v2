...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-mdd0i6");
			add_location(h3, file$3, 84, 4, 1389);
			attr(span0, "class", "svelte-mdd0i6");
			add_location(span0, file$3, 88, 141, 1596);
			attr(i0, "class", "fab fa-github svelte-mdd0i6");
			add_location(i0, file$3, 88, 116, 1571);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-mdd0i6");
			add_location(a0, file$3, 88, 8, 1463);
			attr(span1, "class", "svelte-mdd0i6");
			add_location(span1, file$3, 89, 149, 1789);
			attr(i1, "class", "fab fa-linkedin svelte-mdd0i6");
			add_location(i1, file$3, 89, 122, 1762);
			...
			attr(a1, "class", "svelte-mdd0i6");
			add_location(a1, file$3, 89, 8, 1648);
			attr(span2, "class", "svelte-mdd0i6");
			add_location(span2, file$3, 90, 145, 1982);
			attr(i2, "class", "fas fa-envelope svelte-mdd0i6");
			add_location(i2, file$3, 90, 118, 1955);
			...
			attr(a2, "class", "svelte-mdd0i6");
			add_location(a2, file$3, 90, 8, 1845);
			attr(div0, "class", "social-container svelte-mdd0i6");
			add_location(div0, file$3, 87, 4, 1424);
			attr(div1, "class", "svelte-mdd0i6");
			add_location(div1, file$3, 83, 0, 1379);
		},
