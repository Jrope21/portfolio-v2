...
function create_fragment$4(ctx) {
	...
	return {
		...
		i: function intro(local) {
			...
			if (!div0_intro) {
				add_render_callback(() => {
					div0_intro = create_in_transition(div0, fly, { x: -40, duration: 500, delay: 200, });
					div0_intro.start();
				});
			}
			...
			if (!div2_intro) {
				add_render_callback(() => {
					div2_intro = create_in_transition(div2, fly, { x: -40, duration: 500, delay: 750, });
					div2_intro.start();
				});
			}
