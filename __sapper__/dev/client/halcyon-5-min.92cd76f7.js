...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-145hmji");
			add_location(img, file, 78, 6, 1350);
			attr_dev(div, "class", "img-container svelte-145hmji");
			add_location(div, file, 77, 4, 1316);
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*width*/ ctx[3]) + " svelte-145hmji"));
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*width*/ 8 && a_class_value !== (a_class_value = "" + (null_to_empty(/*width*/ ctx[3]) + " svelte-145hmji"))) {
