...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-3nfgrs");
			add_location(h3, file$1, 66, 4, 1021);
			add_location(strong0, file$1, 70, 43, 1104);
			add_location(strong1, file$1, 71, 12, 1193);
			add_location(strong2, file$1, 72, 30, 1335);
			add_location(strong3, file$1, 73, 28, 1414);
			add_location(strong4, file$1, 74, 30, 1534);
			attr(p, "class", "svelte-3nfgrs");
			add_location(p, file$1, 69, 4, 1057);
			attr(div, "class", "svelte-3nfgrs");
			add_location(div, file$1, 65, 0, 1011);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-17xmmvg");
			add_location(h3, file$3, 119, 4, 2915);
			attr(span0, "class", "svelte-17xmmvg");
			add_location(span0, file$3, 123, 141, 3122);
			attr(i0, "class", "fab fa-github svelte-17xmmvg");
			add_location(i0, file$3, 123, 116, 3097);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-17xmmvg");
			add_location(a0, file$3, 123, 8, 2989);
			attr(span1, "class", "svelte-17xmmvg");
			add_location(span1, file$3, 124, 149, 3315);
			attr(i1, "class", "fab fa-linkedin svelte-17xmmvg");
			add_location(i1, file$3, 124, 122, 3288);
			...
			attr(a1, "class", "svelte-17xmmvg");
			add_location(a1, file$3, 124, 8, 3174);
			attr(span2, "class", "svelte-17xmmvg");
			add_location(span2, file$3, 125, 145, 3508);
			attr(i2, "class", "fas fa-envelope svelte-17xmmvg");
			add_location(i2, file$3, 125, 118, 3481);
			...
			attr(a2, "class", "svelte-17xmmvg");
			add_location(a2, file$3, 125, 8, 3371);
			attr(div0, "class", "social-container svelte-17xmmvg");
			add_location(div0, file$3, 122, 4, 2950);
			attr(div1, "class", "svelte-17xmmvg");
			add_location(div1, file$3, 118, 0, 2905);
		},
