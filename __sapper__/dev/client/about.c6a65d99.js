...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-pla2tv");
			add_location(h3, file$3, 88, 4, 1524);
			attr(span0, "class", "svelte-pla2tv");
			add_location(span0, file$3, 92, 141, 1731);
			attr(i0, "class", "fab fa-github svelte-pla2tv");
			add_location(i0, file$3, 92, 116, 1706);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-pla2tv");
			add_location(a0, file$3, 92, 8, 1598);
			attr(span1, "class", "svelte-pla2tv");
			add_location(span1, file$3, 93, 149, 1924);
			attr(i1, "class", "fab fa-linkedin svelte-pla2tv");
			add_location(i1, file$3, 93, 122, 1897);
			...
			attr(a1, "class", "svelte-pla2tv");
			add_location(a1, file$3, 93, 8, 1783);
			attr(span2, "class", "svelte-pla2tv");
			add_location(span2, file$3, 94, 145, 2117);
			attr(i2, "class", "fas fa-envelope svelte-pla2tv");
			add_location(i2, file$3, 94, 118, 2090);
			...
			attr(a2, "class", "svelte-pla2tv");
			add_location(a2, file$3, 94, 8, 1980);
			attr(div0, "class", "social-container svelte-pla2tv");
			add_location(div0, file$3, 91, 4, 1559);
			attr(div1, "class", "svelte-pla2tv");
			add_location(div1, file$3, 87, 0, 1514);
		},
