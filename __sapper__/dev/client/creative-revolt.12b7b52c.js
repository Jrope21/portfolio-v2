...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1s25sz3");
			add_location(img, file$3, 159, 20, 3160);
			attr(div, "class", "slide svelte-1s25sz3");
			add_location(div, file$3, 158, 16, 3075);
		},
...
// (157:8) {#each STATE.images as img}
...
// (165:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1s25sz3");
			add_location(span, file$3, 165, 12, 3339);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1s25sz3")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-1s25sz3");
			add_location(span, file$3, 154, 21, 2838);
			attr(div0, "class", "box svelte-1s25sz3");
			add_location(div0, file$3, 154, 4, 2821);
			attr(div1, "class", "circles-container svelte-1s25sz3");
			add_location(div1, file$3, 163, 4, 3256);
			attr(div2, "class", "carousel-container svelte-1s25sz3");
			add_location(div2, file$3, 153, 0, 2784);
		},
