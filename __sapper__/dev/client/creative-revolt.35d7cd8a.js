...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-1l1txvt");
			add_location(div0, file$3, 61, 4, 991);
			attr(img, "src", "images/Jorden-Background-Gray.jpg");
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1l1txvt");
			add_location(img, file$3, 63, 12, 1055);
			attr(div1, "class", "slide svelte-1l1txvt");
			add_location(div1, file$3, 62, 8, 1023);
			attr(span0, "class", "circle");
			add_location(span0, file$3, 66, 8, 1163);
			attr(span1, "class", "circle");
			add_location(span1, file$3, 67, 8, 1207);
			attr(span2, "class", "circle");
			add_location(span2, file$3, 68, 8, 1251);
			attr(div2, "class", "circles");
			add_location(div2, file$3, 65, 4, 1133);
			attr(div3, "class", "carousel-container svelte-1l1txvt");
			add_location(div3, file$3, 60, 0, 954);
		},
