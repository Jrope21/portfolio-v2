...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1w1s3jr");
			add_location(img, file$3, 109, 20, 2047);
			attr(div, "class", "slide svelte-1w1s3jr");
			add_location(div, file$3, 108, 16, 1962);
		},
...
// (107:8) {#each STATE.images as img}
...
// (115:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1w1s3jr");
			add_location(span, file$3, 115, 12, 2226);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1w1s3jr")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-1w1s3jr");
			add_location(div0, file$3, 105, 4, 1856);
			attr(div1, "class", "circles-container svelte-1w1s3jr");
			add_location(div1, file$3, 113, 4, 2143);
			attr(div2, "class", "carousel-container svelte-1w1s3jr");
			add_location(div2, file$3, 104, 0, 1819);
		},
