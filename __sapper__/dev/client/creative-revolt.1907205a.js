...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-qczpky");
			add_location(img, file$3, 130, 20, 2446);
			attr(div, "class", "slide svelte-qczpky");
			add_location(div, file$3, 129, 16, 2361);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-qczpky");
			add_location(span, file$3, 136, 12, 2625);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-qczpky")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-qczpky");
			add_location(div0, file$3, 126, 4, 2255);
			attr(div1, "class", "circles-container svelte-qczpky");
			add_location(div1, file$3, 134, 4, 2542);
			attr(div2, "class", "carousel-container svelte-qczpky");
			add_location(div2, file$3, 125, 0, 2218);
		},
