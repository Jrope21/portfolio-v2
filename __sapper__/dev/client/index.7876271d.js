import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.587ac05f.js';
import { P as Projects } from './Projects.2411d889.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file$3, 184, 8, 4847);
			attr_dev(h3, "class", "subheading svelte-7ftf6n");
			add_location(h3, file$3, 185, 8, 4921);
			attr_dev(p, "class", "svelte-7ftf6n");
			add_location(p, file$3, 186, 8, 4995);
			attr_dev(a, "class", "button svelte-7ftf6n");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 192, 8, 5599);
			attr_dev(div1, "class", "text-content svelte-7ftf6n");
			add_location(div1, file$3, 183, 4, 4812);
