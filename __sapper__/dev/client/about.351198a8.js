...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h3, file$1, 109, 4, 1796);
			attr(li0, "class", "svelte-1yh9nhf");
			add_location(li0, file$1, 113, 12, 1866);
			attr(li1, "class", "svelte-1yh9nhf");
			add_location(li1, file$1, 114, 12, 1893);
			attr(li2, "class", "svelte-1yh9nhf");
			add_location(li2, file$1, 115, 12, 1923);
			attr(li3, "class", "svelte-1yh9nhf");
			add_location(li3, file$1, 116, 12, 1951);
			attr(li4, "class", "svelte-1yh9nhf");
			add_location(li4, file$1, 117, 12, 1990);
			attr(li5, "class", "svelte-1yh9nhf");
			add_location(li5, file$1, 118, 12, 2019);
			attr(li6, "class", "svelte-1yh9nhf");
			add_location(li6, file$1, 119, 12, 2062);
			attr(li7, "class", "svelte-1yh9nhf");
			add_location(li7, file$1, 120, 12, 2091);
			attr(li8, "class", "svelte-1yh9nhf");
			add_location(li8, file$1, 121, 12, 2124);
			attr(li9, "class", "svelte-1yh9nhf");
			add_location(li9, file$1, 122, 12, 2149);
			attr(li10, "class", "svelte-1yh9nhf");
			add_location(li10, file$1, 123, 12, 2181);
			attr(li11, "class", "svelte-1yh9nhf");
			add_location(li11, file$1, 124, 12, 2212);
			attr(li12, "class", "svelte-1yh9nhf");
			add_location(li12, file$1, 125, 12, 2249);
			attr(li13, "class", "svelte-1yh9nhf");
			add_location(li13, file$1, 126, 12, 2282);
			attr(li14, "class", "svelte-1yh9nhf");
			add_location(li14, file$1, 127, 12, 2322);
			attr(li15, "class", "svelte-1yh9nhf");
			add_location(li15, file$1, 128, 12, 2363);
			attr(li16, "class", "svelte-1yh9nhf");
			add_location(li16, file$1, 129, 12, 2396);
			attr(li17, "class", "svelte-1yh9nhf");
			add_location(li17, file$1, 130, 12, 2421);
			attr(ul, "class", "skills svelte-1yh9nhf");
			add_location(ul, file$1, 112, 8, 1834);
			attr(div, "class", "svelte-1yh9nhf");
			add_location(div, file$1, 108, 0, 1786);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h3, file$2, 88, 4, 1516);
			attr(span0, "class", "svelte-1cjafcw");
			add_location(span0, file$2, 92, 141, 1723);
			attr(i0, "class", "fab fa-github svelte-1cjafcw");
			add_location(i0, file$2, 92, 116, 1698);
			...
			add_location(a0, file$2, 92, 8, 1590);
			attr(span1, "class", "svelte-1cjafcw");
			add_location(span1, file$2, 93, 149, 1916);
			attr(i1, "class", "fab fa-linkedin svelte-1cjafcw");
			add_location(i1, file$2, 93, 122, 1889);
			...
			add_location(a1, file$2, 93, 8, 1775);
			attr(span2, "class", "svelte-1cjafcw");
			add_location(span2, file$2, 94, 145, 2109);
			attr(i2, "class", "fas fa-envelope svelte-1cjafcw");
			add_location(i2, file$2, 94, 118, 2082);
			...
			add_location(a2, file$2, 94, 8, 1972);
			attr(div0, "class", "social-container svelte-1cjafcw");
			add_location(div0, file$2, 91, 4, 1551);
			attr(div1, "class", "svelte-1cjafcw");
			add_location(div1, file$2, 87, 0, 1506);
		},
