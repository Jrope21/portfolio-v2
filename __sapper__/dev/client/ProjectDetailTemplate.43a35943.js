...
function create_each_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-go005h");
			add_location(li, file$3, 137, 16, 3252);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(137:12) {#each skills as skill}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h3, "class", "svelte-go005h");
			add_location(h3, file$3, 132, 4, 3140);
			attr_dev(ul, "class", "skills svelte-go005h");
			add_location(ul, file$3, 135, 8, 3180);
			attr_dev(div, "class", "svelte-go005h");
			add_location(div, file$3, 131, 0, 3130);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, h3);
