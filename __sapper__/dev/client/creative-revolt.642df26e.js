...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1vp8he3");
			add_location(img, file$3, 131, 20, 2454);
			attr(div, "class", "slide svelte-1vp8he3");
			add_location(div, file$3, 130, 16, 2369);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1vp8he3");
			add_location(span, file$3, 137, 12, 2633);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1vp8he3")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-1vp8he3");
			add_location(div0, file$3, 127, 4, 2263);
			attr(div1, "class", "circles-container svelte-1vp8he3");
			add_location(div1, file$3, 135, 4, 2550);
			attr(div2, "class", "carousel-container svelte-1vp8he3");
