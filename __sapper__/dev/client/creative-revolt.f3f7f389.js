...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h11, file$2, 67, 12, 1627);
			attr(section1, "class", "inner-container");
			add_location(section1, file$2, 66, 8, 1581);
