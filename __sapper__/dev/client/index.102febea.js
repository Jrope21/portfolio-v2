...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1j8heg6");
			add_location(img, file, 91, 8, 1837);
			attr_dev(div0, "class", "hero-image svelte-1j8heg6");
			add_location(div0, file, 90, 4, 1803);
			attr_dev(div1, "class", "box svelte-1j8heg6");
			add_location(div1, file, 89, 0, 1781);
		},
