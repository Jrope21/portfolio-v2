...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h2, "class", "svelte-1e0vtns");
			add_location(h2, file$1, 77, 4, 1287);
			attr_dev(span, "class", "year svelte-1e0vtns");
			add_location(span, file$1, 79, 8, 1326);
			html_tag = new HtmlTag(null);
			attr_dev(p, "class", "svelte-1e0vtns");
			add_location(p, file$1, 78, 4, 1314);
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", /*url*/ ctx[1]);
			attr_dev(a, "class", "svelte-1e0vtns");
			add_location(a, file$1, 82, 4, 1407);
			attr_dev(div, "class", "svelte-1e0vtns");
