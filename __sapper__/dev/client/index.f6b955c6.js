import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.3662ba49.js';
import { P as Projects } from './Projects.47847d9b.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-16wxozh");
			add_location(img, file$3, 148, 8, 3816);
			attr_dev(div0, "class", "image-container svelte-16wxozh");
			add_location(div0, file$3, 147, 4, 3778);
			attr_dev(h2, "class", "heading svelte-16wxozh");
			add_location(h2, file$3, 151, 8, 3921);
			attr_dev(h3, "class", "subheading svelte-16wxozh");
			add_location(h3, file$3, 152, 8, 3995);
			attr_dev(p, "class", "svelte-16wxozh");
			add_location(p, file$3, 153, 8, 4069);
			attr_dev(a, "class", "button svelte-16wxozh");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 159, 8, 4673);
			attr_dev(div1, "class", "text-content svelte-16wxozh");
			add_location(div1, file$3, 150, 4, 3886);
			attr_dev(section, "class", "text-with-image-cta svelte-16wxozh");
			add_location(section, file$3, 146, 0, 3736);
		},
		m: function mount(target, anchor) {
