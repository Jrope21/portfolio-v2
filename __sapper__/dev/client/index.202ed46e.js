import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.f0a65445.js';
import { P as Projects } from './Projects.2269e891.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$3, 9, 4, 82);
			add_location(h2, file$3, 13, 8, 169);
			attr_dev(h3, "class", "subheading");
			add_location(h3, file$3, 14, 8, 218);
			add_location(br, file$3, 16, 287, 565);
			add_location(p, file$3, 15, 8, 274);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn");
			add_location(a, file$3, 19, 8, 838);
			attr_dev(div1, "class", "text-content");
			add_location(div1, file$3, 12, 4, 134);
			attr_dev(section, "class", "text-with-image-cta");
