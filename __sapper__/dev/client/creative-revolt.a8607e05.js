...
function create_if_block(ctx) {
	var div, img, img_src_value, div_intro, div_outro, current;
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 101, 20, 1943);
		...
		i: function intro(local) {
			...
			add_render_callback(() => {
				...
				if (!div_intro) div_intro = create_in_transition(div, fly$1, { x: -80, duration: 650 });
				div_intro.start();
			});
		...
		o: function outro(local) {
			...
			div_outro = create_out_transition(div, fly$1, { x: 80, duration: 650 });
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 107, 12, 2112);
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div1, file$3, 105, 4, 2039);
