...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-ys8gmm");
			add_location(img, file$3, 103, 20, 1947);
			attr(div, "class", "slide svelte-ys8gmm");
			add_location(div, file$3, 102, 16, 1862);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-ys8gmm");
			add_location(span, file$3, 109, 12, 2116);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-ys8gmm")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-ys8gmm");
			add_location(div0, file$3, 99, 4, 1756);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 107, 4, 2043);
			attr(div2, "class", "carousel-container svelte-ys8gmm");
			add_location(div2, file$3, 98, 0, 1719);
		},
