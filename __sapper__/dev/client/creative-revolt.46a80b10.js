...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h10, "class", "title svelte-19y93ht");
			add_location(h10, file$2, 60, 12, 1476);
			attr(section0, "class", "");
			add_location(section0, file$2, 64, 8, 1534);
			attr(h11, "class", "svelte-19y93ht");
			add_location(h11, file$2, 68, 12, 1652);
			attr(section1, "class", "inner-container");
			add_location(section1, file$2, 67, 8, 1606);
			attr(div, "class", "container title-container svelte-19y93ht");
			add_location(div, file$2, 59, 8, 1424);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file$2, 56, 0, 1309);
		},
