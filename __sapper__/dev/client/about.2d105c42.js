...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-1cu4rva");
			add_location(h3, file$1, 80, 4, 1284);
			add_location(strong0, file$1, 84, 43, 1367);
			add_location(strong1, file$1, 85, 12, 1456);
			add_location(strong2, file$1, 86, 30, 1598);
			add_location(strong3, file$1, 87, 28, 1677);
			add_location(strong4, file$1, 88, 30, 1797);
			attr(p, "class", "svelte-1cu4rva");
			add_location(p, file$1, 83, 4, 1320);
			attr(div, "class", "svelte-1cu4rva");
			add_location(div, file$1, 79, 0, 1274);
		},
