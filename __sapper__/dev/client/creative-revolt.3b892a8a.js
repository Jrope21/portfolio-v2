...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-129iewz");
			add_location(img, file$3, 132, 20, 2575);
			attr(div, "class", "slide svelte-129iewz");
			add_location(div, file$3, 131, 16, 2490);
		},
...
// (130:8) {#each STATE.images as img}
...
// (138:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-129iewz");
			add_location(span, file$3, 138, 12, 2754);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-129iewz")) {
...
function create_fragment$3(ctx) {
	var div2, div0, t0, t1, t2, div1, current;
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "CREATIVE REVOLT");
			div0_nodes.forEach(detach);
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-129iewz");
			add_location(div0, file$3, 127, 4, 2263);
			attr(div1, "class", "circles-container svelte-129iewz");
			add_location(div1, file$3, 136, 4, 2671);
			attr(div2, "class", "carousel-container svelte-129iewz");
			add_location(div2, file$3, 126, 0, 2226);
		},
