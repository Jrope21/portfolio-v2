...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-if8yxt");
			add_location(h3, file$2, 110, 4, 1827);
			attr(li0, "class", "svelte-if8yxt");
			add_location(li0, file$2, 114, 12, 1897);
			attr(li1, "class", "svelte-if8yxt");
			add_location(li1, file$2, 115, 12, 1924);
			attr(li2, "class", "svelte-if8yxt");
			add_location(li2, file$2, 116, 12, 1954);
			attr(li3, "class", "svelte-if8yxt");
			add_location(li3, file$2, 117, 12, 1982);
			attr(li4, "class", "svelte-if8yxt");
			add_location(li4, file$2, 118, 12, 2021);
			attr(li5, "class", "svelte-if8yxt");
			add_location(li5, file$2, 119, 12, 2050);
			attr(li6, "class", "svelte-if8yxt");
			add_location(li6, file$2, 120, 12, 2093);
			attr(li7, "class", "svelte-if8yxt");
			add_location(li7, file$2, 121, 12, 2122);
			attr(li8, "class", "svelte-if8yxt");
			add_location(li8, file$2, 122, 12, 2155);
			attr(li9, "class", "svelte-if8yxt");
			add_location(li9, file$2, 123, 12, 2180);
			attr(li10, "class", "svelte-if8yxt");
			add_location(li10, file$2, 124, 12, 2212);
			attr(li11, "class", "svelte-if8yxt");
			add_location(li11, file$2, 125, 12, 2243);
			attr(li12, "class", "svelte-if8yxt");
			add_location(li12, file$2, 126, 12, 2280);
			attr(li13, "class", "svelte-if8yxt");
			add_location(li13, file$2, 127, 12, 2313);
			attr(li14, "class", "svelte-if8yxt");
			add_location(li14, file$2, 128, 12, 2353);
			attr(li15, "class", "svelte-if8yxt");
			add_location(li15, file$2, 129, 12, 2394);
			attr(li16, "class", "svelte-if8yxt");
			add_location(li16, file$2, 130, 12, 2427);
			attr(li17, "class", "svelte-if8yxt");
			add_location(li17, file$2, 131, 12, 2452);
			attr(ul, "class", "skills svelte-if8yxt");
			add_location(ul, file$2, 113, 8, 1865);
			attr(div, "class", "svelte-if8yxt");
			add_location(div, file$2, 109, 0, 1817);
		},
