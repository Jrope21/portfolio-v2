...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span0, file$1, 300, 20, 5763);
			attr(img, "src", img_src_value = ctx.img.src);
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-l8yio0");
			add_location(img, file$1, 301, 20, 5815);
			attr(span1, "class", "next-btn svelte-l8yio0");
			add_location(span1, file$1, 302, 20, 5870);
			attr(div, "class", "slide svelte-l8yio0");
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-l8yio0");
			add_location(span, file$1, 308, 12, 6046);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-l8yio0")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-l8yio0");
			add_location(span, file$1, 294, 0, 5376);
			attr(div0, "class", "box svelte-l8yio0");
			add_location(div0, file$1, 295, 4, 5423);
			attr(div1, "class", "circles-container svelte-l8yio0");
			add_location(div1, file$1, 306, 4, 5963);
			attr(div2, "class", "carousel-container svelte-l8yio0");
