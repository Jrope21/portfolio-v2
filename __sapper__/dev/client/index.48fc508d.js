import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.4adaf7ec.js';
import { P as Projects } from './Projects.e6b2cec6.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-1rya9z4");
			add_location(div0, file$3, 73, 4, 2161);
			attr_dev(h2, "class", "svelte-1rya9z4");
			add_location(h2, file$3, 77, 8, 2246);
			attr_dev(h3, "class", "subheading svelte-1rya9z4");
			add_location(h3, file$3, 78, 8, 2295);
			attr_dev(br, "class", "svelte-1rya9z4");
			add_location(br, file$3, 80, 287, 2642);
			attr_dev(p, "class", "svelte-1rya9z4");
			add_location(p, file$3, 79, 8, 2351);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn svelte-1rya9z4");
			add_location(a, file$3, 83, 8, 2915);
			attr_dev(div1, "class", "text-content svelte-1rya9z4");
			add_location(div1, file$3, 76, 4, 2211);
			attr_dev(section, "class", "text-with-image-cta svelte-1rya9z4");
			add_location(section, file$3, 72, 0, 2119);
		},
		m: function mount(target, anchor) {
