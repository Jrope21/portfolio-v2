...
function create_fragment$4(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$4, 89, 8, 1868);
			attr(div1, "class", "content-container svelte-1e6sja5");
			add_location(div1, file$4, 96, 8, 2093);
			attr(div2, "class", "content-container svelte-1e6sja5");
			add_location(div2, file$4, 103, 8, 2322);
			attr(div3, "class", "container");
			add_location(div3, file$4, 88, 4, 1836);
			attr(section, "class", "svelte-1e6sja5");
			add_location(section, file$4, 87, 0, 1822);
		},
		...
		i: function intro(local) {
			...
			add_render_callback(() => {
				...
				if (!div0_intro) div0_intro = create_in_transition(div0, fly, { y: 20, duration: 500, delay: 200, });
				div0_intro.start();
			});
			...
			add_render_callback(() => {
				...
				if (!div1_intro) div1_intro = create_in_transition(div1, fly, { y: 20, duration: 500, delay: 200, });
				div1_intro.start();
			});
			...
			add_render_callback(() => {
				...
				if (!div2_intro) div2_intro = create_in_transition(div2, fly, { y: 20, duration: 500, delay: 200, });
				div2_intro.start();
			});
		...
		o: function outro(local) {
			...
			div0_outro = create_out_transition(div0, fly, { y: -20, duration: 500, delay: 0, });

			transition_out(skillssection.$$.fragment, local);
			if (div1_intro) div1_intro.invalidate();

			div1_outro = create_out_transition(div1, fly, { y: -20, duration: 500, delay: 0, });

			transition_out(contact.$$.fragment, local);
			if (div2_intro) div2_intro.invalidate();

			div2_outro = create_out_transition(div2, fly, { y: -20, duration: 500, delay: 0, });
