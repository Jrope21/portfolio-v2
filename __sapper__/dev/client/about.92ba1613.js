...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-1dpc012");
			add_location(h3, file$3, 93, 4, 1677);
			attr(span0, "class", "svelte-1dpc012");
			add_location(span0, file$3, 97, 141, 1884);
			attr(i0, "class", "fab fa-github svelte-1dpc012");
			add_location(i0, file$3, 97, 116, 1859);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-1dpc012");
			add_location(a0, file$3, 97, 8, 1751);
			attr(span1, "class", "svelte-1dpc012");
			add_location(span1, file$3, 98, 149, 2077);
			attr(i1, "class", "fab fa-linkedin svelte-1dpc012");
			add_location(i1, file$3, 98, 122, 2050);
			...
			attr(a1, "class", "svelte-1dpc012");
			add_location(a1, file$3, 98, 8, 1936);
			attr(span2, "class", "svelte-1dpc012");
			add_location(span2, file$3, 99, 145, 2270);
			attr(i2, "class", "fas fa-envelope svelte-1dpc012");
			add_location(i2, file$3, 99, 118, 2243);
			...
			attr(a2, "class", "svelte-1dpc012");
			add_location(a2, file$3, 99, 8, 2133);
			attr(div0, "class", "social-container svelte-1dpc012");
			add_location(div0, file$3, 96, 4, 1712);
			attr(div1, "class", "svelte-1dpc012");
			add_location(div1, file$3, 92, 0, 1667);
		},
