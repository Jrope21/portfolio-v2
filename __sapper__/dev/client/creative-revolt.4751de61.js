...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1kaf23n");
			add_location(img, file$3, 131, 20, 2601);
			attr(div, "class", "slide svelte-1kaf23n");
			add_location(div, file$3, 130, 16, 2516);
		},
...
// (129:8) {#each STATE.images as img}
...
// (137:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1kaf23n");
			add_location(span, file$3, 137, 12, 2780);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1kaf23n")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 126, 21, 2279);
			attr(div0, "class", "box svelte-1kaf23n");
			add_location(div0, file$3, 126, 4, 2262);
			attr(div1, "class", "circles-container svelte-1kaf23n");
			add_location(div1, file$3, 135, 4, 2697);
			attr(div2, "class", "carousel-container svelte-1kaf23n");
			add_location(div2, file$3, 125, 0, 2225);
		},
