import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.444d3ee6.js';
import { P as Projects } from './Projects.71eb9d3b.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-e3kh6l");
			add_location(div0, file$3, 126, 4, 3439);
			attr_dev(h2, "class", "heading svelte-e3kh6l");
			add_location(h2, file$3, 130, 8, 3524);
			attr_dev(h3, "class", "subheading svelte-e3kh6l");
			add_location(h3, file$3, 131, 8, 3598);
			attr_dev(p, "class", "svelte-e3kh6l");
			add_location(p, file$3, 132, 8, 3672);
			attr_dev(a, "class", "button svelte-e3kh6l");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 138, 8, 4353);
			attr_dev(div1, "class", "text-content svelte-e3kh6l");
			add_location(div1, file$3, 129, 4, 3489);
			attr_dev(section, "class", "text-with-image-cta svelte-e3kh6l");
			add_location(section, file$3, 125, 0, 3397);
		},
		m: function mount(target, anchor) {
