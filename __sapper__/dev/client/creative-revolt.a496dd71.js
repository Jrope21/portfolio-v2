...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-q4wtga");
			add_location(img, file$3, 159, 20, 3176);
			attr(div, "class", "slide svelte-q4wtga");
			add_location(div, file$3, 158, 16, 3091);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-q4wtga");
			add_location(span, file$3, 165, 12, 3355);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-q4wtga")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-q4wtga");
			add_location(span, file$3, 154, 21, 2854);
			attr(div0, "class", "box svelte-q4wtga");
			add_location(div0, file$3, 154, 4, 2837);
			attr(div1, "class", "circles-container svelte-q4wtga");
			add_location(div1, file$3, 163, 4, 3272);
			attr(div2, "class", "carousel-container svelte-q4wtga");
			add_location(div2, file$3, 153, 0, 2800);
		},
