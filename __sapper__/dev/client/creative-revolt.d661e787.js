...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-n9giq8");
			add_location(img, file$3, 129, 20, 2406);
			attr(div, "class", "slide svelte-n9giq8");
			add_location(div, file$3, 128, 16, 2321);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-n9giq8");
			add_location(span, file$3, 135, 12, 2585);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-n9giq8")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-n9giq8");
			add_location(div0, file$3, 125, 4, 2215);
			attr(div1, "class", "circles-container svelte-n9giq8");
			add_location(div1, file$3, 133, 4, 2502);
			attr(div2, "class", "carousel-container svelte-n9giq8");
			add_location(div2, file$3, 124, 0, 2178);
		},
