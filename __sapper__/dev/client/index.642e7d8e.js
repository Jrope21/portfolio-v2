import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.21938570.js';
import { P as Projects } from './Projects.beb0e6d0.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-s4sf76");
			add_location(img, file$3, 134, 8, 3555);
			attr_dev(div0, "class", "image-container svelte-s4sf76");
			add_location(div0, file$3, 133, 4, 3517);
			attr_dev(h2, "class", "heading svelte-s4sf76");
			add_location(h2, file$3, 137, 8, 3660);
			attr_dev(h3, "class", "subheading svelte-s4sf76");
			add_location(h3, file$3, 138, 8, 3734);
			attr_dev(p, "class", "svelte-s4sf76");
			add_location(p, file$3, 139, 8, 3808);
			attr_dev(a, "class", "button svelte-s4sf76");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 145, 8, 4401);
			attr_dev(div1, "class", "text-content svelte-s4sf76");
			add_location(div1, file$3, 136, 4, 3625);
			attr_dev(section, "class", "text-with-image-cta svelte-s4sf76");
