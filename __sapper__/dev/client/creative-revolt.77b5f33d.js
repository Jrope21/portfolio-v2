...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-899b31");
			add_location(div0, file$3, 60, 4, 964);
			attr(img, "src", "images/Jorden-Background-Gray.jpg");
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-899b31");
			add_location(img, file$3, 62, 12, 1028);
			attr(div1, "class", "slide svelte-899b31");
			add_location(div1, file$3, 61, 8, 996);
			attr(span, "class", "circle");
			add_location(span, file$3, 64, 25, 1127);
			attr(div2, "class", "circles");
			add_location(div2, file$3, 64, 4, 1106);
			attr(div3, "class", "carousel-container svelte-899b31");
			add_location(div3, file$3, 59, 0, 927);
		},
