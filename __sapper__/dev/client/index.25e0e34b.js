...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-16togtp");
			add_location(img, file, 91, 8, 1836);
			attr_dev(div0, "class", "hero-image svelte-16togtp");
			add_location(div0, file, 90, 4, 1802);
			attr_dev(div1, "class", "box svelte-16togtp");
			add_location(div1, file, 89, 0, 1780);
		},
...
function create_fragment$4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$4, 49, 0, 2970);
		},
		m: function mount(target, anchor) {
