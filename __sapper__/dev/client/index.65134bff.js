import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.f352ca69.js';
import { P as Projects } from './Projects.b16e14b5.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1k5wn5v");
			add_location(img, file$3, 154, 8, 3999);
			attr_dev(div0, "class", "image-container svelte-1k5wn5v");
			add_location(div0, file$3, 153, 4, 3961);
			attr_dev(h2, "class", "heading svelte-1k5wn5v");
			add_location(h2, file$3, 157, 8, 4104);
			attr_dev(h3, "class", "subheading svelte-1k5wn5v");
			add_location(h3, file$3, 158, 8, 4178);
			attr_dev(p, "class", "svelte-1k5wn5v");
			add_location(p, file$3, 159, 8, 4252);
			attr_dev(a, "class", "button svelte-1k5wn5v");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 165, 8, 4856);
			attr_dev(div1, "class", "text-content svelte-1k5wn5v");
			add_location(div1, file$3, 156, 4, 4069);
			attr_dev(section, "class", "text-with-image-cta svelte-1k5wn5v");
			add_location(section, file$3, 152, 0, 3919);
		},
		m: function mount(target, anchor) {
