...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-suzneg");
			add_location(div0, file$3, 57, 4, 900);
			attr(img, "src", "images/Jorden-Background-Gray.jpg");
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-suzneg");
			add_location(img, file$3, 59, 8, 956);
			attr(div1, "class", "slide svelte-suzneg");
			add_location(div1, file$3, 58, 4, 928);
			attr(div2, "class", "carousel-container svelte-suzneg");
			add_location(div2, file$3, 56, 0, 863);
		},
