...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-ft3uxb");
			add_location(div0, file$3, 59, 4, 945);
			attr(img, "src", "images/Jorden-Background-Gray.jpg");
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-ft3uxb");
			add_location(img, file$3, 61, 12, 1009);
			attr(div1, "class", "slide svelte-ft3uxb");
			add_location(div1, file$3, 60, 8, 977);
			attr(span, "class", "circle");
			add_location(span, file$3, 63, 25, 1108);
			attr(div2, "class", "circles");
			add_location(div2, file$3, 63, 4, 1087);
			attr(div3, "class", "carousel-container svelte-ft3uxb");
			add_location(div3, file$3, 58, 0, 908);
		},
