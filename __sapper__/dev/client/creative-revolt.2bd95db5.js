...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 89, 20, 1638);
			attr(div, "class", "slide svelte-1rkoq0s");
			add_location(div, file$3, 88, 16, 1598);
		},
...
// (98:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 98, 12, 1930);
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$3, 85, 4, 1492);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 96, 4, 1857);
			attr(div2, "class", "carousel-container svelte-1rkoq0s");
			add_location(div2, file$3, 84, 0, 1455);
		},
