...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(button0, file$1, 300, 20, 5763);
			attr(img, "src", img_src_value = ctx.img.src);
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-rfx8yw");
			add_location(img, file$1, 301, 20, 5819);
			attr(button1, "class", "next svelte-rfx8yw");
			add_location(button1, file$1, 302, 20, 5874);
			attr(div, "class", "slide svelte-rfx8yw");
			add_location(div, file$1, 299, 16, 5678);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-rfx8yw");
			add_location(span, file$1, 308, 12, 6050);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-rfx8yw")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-rfx8yw");
			add_location(span, file$1, 294, 0, 5376);
			attr(div0, "class", "box svelte-rfx8yw");
			add_location(div0, file$1, 295, 4, 5423);
			attr(div1, "class", "circles-container svelte-rfx8yw");
			add_location(div1, file$1, 306, 4, 5967);
			attr(div2, "class", "carousel-container svelte-rfx8yw");
			add_location(div2, file$1, 293, 0, 5343);
		},
