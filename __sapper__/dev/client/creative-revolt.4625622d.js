...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$2, 59, 12, 1436);
			attr(div, "class", "title-container svelte-1xyasuz");
			add_location(div, file$2, 58, 8, 1394);
			attr(section, "class", "container");
			add_location(section, file$2, 63, 8, 1504);
		},
