...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div1, file$1, 50, 4, 958);
			attr(div2, "class", "grid-element-container grid-40 svelte-gtxurd");
			add_location(div2, file$1, 53, 4, 1115);
			attr(div3, "class", "grid-element-container full-width svelte-gtxurd");
			add_location(div3, file$1, 62, 4, 1579);
			attr(div4, "class", "grid-element-container full-width svelte-gtxurd");
			add_location(div4, file$1, 65, 4, 1744);
			attr(div5, "class", "grid-element-container full-width svelte-gtxurd");
			add_location(div5, file$1, 68, 4, 1909);
			attr(div6, "class", "image-grid svelte-gtxurd");
			add_location(div6, file$1, 46, 0, 768);
		},
