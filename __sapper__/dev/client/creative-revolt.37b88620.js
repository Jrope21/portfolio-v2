...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-4znts3");
			add_location(img, file$3, 60, 12, 972);
			attr(div0, "class", "slide svelte-4znts3");
			add_location(div0, file$3, 59, 8, 940);
			attr(div1, "class", "box svelte-4znts3");
			add_location(div1, file$3, 58, 4, 914);
			attr(div2, "class", "carousel-container svelte-4znts3");
