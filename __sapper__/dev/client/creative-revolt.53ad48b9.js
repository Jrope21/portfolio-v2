...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "grid-element-container svelte-4e5qhu");
			add_location(div0, file, 40, 4, 694);
			attr(div1, "class", "grid-element-container svelte-4e5qhu");
			add_location(div1, file, 43, 4, 843);
			attr(div2, "class", "grid-element-container svelte-4e5qhu");
			add_location(div2, file, 46, 4, 992);
			attr(div3, "class", "grid-element-container svelte-4e5qhu");
			add_location(div3, file, 49, 4, 1141);
			attr(div4, "class", "grid-element-container full-width svelte-4e5qhu");
			add_location(div4, file, 52, 4, 1290);
			attr(div5, "class", "image-grid svelte-4e5qhu");
			add_location(div5, file, 39, 0, 665);
		},
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p, "class", "headline svelte-17uvmh8");
			add_location(p, file$1, 14, 0, 292);
		},
