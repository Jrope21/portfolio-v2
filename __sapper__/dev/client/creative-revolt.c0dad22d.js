...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-le2fve");
			add_location(img, file$3, 109, 20, 2047);
			attr(div, "class", "slide svelte-le2fve");
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-le2fve");
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-le2fve")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-le2fve");
			add_location(div0, file$3, 105, 4, 1856);
			attr(div1, "class", "circles-container svelte-le2fve");
			add_location(div1, file$3, 113, 4, 2143);
			attr(div2, "class", "carousel-container svelte-le2fve");
