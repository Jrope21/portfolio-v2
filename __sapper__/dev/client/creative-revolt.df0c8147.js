...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1him1hj");
			add_location(img, file$3, 153, 20, 2984);
			attr(div, "class", "slide svelte-1him1hj");
			add_location(div, file$3, 152, 16, 2899);
		},
...
// (151:8) {#each STATE.images as img}
...
// (159:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1him1hj");
			add_location(span, file$3, 159, 12, 3163);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1him1hj")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-1him1hj");
			add_location(span, file$3, 148, 21, 2662);
			attr(div0, "class", "box svelte-1him1hj");
			add_location(div0, file$3, 148, 4, 2645);
			attr(div1, "class", "circles-container svelte-1him1hj");
			add_location(div1, file$3, 157, 4, 3080);
			attr(div2, "class", "carousel-container svelte-1him1hj");
			add_location(div2, file$3, 147, 0, 2608);
		},
