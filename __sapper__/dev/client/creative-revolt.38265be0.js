...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(p0, "class", "svelte-s2xmgv");
			add_location(p0, file$3, 67, 4, 1299);
			add_location(strong4, file$3, 68, 39, 1806);
			add_location(strong5, file$3, 68, 76, 1843);
			add_location(strong6, file$3, 68, 381, 2148);
			add_location(strong7, file$3, 68, 429, 2196);
			attr(p1, "class", "svelte-s2xmgv");
			add_location(p1, file$3, 68, 8, 1775);
			attr(a, "target", "blank");
			attr(a, "href", "");
			attr(a, "class", "svelte-s2xmgv");
			add_location(a, file$3, 70, 4, 2248);
