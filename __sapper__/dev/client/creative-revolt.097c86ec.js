...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-8vyiqd");
			add_location(img, file$3, 146, 20, 2856);
			attr(div, "class", "slide svelte-8vyiqd");
			add_location(div, file$3, 145, 16, 2771);
		},
...
// (144:8) {#each STATE.images as img}
...
// (152:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-8vyiqd");
			add_location(span, file$3, 152, 12, 3035);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-8vyiqd")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-8vyiqd");
			add_location(span, file$3, 141, 21, 2534);
			attr(div0, "class", "box svelte-8vyiqd");
			add_location(div0, file$3, 141, 4, 2517);
			attr(div1, "class", "circles-container svelte-8vyiqd");
			add_location(div1, file$3, 150, 4, 2952);
			attr(div2, "class", "carousel-container svelte-8vyiqd");
			add_location(div2, file$3, 140, 0, 2480);
		},
