...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "slide svelte-1jnapxs");
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1jnapxs");
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1jnapxs")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-1jnapxs");
			add_location(span, file$1, 225, 21, 4065);
			attr(div0, "class", "box svelte-1jnapxs");
			add_location(div0, file$1, 225, 4, 4048);
			attr(div1, "class", "circles-container svelte-1jnapxs");
			add_location(div1, file$1, 234, 4, 4484);
			attr(div2, "class", "carousel-container svelte-1jnapxs");
