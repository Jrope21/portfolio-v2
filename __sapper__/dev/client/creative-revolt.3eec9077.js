...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1fldn3g");
			add_location(img, file$1, 258, 20, 5037);
			attr(div, "class", "slide svelte-1fldn3g");
			add_location(div, file$1, 257, 16, 4952);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1fldn3g");
			add_location(span, file$1, 264, 12, 5216);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1fldn3g")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-1fldn3g");
			add_location(div0, file$1, 253, 4, 4697);
			attr(div1, "class", "circles-container svelte-1fldn3g");
			add_location(div1, file$1, 262, 4, 5133);
			attr(div2, "class", "carousel-container svelte-1fldn3g");
			add_location(div2, file$1, 252, 0, 4660);
		},
