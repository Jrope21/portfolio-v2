...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1fswg6f");
			add_location(img, file, 88, 8, 1655);
			attr_dev(div0, "class", "hero-image svelte-1fswg6f");
			add_location(div0, file, 87, 4, 1621);
			attr_dev(div1, "class", "box svelte-1fswg6f");
			add_location(div1, file, 86, 0, 1599);
		},
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-188k0u5");
			add_location(img, file$3, 184, 8, 3358);
			attr_dev(a0, "href", "javascript:void(0)");
			attr_dev(a0, "class", "image-container svelte-188k0u5");
			add_location(a0, file$3, 183, 4, 3275);
			attr_dev(h2, "class", "heading svelte-188k0u5");
			add_location(h2, file$3, 187, 8, 3461);
			attr_dev(h3, "class", "subheading svelte-188k0u5");
			add_location(h3, file$3, 188, 8, 3535);
			attr_dev(p, "class", "svelte-188k0u5");
			add_location(p, file$3, 189, 8, 3609);
			attr_dev(a1, "class", "button svelte-188k0u5");
			attr_dev(a1, "href", "javascript:void(0)");
			add_location(a1, file$3, 193, 8, 3944);
			attr_dev(div, "class", "text-content svelte-188k0u5");
			add_location(div, file$3, 186, 4, 3426);
			attr_dev(section, "class", "text-with-image-cta svelte-188k0u5");
			add_location(section, file$3, 182, 0, 3233);
		},
		m: function mount(target, anchor) {
