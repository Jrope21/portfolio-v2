...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "svelte-1rw6gt4");
			add_location(h1, file$2, 46, 8, 1094);
			attr(section, "class", "container");
			add_location(section, file$2, 49, 8, 1129);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file$2, 43, 0, 979);
		},
