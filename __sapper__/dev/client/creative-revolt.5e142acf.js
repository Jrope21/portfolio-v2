...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "container svelte-1bgfg0n");
			add_location(h1, file$2, 50, 8, 1206);
			attr(section, "class", "container");
			add_location(section, file$2, 53, 8, 1259);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file$2, 47, 0, 1091);
		},
