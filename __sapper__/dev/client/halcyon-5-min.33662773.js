...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-b8ndh2");
			add_location(img, file, 78, 6, 1346);
			attr_dev(div, "class", "img-container svelte-b8ndh2");
			add_location(div, file, 77, 4, 1312);
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*width*/ ctx[3]) + " svelte-b8ndh2"));
			attr_dev(a, "href", /*url*/ ctx[2]);
			add_location(a, file, 76, 0, 1262);
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*width*/ 8 && a_class_value !== (a_class_value = "" + (null_to_empty(/*width*/ ctx[3]) + " svelte-b8ndh2"))) {
