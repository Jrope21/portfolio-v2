...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1y9m4tm");
			add_location(img, file$3, 113, 20, 2096);
			attr(div, "class", "slide svelte-1y9m4tm");
			add_location(div, file$3, 112, 16, 2011);
		},
...
// (111:8) {#each STATE.images as img}
...
// (119:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1y9m4tm");
			add_location(span, file$3, 119, 12, 2275);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1y9m4tm")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-1y9m4tm");
			add_location(div0, file$3, 109, 4, 1905);
			attr(div1, "class", "circles-container svelte-1y9m4tm");
			add_location(div1, file$3, 117, 4, 2192);
			attr(div2, "class", "carousel-container svelte-1y9m4tm");
			add_location(div2, file$3, 108, 0, 1868);
		},
