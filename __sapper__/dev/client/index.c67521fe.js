import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.d461afa1.js';
import { P as Projects } from './Projects.7f72d97d.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1j8daei");
			add_location(img, file$3, 139, 8, 3633);
			attr_dev(div0, "class", "image-container svelte-1j8daei");
			add_location(div0, file$3, 138, 4, 3595);
			attr_dev(h2, "class", "heading svelte-1j8daei");
			add_location(h2, file$3, 142, 8, 3738);
			attr_dev(h3, "class", "subheading svelte-1j8daei");
			add_location(h3, file$3, 143, 8, 3812);
			attr_dev(p, "class", "svelte-1j8daei");
			add_location(p, file$3, 144, 8, 3886);
			attr_dev(a, "class", "button svelte-1j8daei");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 150, 8, 4488);
			attr_dev(div1, "class", "text-content svelte-1j8daei");
			add_location(div1, file$3, 141, 4, 3703);
			attr_dev(section, "class", "text-with-image-cta svelte-1j8daei");
			add_location(section, file$3, 137, 0, 3553);
		},
		m: function mount(target, anchor) {
