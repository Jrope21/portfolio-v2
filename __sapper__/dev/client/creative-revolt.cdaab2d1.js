...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-alangh");
			add_location(div0, file$3, 58, 4, 904);
			attr(img, "src", "images/Jorden-Background-Gray.jpg");
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-alangh");
			add_location(img, file$3, 60, 8, 960);
			attr(div1, "class", "slide svelte-alangh");
			add_location(div1, file$3, 59, 4, 932);
			attr(div2, "class", "carousel-container svelte-alangh");
			add_location(div2, file$3, 57, 0, 867);
		},
