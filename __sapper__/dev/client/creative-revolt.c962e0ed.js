...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-dqi2g7");
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-dqi2g7")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-dqi2g7");
			add_location(span, file$1, 303, 0, 5534);
			attr(div0, "class", "box svelte-dqi2g7");
			add_location(div0, file$1, 304, 4, 5581);
			attr(div1, "class", "circles-container svelte-dqi2g7");
			add_location(div1, file$1, 319, 4, 6276);
			attr(div2, "class", "carousel-container svelte-dqi2g7");
