...
function create_fragment$4(ctx) {
	var t0, div0, t1, div0_intro, t2, section, div4, div1, div1_intro, t3, div2, div2_intro, t4, div3, div3_intro, current;
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div1, file$4, 91, 8, 1943);
			attr(div2, "class", "content-container svelte-haz9qt");
			add_location(div2, file$4, 97, 8, 2108);
			attr(div3, "class", "content-container svelte-haz9qt");
			add_location(div3, file$4, 103, 8, 2277);
			attr(div4, "class", "container");
			add_location(div4, file$4, 90, 4, 1911);
			attr(section, "class", "svelte-haz9qt");
			add_location(section, file$4, 89, 0, 1897);
		},
		...
		i: function intro(local) {
			...
			if (!div0_intro) {
				add_render_callback(() => {
					div0_intro = create_in_transition(div0, fly, { x: -100, duration: 500, delay: 200, });
					div0_intro.start();
				});
			}
