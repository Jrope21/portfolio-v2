import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.b6524192.js';
import { P as Projects } from './Projects.6b15c6f1.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-18lc2x3");
			add_location(div0, file$3, 129, 4, 3467);
			attr_dev(h2, "class", "heading svelte-18lc2x3");
			add_location(h2, file$3, 133, 8, 3552);
			attr_dev(h3, "class", "subheading svelte-18lc2x3");
			add_location(h3, file$3, 134, 8, 3626);
			attr_dev(p, "class", "svelte-18lc2x3");
			add_location(p, file$3, 135, 8, 3700);
			attr_dev(a, "class", "button svelte-18lc2x3");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 141, 8, 4381);
			attr_dev(div1, "class", "text-content svelte-18lc2x3");
			add_location(div1, file$3, 132, 4, 3517);
			attr_dev(section, "class", "text-with-image-cta svelte-18lc2x3");
