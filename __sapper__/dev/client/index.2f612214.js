import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.6644eed1.js';
import { P as Projects } from './Projects.c7a51282.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-exrblt");
			add_location(img, file$3, 176, 8, 4627);
			attr_dev(div0, "class", "image-container svelte-exrblt");
			add_location(div0, file$3, 175, 4, 4589);
			attr_dev(h2, "class", "heading svelte-exrblt");
			add_location(h2, file$3, 179, 8, 4732);
			attr_dev(h3, "class", "subheading svelte-exrblt");
			add_location(h3, file$3, 180, 8, 4806);
			attr_dev(p, "class", "svelte-exrblt");
			add_location(p, file$3, 181, 8, 4880);
			attr_dev(a, "class", "button svelte-exrblt");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 187, 8, 5484);
			attr_dev(div1, "class", "text-content svelte-exrblt");
			add_location(div1, file$3, 178, 4, 4697);
			attr_dev(section, "class", "text-with-image-cta svelte-exrblt");
			add_location(section, file$3, 174, 0, 4547);
		},
		m: function mount(target, anchor) {
