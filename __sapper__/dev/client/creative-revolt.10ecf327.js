...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-t1b84w");
			add_location(img, file$3, 146, 20, 2857);
			attr(div, "class", "slide svelte-t1b84w");
			add_location(div, file$3, 145, 16, 2772);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-t1b84w");
			add_location(span, file$3, 152, 12, 3036);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-t1b84w")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-t1b84w");
			add_location(span, file$3, 141, 21, 2535);
			attr(div0, "class", "box svelte-t1b84w");
			add_location(div0, file$3, 141, 4, 2518);
			attr(div1, "class", "circles-container svelte-t1b84w");
			add_location(div1, file$3, 150, 4, 2953);
			attr(div2, "class", "carousel-container svelte-t1b84w");
			add_location(div2, file$3, 140, 0, 2481);
		},
