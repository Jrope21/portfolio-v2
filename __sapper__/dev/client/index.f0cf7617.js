...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-l4zdhn");
			add_location(img, file$3, 184, 8, 3396);
			attr_dev(a0, "href", "javascript:void(0)");
			attr_dev(a0, "class", "image-container svelte-l4zdhn");
			add_location(a0, file$3, 183, 4, 3313);
			attr_dev(h2, "class", "heading svelte-l4zdhn");
			add_location(h2, file$3, 187, 8, 3499);
			attr_dev(h3, "class", "subheading svelte-l4zdhn");
			add_location(h3, file$3, 188, 8, 3573);
			attr_dev(p, "class", "svelte-l4zdhn");
			add_location(p, file$3, 189, 8, 3647);
			attr_dev(a1, "class", "button svelte-l4zdhn");
			attr_dev(a1, "href", "javascript:void(0)");
			add_location(a1, file$3, 193, 8, 3982);
			attr_dev(div, "class", "text-content svelte-l4zdhn");
			add_location(div, file$3, 186, 4, 3464);
			attr_dev(section, "class", "text-with-image-cta svelte-l4zdhn");
