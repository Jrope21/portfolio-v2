...
function create_if_block(ctx) {
	var div, img, img_src_value, div_intro;
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 101, 20, 1919);
