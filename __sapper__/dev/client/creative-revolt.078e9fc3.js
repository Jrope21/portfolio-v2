...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "slide svelte-kpl5mr");
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-kpl5mr");
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-kpl5mr")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-kpl5mr");
			add_location(div0, file$1, 231, 4, 4182);
			attr(div1, "class", "circles-container svelte-kpl5mr");
			add_location(div1, file$1, 240, 4, 4618);
			attr(div2, "class", "carousel-container svelte-kpl5mr");
