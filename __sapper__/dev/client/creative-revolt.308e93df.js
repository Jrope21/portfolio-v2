...
function create_if_block(ctx) {
	...
	return {
		...
		i: function intro(local) {
			if (!div_intro) {
				add_render_callback(() => {
					div_intro = create_in_transition(div, fly$1, { x: -200, duration: 1000 });
					div_intro.start();
				});
			}
		},
