...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-ru6wfb");
			add_location(img, file$1, 258, 20, 5042);
			attr(div, "class", "slide svelte-ru6wfb");
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-ru6wfb");
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-ru6wfb")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-ru6wfb");
			add_location(div0, file$1, 253, 4, 4702);
			attr(div1, "class", "circles-container svelte-ru6wfb");
			add_location(div1, file$1, 262, 4, 5138);
			attr(div2, "class", "carousel-container svelte-ru6wfb");
