import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.82f32ef5.js';
import { P as Projects } from './Projects.33227b9f.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-5udvva");
			add_location(img, file$3, 167, 8, 4355);
			attr_dev(div0, "class", "image-container svelte-5udvva");
			add_location(div0, file$3, 166, 4, 4317);
			attr_dev(h2, "class", "heading svelte-5udvva");
			add_location(h2, file$3, 170, 8, 4460);
			attr_dev(h3, "class", "subheading svelte-5udvva");
			add_location(h3, file$3, 171, 8, 4534);
			attr_dev(p, "class", "svelte-5udvva");
			add_location(p, file$3, 172, 8, 4608);
			attr_dev(a, "class", "button svelte-5udvva");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 178, 8, 5212);
			attr_dev(div1, "class", "text-content svelte-5udvva");
			add_location(div1, file$3, 169, 4, 4425);
			attr_dev(section, "class", "text-with-image-cta svelte-5udvva");
			add_location(section, file$3, 165, 0, 4275);
		},
		m: function mount(target, anchor) {
