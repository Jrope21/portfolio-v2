...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$1, 260, 20, 5123);
			attr(div, "class", "slide svelte-1ghlmdq");
			add_location(div, file$1, 259, 16, 5038);
		},
...
// (258:8) {#each STATE.images as img}
...
// (266:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 266, 12, 5302);
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 254, 0, 4736);
			attr(div0, "class", "box svelte-1ghlmdq");
			add_location(div0, file$1, 255, 4, 4783);
			attr(div1, "class", "circles-container svelte-1ghlmdq");
			add_location(div1, file$1, 264, 4, 5219);
