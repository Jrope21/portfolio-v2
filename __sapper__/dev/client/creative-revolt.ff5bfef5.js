...
function create_fragment$3(ctx) {
	var div3, div0, t0, div1, img, t1, div2, span, t2;
	...
	return {
		...
		l: function claim(nodes) {
			...
			t2 = claim_text(span_nodes, "circle");
			span_nodes.forEach(detach);
			div2_nodes.forEach(detach);
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 65, 25, 1154);
