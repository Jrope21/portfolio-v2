...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-770w7e");
			add_location(img, file$3, 101, 20, 1907);
			attr(div, "class", "slide svelte-770w7e");
			add_location(div, file$3, 100, 16, 1822);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-770w7e");
			add_location(span, file$3, 107, 12, 2076);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-770w7e")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-770w7e");
			add_location(div0, file$3, 97, 4, 1716);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 105, 4, 2003);
			attr(div2, "class", "carousel-container svelte-770w7e");
			add_location(div2, file$3, 96, 0, 1679);
		},
