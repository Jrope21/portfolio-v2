import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.5863ab15.js';
import { P as Projects } from './Projects.d4a28588.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-whvxld");
			add_location(div0, file$3, 122, 4, 3322);
			attr_dev(h2, "class", "heading svelte-whvxld");
			add_location(h2, file$3, 126, 8, 3407);
			attr_dev(h3, "class", "subheading svelte-whvxld");
			add_location(h3, file$3, 127, 8, 3481);
			attr_dev(p, "class", "svelte-whvxld");
			add_location(p, file$3, 128, 8, 3555);
			attr_dev(a, "class", "button svelte-whvxld");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 134, 8, 4236);
			attr_dev(div1, "class", "text-content svelte-whvxld");
			add_location(div1, file$3, 125, 4, 3372);
			attr_dev(section, "class", "text-with-image-cta svelte-whvxld");
			add_location(section, file$3, 121, 0, 3280);
		},
		m: function mount(target, anchor) {
