...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(section1, file, 133, 16, 3996);
			attr(a, "href", a_href_value = ctx.STATE.url);
			attr(a, "target", "blank");
			attr(a, "class", "svelte-1riw4zc");
			add_location(a, file, 137, 20, 4147);
			attr(section2, "class", "cta svelte-1riw4zc");
			add_location(section2, file, 136, 16, 4105);
