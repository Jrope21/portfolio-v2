import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.f5742c89.js';
import { P as Projects } from './Projects.ea240e35.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-d4x3zn");
			add_location(img, file$3, 151, 8, 3888);
			attr_dev(div0, "class", "image-container svelte-d4x3zn");
			add_location(div0, file$3, 150, 4, 3850);
			attr_dev(h2, "class", "heading svelte-d4x3zn");
			add_location(h2, file$3, 154, 8, 3993);
			attr_dev(h3, "class", "subheading svelte-d4x3zn");
			add_location(h3, file$3, 155, 8, 4067);
			attr_dev(p, "class", "svelte-d4x3zn");
			add_location(p, file$3, 156, 8, 4141);
			attr_dev(a, "class", "button svelte-d4x3zn");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 162, 8, 4745);
			attr_dev(div1, "class", "text-content svelte-d4x3zn");
			add_location(div1, file$3, 153, 4, 3958);
			attr_dev(section, "class", "text-with-image-cta svelte-d4x3zn");
