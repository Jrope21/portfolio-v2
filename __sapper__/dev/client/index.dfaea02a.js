import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.7986d880.js';
import { P as Projects } from './Projects.756f5d70.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-duagsf");
			add_location(div0, file$3, 89, 4, 2675);
			attr_dev(h2, "class", "svelte-duagsf");
			add_location(h2, file$3, 93, 8, 2760);
			attr_dev(h3, "class", "subheading svelte-duagsf");
			add_location(h3, file$3, 94, 8, 2809);
			attr_dev(br0, "class", "svelte-duagsf");
			add_location(br0, file$3, 96, 287, 3156);
			attr_dev(br1, "class", "svelte-duagsf");
			add_location(br1, file$3, 96, 293, 3162);
			attr_dev(p, "class", "svelte-duagsf");
			add_location(p, file$3, 95, 8, 2865);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn svelte-duagsf");
			add_location(a, file$3, 99, 8, 3435);
			attr_dev(div1, "class", "text-content svelte-duagsf");
			add_location(div1, file$3, 92, 4, 2725);
			attr_dev(section, "class", "text-with-image-cta svelte-duagsf");
			add_location(section, file$3, 88, 0, 2633);
		},
		m: function mount(target, anchor) {
