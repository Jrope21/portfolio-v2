import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.6fba91cb.js';
import { P as Projects } from './Projects.3e0fa677.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-17lvzu0");
			add_location(div0, file$3, 97, 4, 2795);
			attr_dev(h2, "class", "heading svelte-17lvzu0");
			add_location(h2, file$3, 101, 8, 2880);
			attr_dev(h3, "class", "subheading svelte-17lvzu0");
			add_location(h3, file$3, 102, 8, 2945);
			attr_dev(br0, "class", "svelte-17lvzu0");
			add_location(br0, file$3, 104, 287, 3310);
			attr_dev(br1, "class", "svelte-17lvzu0");
			add_location(br1, file$3, 104, 293, 3316);
			attr_dev(p, "class", "svelte-17lvzu0");
			add_location(p, file$3, 103, 8, 3019);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn svelte-17lvzu0");
			add_location(a, file$3, 107, 8, 3589);
			attr_dev(div1, "class", "text-content svelte-17lvzu0");
			add_location(div1, file$3, 100, 4, 2845);
			attr_dev(section, "class", "text-with-image-cta svelte-17lvzu0");
