import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.bc535ab8.js';
import { P as Projects } from './Projects.35206869.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-x6x05n");
			add_location(img, file$3, 142, 8, 3701);
			attr_dev(div0, "class", "image-container svelte-x6x05n");
			add_location(div0, file$3, 141, 4, 3663);
			attr_dev(h2, "class", "heading svelte-x6x05n");
			add_location(h2, file$3, 145, 8, 3806);
			attr_dev(h3, "class", "subheading svelte-x6x05n");
			add_location(h3, file$3, 146, 8, 3880);
			attr_dev(p, "class", "svelte-x6x05n");
			add_location(p, file$3, 147, 8, 3954);
			attr_dev(a, "class", "button svelte-x6x05n");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 153, 8, 4635);
			attr_dev(div1, "class", "text-content svelte-x6x05n");
			add_location(div1, file$3, 144, 4, 3771);
			attr_dev(section, "class", "text-with-image-cta svelte-x6x05n");
			add_location(section, file$3, 140, 0, 3621);
		},
		m: function mount(target, anchor) {
