import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.65703646.js';
import { P as Projects } from './Projects.b24ff3b2.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-ew26hs");
			add_location(img, file$3, 173, 8, 4550);
			attr_dev(div0, "class", "image-container svelte-ew26hs");
			add_location(div0, file$3, 172, 4, 4512);
			attr_dev(h2, "class", "heading svelte-ew26hs");
			add_location(h2, file$3, 176, 8, 4655);
			attr_dev(h3, "class", "subheading svelte-ew26hs");
			add_location(h3, file$3, 177, 8, 4729);
			attr_dev(p, "class", "svelte-ew26hs");
			add_location(p, file$3, 178, 8, 4803);
			attr_dev(a, "class", "button svelte-ew26hs");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 184, 8, 5407);
			attr_dev(div1, "class", "text-content svelte-ew26hs");
			add_location(div1, file$3, 175, 4, 4620);
			attr_dev(section, "class", "text-with-image-cta svelte-ew26hs");
