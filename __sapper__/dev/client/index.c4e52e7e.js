import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.d1ef3d8a.js';
import { P as Projects } from './Projects.69d00e3c.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-exrqoa");
			add_location(img, file$3, 170, 8, 4463);
			attr_dev(div0, "class", "image-container svelte-exrqoa");
			add_location(div0, file$3, 169, 4, 4425);
			attr_dev(h2, "class", "heading svelte-exrqoa");
			add_location(h2, file$3, 173, 8, 4568);
			attr_dev(h3, "class", "subheading svelte-exrqoa");
			add_location(h3, file$3, 174, 8, 4642);
			attr_dev(p, "class", "svelte-exrqoa");
			add_location(p, file$3, 175, 8, 4716);
			attr_dev(a, "class", "button svelte-exrqoa");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 181, 8, 5320);
			attr_dev(div1, "class", "text-content svelte-exrqoa");
			add_location(div1, file$3, 172, 4, 4533);
			attr_dev(section, "class", "text-with-image-cta svelte-exrqoa");
