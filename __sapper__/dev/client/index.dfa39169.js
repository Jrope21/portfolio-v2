import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.663eb948.js';
import { P as Projects } from './Projects.fb8236a7.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			div1 = element("div");
			h2 = element("h2");
			t1 = text("Let's Create Something Awesome.");
			t2 = space();
			h3 = element("h3");
		...
		l: function claim(nodes) {
			...
			var h2_nodes = children(h2);
			t1 = claim_text(h2_nodes, "Let's Create Something Awesome.");
			h2_nodes.forEach(detach_dev);
			t2 = claim_space(div1_nodes);
			h3 = claim_element(div1_nodes, "H3", { class: true });
			var h3_nodes = children(h3);
			t3 = claim_text(h3_nodes, "Front End Developer");
			h3_nodes.forEach(detach_dev);
			...
			t8 = claim_text(a_nodes, "Get In Touch!");
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-1qm0khb");
			add_location(div0, file$3, 97, 4, 2795);
			attr_dev(h2, "class", "heading svelte-1qm0khb");
			add_location(h2, file$3, 101, 8, 2880);
			attr_dev(h3, "class", "subheading svelte-1qm0khb");
			add_location(h3, file$3, 102, 8, 2945);
			attr_dev(br0, "class", "svelte-1qm0khb");
			add_location(br0, file$3, 104, 287, 3292);
			attr_dev(br1, "class", "svelte-1qm0khb");
			add_location(br1, file$3, 104, 293, 3298);
			attr_dev(p, "class", "svelte-1qm0khb");
			add_location(p, file$3, 103, 8, 3001);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn svelte-1qm0khb");
			add_location(a, file$3, 107, 8, 3571);
			attr_dev(div1, "class", "text-content svelte-1qm0khb");
			add_location(div1, file$3, 100, 4, 2845);
			attr_dev(section, "class", "text-with-image-cta svelte-1qm0khb");
			add_location(section, file$3, 96, 0, 2753);
		},
		m: function mount(target, anchor) {
