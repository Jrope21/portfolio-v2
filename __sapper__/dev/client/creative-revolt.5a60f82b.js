...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$1, 159, 20, 3161);
			attr(div, "class", "slide svelte-1s25sz3");
			add_location(div, file$1, 158, 16, 3075);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 165, 12, 3340);
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 154, 21, 2838);
			attr(div0, "class", "box svelte-1s25sz3");
			add_location(div0, file$1, 154, 4, 2821);
			attr(div1, "class", "circles-container svelte-1s25sz3");
			add_location(div1, file$1, 163, 4, 3257);
			attr(div2, "class", "carousel-container svelte-1s25sz3");
			add_location(div2, file$1, 153, 0, 2784);
		},
