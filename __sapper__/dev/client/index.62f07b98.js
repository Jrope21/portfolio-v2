import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.69adde6b.js';
import { P as Projects } from './Projects.ef84ca7b.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-er5e9w");
			add_location(img, file$3, 132, 8, 3514);
			attr_dev(div0, "class", "image-container svelte-er5e9w");
			add_location(div0, file$3, 131, 4, 3476);
			attr_dev(h2, "class", "heading svelte-er5e9w");
			add_location(h2, file$3, 135, 8, 3619);
			attr_dev(h3, "class", "subheading svelte-er5e9w");
			add_location(h3, file$3, 136, 8, 3693);
			attr_dev(br0, "class", "svelte-er5e9w");
			add_location(br0, file$3, 139, 12, 4071);
			attr_dev(br1, "class", "svelte-er5e9w");
			add_location(br1, file$3, 139, 18, 4077);
			attr_dev(p, "class", "svelte-er5e9w");
			add_location(p, file$3, 137, 8, 3767);
			attr_dev(a, "class", "button svelte-er5e9w");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 143, 8, 4351);
			attr_dev(div1, "class", "text-content svelte-er5e9w");
			add_location(div1, file$3, 134, 4, 3584);
			attr_dev(section, "class", "text-with-image-cta svelte-er5e9w");
			add_location(section, file$3, 130, 0, 3434);
		},
		m: function mount(target, anchor) {
