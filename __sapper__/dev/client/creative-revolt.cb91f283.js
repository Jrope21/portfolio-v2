...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h10, "class", "title svelte-tvkofq");
			add_location(h10, file$2, 81, 12, 1780);
			attr(section0, "class", "");
			add_location(section0, file$2, 85, 8, 1838);
			attr(h11, "class", "headline svelte-tvkofq");
			add_location(h11, file$2, 89, 12, 1956);
			attr(p, "class", "svelte-tvkofq");
			add_location(p, file$2, 90, 12, 2002);
			attr(section1, "class", "inner-container svelte-tvkofq");
			add_location(section1, file$2, 88, 8, 1910);
			attr(div, "class", "container");
			add_location(div, file$2, 80, 8, 1744);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file$2, 77, 0, 1629);
		},
