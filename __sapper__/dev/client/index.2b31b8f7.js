import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.309f7689.js';
import { P as Projects } from './Projects.7b3169b7.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-xuc0wg");
			add_location(img, file$3, 165, 8, 4289);
			attr_dev(div0, "class", "image-container svelte-xuc0wg");
			add_location(div0, file$3, 164, 4, 4251);
			attr_dev(h2, "class", "heading svelte-xuc0wg");
			add_location(h2, file$3, 168, 8, 4394);
			attr_dev(h3, "class", "subheading svelte-xuc0wg");
			add_location(h3, file$3, 169, 8, 4468);
			attr_dev(p, "class", "svelte-xuc0wg");
			add_location(p, file$3, 170, 8, 4542);
			attr_dev(a, "class", "button svelte-xuc0wg");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 176, 8, 5146);
			attr_dev(div1, "class", "text-content svelte-xuc0wg");
			add_location(div1, file$3, 167, 4, 4359);
			attr_dev(section, "class", "text-with-image-cta svelte-xuc0wg");
