...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h2, "class", "svelte-11vb843");
			add_location(h2, file$1, 125, 4, 3026);
			attr_dev(span, "class", "year svelte-11vb843");
			add_location(span, file$1, 127, 8, 3065);
			html_tag = new HtmlTag(null);
			attr_dev(p, "class", "svelte-11vb843");
			add_location(p, file$1, 126, 4, 3053);
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", /*url*/ ctx[1]);
			attr_dev(a, "class", "svelte-11vb843");
			add_location(a, file$1, 130, 4, 3146);
			attr_dev(div, "class", "svelte-11vb843");
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h2, "class", "svelte-dccjxj");
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-dccjxj");
			add_location(div0, file$2, 161, 16, 3791);
			attr_dev(div1, "class", "text-container svelte-dccjxj");
			add_location(div1, file$2, 170, 16, 4156);
			attr_dev(div2, "class", "card-container svelte-dccjxj");
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "projects-container svelte-dccjxj");
			add_location(div, file$2, 158, 4, 3647);
			attr_dev(section, "class", "svelte-dccjxj");
