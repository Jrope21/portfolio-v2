...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			add_location(img, file$1, 252, 20, 4913);
			attr(div, "class", "slide svelte-5jsoxt");
			add_location(div, file$1, 251, 16, 4828);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-5jsoxt");
			add_location(span, file$1, 258, 12, 5092);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-5jsoxt")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-5jsoxt");
			add_location(div0, file$1, 247, 4, 4573);
			attr(div1, "class", "circles-container svelte-5jsoxt");
			add_location(div1, file$1, 256, 4, 5009);
			attr(div2, "class", "carousel-container svelte-5jsoxt");
			add_location(div2, file$1, 246, 0, 4536);
		},
