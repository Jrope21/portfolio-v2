...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "container svelte-r9ejl9");
			add_location(h1, file$2, 49, 8, 1179);
			attr(section, "class", "container");
			add_location(section, file$2, 52, 8, 1232);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file$2, 46, 0, 1064);
		},
