...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i0, file$7, 497, 32, 11566);
			...
			add_location(a8, file$7, 496, 28, 11389);
			attr_dev(i1, "class", "fab fa-linkedin svelte-uorvq3");
			add_location(i1, file$7, 500, 32, 11840);
			...
			add_location(a9, file$7, 499, 28, 11657);
			attr_dev(i2, "class", "fas fa-envelope svelte-uorvq3");
			add_location(i2, file$7, 503, 32, 12081);
			...
			add_location(a10, file$7, 502, 28, 11933);
			attr_dev(div5, "class", "social-icons svelte-uorvq3");
			add_location(div5, file$7, 495, 24, 11334);
...
function create_if_block$4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file$b, 50, 1, 1559);
		},
		m: function mount(target, anchor) {
...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-j169m1");
			add_location(h1, file$b, 42, 1, 1430);
			attr_dev(h2, "class", "svelte-j169m1");
			add_location(h2, file$b, 43, 1, 1447);
			attr_dev(div, "class", "text-container container svelte-j169m1");
			add_location(div, file$b, 41, 0, 1390);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.d828a32a.js'), __inject_styles(["client-87b88b18.css","halcyon-5-min-9ec22285.css","index-f9894ff4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./experience.99e40223.js'), __inject_styles(["client-87b88b18.css","experience-7af911e7.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./creative-revolt.e0d0fe5f.js'), __inject_styles(["client-87b88b18.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css","creative-revolt-387c384c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./university-park.32e45d1c.js'), __inject_styles(["client-87b88b18.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./di-repairs.fa752da1.js'), __inject_styles(["client-87b88b18.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./stallion.b7ef69c2.js'), __inject_styles(["client-87b88b18.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./halcyon.60d36e2e.js'), __inject_styles(["client-87b88b18.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./projects.3d24920f.js'), __inject_styles(["client-87b88b18.css","halcyon-5-min-9ec22285.css","PageTitle-fbf706b4.css","projects-61f9fec4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./about.0d3b2b49.js'), __inject_styles(["client-87b88b18.css","about-3acc9d53.css"])]).then(function(x) { return x[0]; })
	}
];
