...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-451it8");
			add_location(h3, file$3, 67, 4, 1116);
			attr(span0, "class", "svelte-451it8");
			add_location(span0, file$3, 71, 141, 1323);
			attr(i0, "class", "fab fa-github svelte-451it8");
			add_location(i0, file$3, 71, 116, 1298);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-451it8");
			add_location(a0, file$3, 71, 8, 1190);
			attr(span1, "class", "svelte-451it8");
			add_location(span1, file$3, 72, 149, 1516);
			attr(i1, "class", "fab fa-linkedin svelte-451it8");
			add_location(i1, file$3, 72, 122, 1489);
			...
			attr(a1, "class", "svelte-451it8");
			add_location(a1, file$3, 72, 8, 1375);
			attr(span2, "class", "svelte-451it8");
			add_location(span2, file$3, 73, 145, 1709);
			attr(i2, "class", "fas fa-envelope svelte-451it8");
			add_location(i2, file$3, 73, 118, 1682);
			...
			attr(a2, "class", "svelte-451it8");
			add_location(a2, file$3, 73, 8, 1572);
			attr(div0, "class", "social-container svelte-451it8");
			add_location(div0, file$3, 70, 4, 1151);
			attr(div1, "class", "svelte-451it8");
			add_location(div1, file$3, 66, 0, 1106);
		},
