import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.d761d2b6.js';
import { P as Projects } from './Projects.5bc01244.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-jl5pj9");
			add_location(img, file$3, 161, 8, 4179);
			attr_dev(div0, "class", "image-container svelte-jl5pj9");
			add_location(div0, file$3, 160, 4, 4141);
			attr_dev(h2, "class", "heading svelte-jl5pj9");
			add_location(h2, file$3, 164, 8, 4284);
			attr_dev(h3, "class", "subheading svelte-jl5pj9");
			add_location(h3, file$3, 165, 8, 4358);
			attr_dev(p, "class", "svelte-jl5pj9");
			add_location(p, file$3, 166, 8, 4432);
			attr_dev(a, "class", "button svelte-jl5pj9");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 172, 8, 5036);
			attr_dev(div1, "class", "text-content svelte-jl5pj9");
			add_location(div1, file$3, 163, 4, 4249);
			attr_dev(section, "class", "text-with-image-cta svelte-jl5pj9");
