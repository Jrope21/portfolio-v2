...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-pu3lhn");
			add_location(h3, file$2, 128, 4, 3075);
			attr(li0, "class", "svelte-pu3lhn");
			add_location(li0, file$2, 132, 12, 3145);
			attr(li1, "class", "svelte-pu3lhn");
			add_location(li1, file$2, 133, 12, 3172);
			attr(li2, "class", "svelte-pu3lhn");
			add_location(li2, file$2, 134, 12, 3202);
			attr(li3, "class", "svelte-pu3lhn");
			add_location(li3, file$2, 135, 12, 3230);
			attr(li4, "class", "svelte-pu3lhn");
			add_location(li4, file$2, 136, 12, 3269);
			attr(li5, "class", "svelte-pu3lhn");
			add_location(li5, file$2, 137, 12, 3298);
			attr(li6, "class", "svelte-pu3lhn");
			add_location(li6, file$2, 138, 12, 3341);
			attr(li7, "class", "svelte-pu3lhn");
			add_location(li7, file$2, 139, 12, 3370);
			attr(li8, "class", "svelte-pu3lhn");
			add_location(li8, file$2, 140, 12, 3403);
			attr(li9, "class", "svelte-pu3lhn");
			add_location(li9, file$2, 141, 12, 3428);
			attr(li10, "class", "svelte-pu3lhn");
			add_location(li10, file$2, 142, 12, 3460);
			attr(li11, "class", "svelte-pu3lhn");
			add_location(li11, file$2, 143, 12, 3491);
			attr(li12, "class", "svelte-pu3lhn");
			add_location(li12, file$2, 144, 12, 3528);
			attr(li13, "class", "svelte-pu3lhn");
			add_location(li13, file$2, 145, 12, 3561);
			attr(li14, "class", "svelte-pu3lhn");
			add_location(li14, file$2, 146, 12, 3601);
			attr(li15, "class", "svelte-pu3lhn");
			add_location(li15, file$2, 147, 12, 3642);
			attr(li16, "class", "svelte-pu3lhn");
			add_location(li16, file$2, 148, 12, 3675);
			attr(li17, "class", "svelte-pu3lhn");
			add_location(li17, file$2, 149, 12, 3700);
			attr(ul, "class", "skills svelte-pu3lhn");
			add_location(ul, file$2, 131, 8, 3113);
			attr(div, "class", "svelte-pu3lhn");
			add_location(div, file$2, 127, 0, 3065);
		},
