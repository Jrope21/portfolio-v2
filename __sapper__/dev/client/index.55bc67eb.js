...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-44liic");
			add_location(img, file$3, 184, 8, 3364);
			attr_dev(a0, "href", "javascript:void(0)");
			attr_dev(a0, "class", "image-container svelte-44liic");
			add_location(a0, file$3, 183, 4, 3281);
			attr_dev(h2, "class", "heading svelte-44liic");
			add_location(h2, file$3, 187, 8, 3467);
			attr_dev(h3, "class", "subheading svelte-44liic");
			add_location(h3, file$3, 188, 8, 3541);
			attr_dev(p, "class", "svelte-44liic");
			add_location(p, file$3, 189, 8, 3615);
			attr_dev(a1, "class", "button svelte-44liic");
			attr_dev(a1, "href", "javascript:void(0)");
			add_location(a1, file$3, 193, 8, 3950);
			attr_dev(div, "class", "text-content svelte-44liic");
			add_location(div, file$3, 186, 4, 3432);
			attr_dev(section, "class", "text-with-image-cta svelte-44liic");
