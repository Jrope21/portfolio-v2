...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 85, 20, 1560);
			attr(div, "class", "slide svelte-1rkoq0s");
			add_location(div, file$3, 84, 16, 1520);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 94, 12, 1852);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div1, file$3, 92, 4, 1779);
