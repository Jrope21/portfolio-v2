...
function create_if_block$4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file$b, 50, 1, 1623);
		},
		m: function mount(target, anchor) {
...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-nuk1w7");
			add_location(h1, file$b, 42, 1, 1494);
			attr_dev(h2, "class", "svelte-nuk1w7");
			add_location(h2, file$b, 43, 1, 1511);
			attr_dev(div, "class", "text-container container svelte-nuk1w7");
			add_location(div, file$b, 41, 0, 1454);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.cc089905.js'), __inject_styles(["client-c704507f.css","halcyon-5-min-9ec22285.css","index-f9894ff4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./experience.65d5b6be.js'), __inject_styles(["client-c704507f.css","experience-7af911e7.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./creative-revolt.03622196.js'), __inject_styles(["client-c704507f.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css","creative-revolt-387c384c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./university-park.54d542dc.js'), __inject_styles(["client-c704507f.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./di-repairs.b4aba9fb.js'), __inject_styles(["client-c704507f.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./stallion.62b0e0d6.js'), __inject_styles(["client-c704507f.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./halcyon.c48835da.js'), __inject_styles(["client-c704507f.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./projects.82b19adb.js'), __inject_styles(["client-c704507f.css","halcyon-5-min-9ec22285.css","PageTitle-fbf706b4.css","projects-61f9fec4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./about.37004219.js'), __inject_styles(["client-c704507f.css","about-3acc9d53.css"])]).then(function(x) { return x[0]; })
	}
];
