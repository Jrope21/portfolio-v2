...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 98, 20, 1828);
			attr(div, "class", "slide svelte-1rkoq0s");
			add_location(div, file$3, 97, 16, 1788);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 107, 12, 2120);
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$3, 94, 4, 1682);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 105, 4, 2047);
			attr(div2, "class", "carousel-container svelte-1rkoq0s");
			add_location(div2, file$3, 93, 0, 1645);
		},
