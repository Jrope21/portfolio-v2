...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(section0, file, 123, 16, 2987);
			attr(section1, "class", "skills-container svelte-mu6yvw");
			add_location(section1, file, 126, 16, 3147);
			attr(p, "class", "svelte-mu6yvw");
			add_location(p, file, 130, 20, 3319);
			attr(section2, "class", "cta svelte-mu6yvw");
			add_location(section2, file, 129, 16, 3277);
