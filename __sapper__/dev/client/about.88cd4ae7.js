...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-10f57um");
			add_location(h3, file$1, 105, 4, 2726);
			attr(strong0, "class", "svelte-10f57um");
			add_location(strong0, file$1, 109, 43, 2809);
			attr(strong1, "class", "svelte-10f57um");
			add_location(strong1, file$1, 110, 12, 2898);
			attr(strong2, "class", "svelte-10f57um");
			add_location(strong2, file$1, 111, 30, 3040);
			attr(strong3, "class", "svelte-10f57um");
			add_location(strong3, file$1, 112, 28, 3119);
			attr(strong4, "class", "svelte-10f57um");
			add_location(strong4, file$1, 113, 30, 3239);
			attr(p, "class", "svelte-10f57um");
			add_location(p, file$1, 108, 4, 2762);
			attr(div, "class", "svelte-10f57um");
			add_location(div, file$1, 104, 0, 2716);
		},
