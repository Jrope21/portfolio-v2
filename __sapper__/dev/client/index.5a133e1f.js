...
function create_fragment$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file$5, 176, 4, 6977);
			attr_dev(div, "class", "projects-container svelte-lb4k03");
			add_location(div, file$5, 177, 4, 7005);
			attr_dev(section, "class", "svelte-lb4k03");
			add_location(section, file$5, 175, 0, 6963);
		},
		m: function mount(target, anchor) {
...
function instance$5($$self, $$props, $$invalidate) {
	...
	let portfolioCards = [
		...
		},
		{
			...
			imgSrc: "thumbnails/di-thumb.png",
