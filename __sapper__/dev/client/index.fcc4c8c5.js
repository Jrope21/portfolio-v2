import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.b2fab1bd.js';
import { P as Projects } from './Projects.5f72e4e9.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-s7dryo");
			add_location(div0, file$3, 109, 4, 3042);
			attr_dev(h2, "class", "heading svelte-s7dryo");
			add_location(h2, file$3, 113, 8, 3127);
			attr_dev(h3, "class", "subheading svelte-s7dryo");
			add_location(h3, file$3, 114, 8, 3201);
			attr_dev(br0, "class", "svelte-s7dryo");
			add_location(br0, file$3, 116, 287, 3566);
			attr_dev(br1, "class", "svelte-s7dryo");
			add_location(br1, file$3, 116, 293, 3572);
			attr_dev(p, "class", "svelte-s7dryo");
			add_location(p, file$3, 115, 8, 3275);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn svelte-s7dryo");
			add_location(a, file$3, 119, 8, 3845);
			attr_dev(div1, "class", "text-content svelte-s7dryo");
			add_location(div1, file$3, 112, 4, 3092);
			attr_dev(section, "class", "text-with-image-cta svelte-s7dryo");
			add_location(section, file$3, 108, 0, 3000);
		},
		m: function mount(target, anchor) {
