...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			add_location(img, file$3, 11, 12, 135);
			attr(div0, "class", "slide");
			add_location(div0, file$3, 10, 8, 103);
			attr(div1, "class", "box");
			add_location(div1, file$3, 9, 4, 77);
			attr(div2, "class", "carousel-container");
			add_location(div2, file$3, 8, 0, 40);
		},
