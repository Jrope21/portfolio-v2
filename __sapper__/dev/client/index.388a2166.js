import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.57103034.js';
import { P as Projects } from './Projects.92cdda65.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-17f8wz2");
			add_location(img, file$3, 179, 8, 4692);
			attr_dev(div0, "class", "image-container svelte-17f8wz2");
			add_location(div0, file$3, 178, 4, 4654);
			attr_dev(h2, "class", "heading svelte-17f8wz2");
			add_location(h2, file$3, 182, 8, 4797);
			attr_dev(h3, "class", "subheading svelte-17f8wz2");
			add_location(h3, file$3, 183, 8, 4871);
			attr_dev(p, "class", "svelte-17f8wz2");
			add_location(p, file$3, 184, 8, 4945);
			attr_dev(a, "class", "button svelte-17f8wz2");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 190, 8, 5549);
			attr_dev(div1, "class", "text-content svelte-17f8wz2");
			add_location(div1, file$3, 181, 4, 4762);
			attr_dev(section, "class", "text-with-image-cta svelte-17f8wz2");
			add_location(section, file$3, 177, 0, 4612);
		},
		m: function mount(target, anchor) {
