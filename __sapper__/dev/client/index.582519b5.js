import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.cc2bf65c.js';
import { P as Projects } from './Projects.e4868c03.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-l4syhv");
			add_location(div0, file$3, 87, 4, 2580);
			attr_dev(h2, "class", "svelte-l4syhv");
			add_location(h2, file$3, 91, 8, 2665);
			attr_dev(h3, "class", "subheading svelte-l4syhv");
			add_location(h3, file$3, 92, 8, 2714);
			attr_dev(br0, "class", "svelte-l4syhv");
			add_location(br0, file$3, 94, 287, 3061);
			attr_dev(br1, "class", "svelte-l4syhv");
			add_location(br1, file$3, 94, 293, 3067);
			attr_dev(p, "class", "svelte-l4syhv");
			add_location(p, file$3, 93, 8, 2770);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn svelte-l4syhv");
			add_location(a, file$3, 97, 8, 3340);
			attr_dev(div1, "class", "text-content svelte-l4syhv");
			add_location(div1, file$3, 90, 4, 2630);
			attr_dev(section, "class", "text-with-image-cta svelte-l4syhv");
			add_location(section, file$3, 86, 0, 2538);
		},
		m: function mount(target, anchor) {
