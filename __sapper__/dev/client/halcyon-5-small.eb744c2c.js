...
function create_else_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img0, file$1, 95, 8, 3014);
			...
			add_location(img1, file$1, 101, 8, 3219);
			attr_dev(div, "class", "progressive-image svelte-1tkh93z");
			add_location(div, file$1, 94, 4, 2974);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, img0);
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$1, 83, 12, 2686);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$1, 75, 12, 2485);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
