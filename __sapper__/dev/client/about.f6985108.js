...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-87nx3d");
			add_location(h3, file$3, 105, 4, 2644);
			attr(span0, "class", "svelte-87nx3d");
			add_location(span0, file$3, 109, 141, 2851);
			attr(i0, "class", "fab fa-github svelte-87nx3d");
			add_location(i0, file$3, 109, 116, 2826);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-87nx3d");
			add_location(a0, file$3, 109, 8, 2718);
			attr(span1, "class", "svelte-87nx3d");
			add_location(span1, file$3, 110, 149, 3044);
			attr(i1, "class", "fab fa-linkedin svelte-87nx3d");
			add_location(i1, file$3, 110, 122, 3017);
			...
			attr(a1, "class", "svelte-87nx3d");
			add_location(a1, file$3, 110, 8, 2903);
			attr(span2, "class", "svelte-87nx3d");
			add_location(span2, file$3, 111, 145, 3237);
			attr(i2, "class", "fas fa-envelope svelte-87nx3d");
			add_location(i2, file$3, 111, 118, 3210);
			...
			attr(a2, "class", "svelte-87nx3d");
			add_location(a2, file$3, 111, 8, 3100);
			attr(div0, "class", "social-container svelte-87nx3d");
			add_location(div0, file$3, 108, 4, 2679);
			attr(div1, "class", "svelte-87nx3d");
			add_location(div1, file$3, 104, 0, 2634);
		},
