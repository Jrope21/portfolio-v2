import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.bb94dd86.js';
import { P as Projects } from './Projects.3d0caa54.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-1nxubd9");
			add_location(div0, file$3, 102, 4, 2898);
			attr_dev(h2, "class", "heading svelte-1nxubd9");
			add_location(h2, file$3, 106, 8, 2983);
			attr_dev(h3, "class", "subheading svelte-1nxubd9");
			add_location(h3, file$3, 107, 8, 3048);
			attr_dev(br0, "class", "svelte-1nxubd9");
			add_location(br0, file$3, 109, 287, 3413);
			attr_dev(br1, "class", "svelte-1nxubd9");
			add_location(br1, file$3, 109, 293, 3419);
			attr_dev(p, "class", "svelte-1nxubd9");
			add_location(p, file$3, 108, 8, 3122);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn svelte-1nxubd9");
			add_location(a, file$3, 112, 8, 3692);
			attr_dev(div1, "class", "text-content svelte-1nxubd9");
			add_location(div1, file$3, 105, 4, 2948);
			attr_dev(section, "class", "text-with-image-cta svelte-1nxubd9");
			add_location(section, file$3, 101, 0, 2856);
		},
		m: function mount(target, anchor) {
