import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.8476f111.js';
import { P as Projects } from './Projects.b0ce6a0b.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1w9q5lc");
			add_location(img, file$3, 173, 8, 4551);
			attr_dev(div0, "class", "image-container svelte-1w9q5lc");
			add_location(div0, file$3, 172, 4, 4513);
			attr_dev(h2, "class", "heading svelte-1w9q5lc");
			add_location(h2, file$3, 176, 8, 4656);
			attr_dev(h3, "class", "subheading svelte-1w9q5lc");
			add_location(h3, file$3, 177, 8, 4730);
			attr_dev(p, "class", "svelte-1w9q5lc");
			add_location(p, file$3, 178, 8, 4804);
			attr_dev(a, "class", "button svelte-1w9q5lc");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 184, 8, 5408);
			attr_dev(div1, "class", "text-content svelte-1w9q5lc");
			add_location(div1, file$3, 175, 4, 4621);
			attr_dev(section, "class", "text-with-image-cta svelte-1w9q5lc");
			add_location(section, file$3, 171, 0, 4471);
		},
		m: function mount(target, anchor) {
