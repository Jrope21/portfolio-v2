...
function create_if_block(ctx) {
	var div, img, img_src_value, img_intro;
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 101, 20, 1869);
		...
		i: function intro(local) {
			if (!img_intro) {
				add_render_callback(() => {
					img_intro = create_in_transition(img, fly$1, { x: -40, duration: 500, delay: 650, });
					img_intro.start();
				});
			}
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 107, 12, 2088);
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div1, file$3, 105, 4, 2015);
