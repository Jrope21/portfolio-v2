...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-1mns7mp");
			add_location(h3, file$1, 97, 4, 2594);
			attr(strong0, "class", "svelte-1mns7mp");
			add_location(strong0, file$1, 101, 43, 2677);
			attr(strong1, "class", "svelte-1mns7mp");
			add_location(strong1, file$1, 102, 12, 2766);
			attr(strong2, "class", "svelte-1mns7mp");
			add_location(strong2, file$1, 103, 30, 2908);
			attr(strong3, "class", "svelte-1mns7mp");
			add_location(strong3, file$1, 104, 28, 2987);
			attr(strong4, "class", "svelte-1mns7mp");
			add_location(strong4, file$1, 105, 30, 3107);
			attr(p, "class", "svelte-1mns7mp");
			add_location(p, file$1, 100, 4, 2630);
			attr(div, "class", "svelte-1mns7mp");
			add_location(div, file$1, 96, 0, 2584);
		},
