...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-s41ri9");
			add_location(img, file$3, 130, 20, 2421);
			attr(div, "class", "slide svelte-s41ri9");
			add_location(div, file$3, 129, 16, 2336);
		},
...
// (128:8) {#each STATE.images as img}
...
// (136:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-s41ri9");
			add_location(span, file$3, 136, 12, 2600);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-s41ri9")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-s41ri9");
			add_location(div0, file$3, 126, 4, 2230);
			attr(div1, "class", "circles-container svelte-s41ri9");
			add_location(div1, file$3, 134, 4, 2517);
			attr(div2, "class", "carousel-container svelte-s41ri9");
			add_location(div2, file$3, 125, 0, 2193);
		},
