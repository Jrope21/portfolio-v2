...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "slide svelte-1142kvf");
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1142kvf");
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1142kvf")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-1142kvf");
			add_location(div0, file$1, 247, 4, 4567);
			attr(div1, "class", "circles-container svelte-1142kvf");
			add_location(div1, file$1, 256, 4, 5003);
			attr(div2, "class", "carousel-container svelte-1142kvf");
