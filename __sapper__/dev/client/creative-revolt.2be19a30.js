...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", " svelte-1nn0ovu");
			add_location(h1, file$2, 59, 12, 1447);
			attr(div, "class", "container title-container svelte-1nn0ovu");
