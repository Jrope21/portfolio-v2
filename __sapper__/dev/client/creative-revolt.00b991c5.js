...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			add_location(img, file$1, 253, 20, 4938);
			attr(div, "class", "slide svelte-17tthih");
			add_location(div, file$1, 252, 16, 4853);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-17tthih");
			add_location(span, file$1, 259, 12, 5117);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-17tthih")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-17tthih");
			add_location(div0, file$1, 248, 4, 4598);
			attr(div1, "class", "circles-container svelte-17tthih");
			add_location(div1, file$1, 257, 4, 5034);
			attr(div2, "class", "carousel-container svelte-17tthih");
			add_location(div2, file$1, 247, 0, 4561);
		},
