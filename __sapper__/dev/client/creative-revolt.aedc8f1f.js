...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1co73c4");
			add_location(img, file$3, 138, 20, 2714);
			attr(div, "class", "slide svelte-1co73c4");
			add_location(div, file$3, 137, 16, 2629);
		},
...
// (136:8) {#each STATE.images as img}
...
// (144:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1co73c4");
			add_location(span, file$3, 144, 12, 2893);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1co73c4")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-1co73c4");
			add_location(span, file$3, 133, 21, 2392);
			attr(div0, "class", "box svelte-1co73c4");
			add_location(div0, file$3, 133, 4, 2375);
			attr(div1, "class", "circles-container svelte-1co73c4");
			add_location(div1, file$3, 142, 4, 2810);
			attr(div2, "class", "carousel-container svelte-1co73c4");
			add_location(div2, file$3, 132, 0, 2338);
		},
