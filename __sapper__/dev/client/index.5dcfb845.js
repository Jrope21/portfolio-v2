import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.a73ab81b.js';
import { P as Projects } from './Projects.bcc20fa9.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-14mc1ar");
			add_location(div0, file$3, 93, 4, 2723);
			attr_dev(h2, "class", "svelte-14mc1ar");
			add_location(h2, file$3, 97, 8, 2808);
			attr_dev(h3, "class", "subheading svelte-14mc1ar");
			add_location(h3, file$3, 98, 8, 2857);
			attr_dev(br0, "class", "svelte-14mc1ar");
			add_location(br0, file$3, 100, 287, 3204);
			attr_dev(br1, "class", "svelte-14mc1ar");
			add_location(br1, file$3, 100, 293, 3210);
			attr_dev(p, "class", "svelte-14mc1ar");
			add_location(p, file$3, 99, 8, 2913);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn svelte-14mc1ar");
			add_location(a, file$3, 103, 8, 3483);
			attr_dev(div1, "class", "text-content svelte-14mc1ar");
			add_location(div1, file$3, 96, 4, 2773);
			attr_dev(section, "class", "text-with-image-cta svelte-14mc1ar");
			add_location(section, file$3, 92, 0, 2681);
		},
		m: function mount(target, anchor) {
