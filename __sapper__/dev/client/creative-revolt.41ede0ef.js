...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1tuhk6t");
			add_location(img, file$3, 159, 20, 3164);
			attr(div, "class", "slide svelte-1tuhk6t");
			add_location(div, file$3, 158, 16, 3079);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1tuhk6t");
			add_location(span, file$3, 165, 12, 3343);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1tuhk6t")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-1tuhk6t");
			add_location(span, file$3, 154, 21, 2842);
			attr(div0, "class", "box svelte-1tuhk6t");
			add_location(div0, file$3, 154, 4, 2825);
			attr(div1, "class", "circles-container svelte-1tuhk6t");
			add_location(div1, file$3, 163, 4, 3260);
			attr(div2, "class", "carousel-container svelte-1tuhk6t");
			add_location(div2, file$3, 153, 0, 2788);
		},
