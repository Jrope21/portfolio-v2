...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-19eixg5");
			add_location(div0, file$3, 62, 4, 1032);
			attr(img, "src", "images/Jorden-Background-Gray.jpg");
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-19eixg5");
			add_location(img, file$3, 64, 12, 1096);
			attr(div1, "class", "slide svelte-19eixg5");
			add_location(div1, file$3, 63, 8, 1064);
			attr(span0, "class", "circle");
			add_location(span0, file$3, 67, 8, 1204);
			attr(span1, "class", "circle");
			add_location(span1, file$3, 68, 8, 1248);
			attr(span2, "class", "circle");
			add_location(span2, file$3, 69, 8, 1292);
			attr(div2, "class", "circles");
			add_location(div2, file$3, 66, 4, 1174);
			attr(div3, "class", "carousel-container svelte-19eixg5");
			add_location(div3, file$3, 61, 0, 995);
		},
