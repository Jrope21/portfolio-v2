...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "container svelte-1biyjnw");
			add_location(h1, file$2, 50, 8, 1198);
			attr(section, "class", "container");
			add_location(section, file$2, 53, 8, 1251);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file$2, 47, 0, 1083);
		},
