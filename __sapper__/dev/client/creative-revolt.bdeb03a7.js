...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-16sygxl");
			add_location(img, file$3, 147, 20, 2896);
			attr(div, "class", "slide svelte-16sygxl");
			add_location(div, file$3, 146, 16, 2811);
		},
...
// (145:8) {#each STATE.images as img}
...
// (153:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-16sygxl");
			add_location(span, file$3, 153, 12, 3075);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-16sygxl")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-16sygxl");
			add_location(span, file$3, 142, 21, 2574);
			attr(div0, "class", "box svelte-16sygxl");
			add_location(div0, file$3, 142, 4, 2557);
			attr(div1, "class", "circles-container svelte-16sygxl");
			add_location(div1, file$3, 151, 4, 2992);
			attr(div2, "class", "carousel-container svelte-16sygxl");
			add_location(div2, file$3, 141, 0, 2520);
		},
