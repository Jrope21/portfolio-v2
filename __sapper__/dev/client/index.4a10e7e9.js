import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.06a971ef.js';
import { P as Projects } from './Projects.b53bf7a1.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			t4 = space();
			p = element("p");
			t5 = text("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sem purus libero proin elit, consectetur vitae ut purus. Eu diam aliquam justo nam eget. Sollicitudin pharetra, quisque placerat vulputate. Vitae vestibulum tristique commodo aliquet suspendisse leo morbi velit tellus. Vitae vestibulum tristique commodo aliquet suspendisse leo morbi velit tellus.");
			t6 = space();
			a = element("a");
		...
		l: function claim(nodes) {
			...
			t5 = claim_text(p_nodes, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sem purus libero proin elit, consectetur vitae ut purus. Eu diam aliquam justo nam eget. Sollicitudin pharetra, quisque placerat vulputate. Vitae vestibulum tristique commodo aliquet suspendisse leo morbi velit tellus. Vitae vestibulum tristique commodo aliquet suspendisse leo morbi velit tellus.");
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1rpcuem");
			add_location(img, file$3, 132, 8, 3452);
			attr_dev(div0, "class", "image-container svelte-1rpcuem");
			add_location(div0, file$3, 131, 4, 3414);
			attr_dev(h2, "class", "heading svelte-1rpcuem");
			add_location(h2, file$3, 135, 8, 3557);
			attr_dev(h3, "class", "subheading svelte-1rpcuem");
			add_location(h3, file$3, 136, 8, 3631);
			attr_dev(p, "class", "svelte-1rpcuem");
			add_location(p, file$3, 137, 8, 3705);
			attr_dev(a, "class", "button svelte-1rpcuem");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 143, 8, 4386);
			attr_dev(div1, "class", "text-content svelte-1rpcuem");
			add_location(div1, file$3, 134, 4, 3522);
			attr_dev(section, "class", "text-with-image-cta svelte-1rpcuem");
			add_location(section, file$3, 130, 0, 3372);
		},
		m: function mount(target, anchor) {
