...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1b5ahqu");
			add_location(img, file, 78, 6, 1382);
			attr_dev(div, "class", "img-container svelte-1b5ahqu");
			add_location(div, file, 77, 4, 1348);
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*width*/ ctx[3]) + " svelte-1b5ahqu"));
			attr_dev(a, "href", /*url*/ ctx[2]);
			add_location(a, file, 76, 0, 1298);
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*width*/ 8 && a_class_value !== (a_class_value = "" + (null_to_empty(/*width*/ ctx[3]) + " svelte-1b5ahqu"))) {
