...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$1, 259, 20, 5080);
			attr(div, "class", "slide svelte-1ghlmdq");
			add_location(div, file$1, 258, 16, 4995);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 265, 12, 5259);
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div1, file$1, 263, 4, 5176);
