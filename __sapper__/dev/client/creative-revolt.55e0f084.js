...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-t8wn3r");
			add_location(img, file$3, 94, 20, 1802);
			attr(div, "class", "slide svelte-t8wn3r");
			add_location(div, file$3, 93, 16, 1717);
		},
...
// (100:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-t8wn3r");
			add_location(span, file$3, 100, 12, 1971);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-t8wn3r")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-t8wn3r");
			add_location(div0, file$3, 90, 4, 1611);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 98, 4, 1898);
			attr(div2, "class", "carousel-container svelte-t8wn3r");
			add_location(div2, file$3, 89, 0, 1574);
		},
