...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$2, 159, 20, 3161);
			attr(div, "class", "slide svelte-1s25sz3");
			add_location(div, file$2, 158, 16, 3075);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$2, 165, 12, 3340);
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$2, 154, 21, 2838);
			attr(div0, "class", "box svelte-1s25sz3");
			add_location(div0, file$2, 154, 4, 2821);
			attr(div1, "class", "circles-container svelte-1s25sz3");
			add_location(div1, file$2, 163, 4, 3257);
			attr(div2, "class", "carousel-container svelte-1s25sz3");
			add_location(div2, file$2, 153, 0, 2784);
		},
...
function create_fragment$4(ctx) {
	var t0, t1, div, div_intro, t2, section, current;
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file$4, 14, 0, 376);
			attr(section, "class", "container");
			add_location(section, file$4, 20, 0, 490);
		},
