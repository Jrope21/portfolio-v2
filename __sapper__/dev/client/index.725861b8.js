import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.98fdd8bc.js';
import { P as Projects } from './Projects.e99e093d.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			br0 = element("br");
			br1 = element("br");
			t6 = text("\n            Consectetur adipiscing elit. Sem purus libero proin elit, consectetur vitae ut purus. Eu diam aliquam justo nam eget. Sollicitudin pharetra, quisque placerat vulputate. Vitae vestibulum tristique commodo.");
			t7 = space();
			a = element("a");
		...
		l: function claim(nodes) {
			...
			br0 = claim_element(p_nodes, "BR", { class: true });
			br1 = claim_element(p_nodes, "BR", { class: true });
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-j4zr0u");
			add_location(img, file$3, 135, 8, 3568);
			attr_dev(div0, "class", "image-container svelte-j4zr0u");
			add_location(div0, file$3, 134, 4, 3530);
			attr_dev(h2, "class", "heading svelte-j4zr0u");
			add_location(h2, file$3, 138, 8, 3673);
			attr_dev(h3, "class", "subheading svelte-j4zr0u");
			add_location(h3, file$3, 139, 8, 3747);
			attr_dev(br0, "class", "svelte-j4zr0u");
			add_location(br0, file$3, 142, 12, 4125);
			attr_dev(br1, "class", "svelte-j4zr0u");
			add_location(br1, file$3, 142, 18, 4131);
			attr_dev(p, "class", "svelte-j4zr0u");
			add_location(p, file$3, 140, 8, 3821);
			attr_dev(a, "class", "button svelte-j4zr0u");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 146, 8, 4377);
			attr_dev(div1, "class", "text-content svelte-j4zr0u");
			add_location(div1, file$3, 137, 4, 3638);
			attr_dev(section, "class", "text-with-image-cta svelte-j4zr0u");
			add_location(section, file$3, 133, 0, 3488);
		},
		m: function mount(target, anchor) {
