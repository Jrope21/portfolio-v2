...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-l5bcmp");
			add_location(img, file$3, 148, 20, 2917);
			attr(div, "class", "slide svelte-l5bcmp");
			add_location(div, file$3, 147, 16, 2832);
		},
...
// (146:8) {#each STATE.images as img}
...
// (154:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-l5bcmp");
			add_location(span, file$3, 154, 12, 3096);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-l5bcmp")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-l5bcmp");
			add_location(span, file$3, 143, 21, 2595);
			attr(div0, "class", "box svelte-l5bcmp");
			add_location(div0, file$3, 143, 4, 2578);
			attr(div1, "class", "circles-container svelte-l5bcmp");
			add_location(div1, file$3, 152, 4, 3013);
			attr(div2, "class", "carousel-container svelte-l5bcmp");
			add_location(div2, file$3, 142, 0, 2541);
		},
