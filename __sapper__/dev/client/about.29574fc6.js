...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-1fy61wr");
			add_location(h3, file$3, 116, 4, 2958);
			attr(span0, "class", "svelte-1fy61wr");
			add_location(span0, file$3, 120, 141, 3165);
			attr(i0, "class", "fab fa-github svelte-1fy61wr");
			add_location(i0, file$3, 120, 116, 3140);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-1fy61wr");
			add_location(a0, file$3, 120, 8, 3032);
			attr(span1, "class", "svelte-1fy61wr");
			add_location(span1, file$3, 121, 149, 3358);
			attr(i1, "class", "fab fa-linkedin svelte-1fy61wr");
			add_location(i1, file$3, 121, 122, 3331);
			...
			attr(a1, "class", "svelte-1fy61wr");
			add_location(a1, file$3, 121, 8, 3217);
			attr(span2, "class", "svelte-1fy61wr");
			add_location(span2, file$3, 122, 145, 3551);
			attr(i2, "class", "fas fa-envelope svelte-1fy61wr");
			add_location(i2, file$3, 122, 118, 3524);
			...
			attr(a2, "class", "svelte-1fy61wr");
			add_location(a2, file$3, 122, 8, 3414);
			attr(div0, "class", "social-container svelte-1fy61wr");
			add_location(div0, file$3, 119, 4, 2993);
			attr(div1, "class", "svelte-1fy61wr");
			add_location(div1, file$3, 115, 0, 2948);
		},
