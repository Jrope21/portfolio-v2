import { S as SvelteComponentDev, i as init, s as safe_not_equal, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, d as detach, g as attr, h as add_location, j as insert, k as append, J as set_data, n as noop, y as mount_component, r as transition_in, w as transition_out, z as destroy_component, u as add_render_callback, v as create_in_transition } from './index.d872f164.js';
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h3, file$2, 110, 4, 1838);
			attr(li0, "class", "svelte-1gz9aiu");
			add_location(li0, file$2, 114, 12, 1908);
			attr(li1, "class", "svelte-1gz9aiu");
			add_location(li1, file$2, 115, 12, 1935);
			attr(li2, "class", "svelte-1gz9aiu");
			add_location(li2, file$2, 116, 12, 1965);
			attr(li3, "class", "svelte-1gz9aiu");
			add_location(li3, file$2, 117, 12, 1993);
			attr(li4, "class", "svelte-1gz9aiu");
			add_location(li4, file$2, 118, 12, 2032);
			attr(li5, "class", "svelte-1gz9aiu");
			add_location(li5, file$2, 119, 12, 2061);
			attr(li6, "class", "svelte-1gz9aiu");
			add_location(li6, file$2, 120, 12, 2104);
			attr(li7, "class", "svelte-1gz9aiu");
			add_location(li7, file$2, 121, 12, 2133);
			attr(li8, "class", "svelte-1gz9aiu");
			add_location(li8, file$2, 122, 12, 2166);
			attr(li9, "class", "svelte-1gz9aiu");
			add_location(li9, file$2, 123, 12, 2191);
			attr(li10, "class", "svelte-1gz9aiu");
			add_location(li10, file$2, 124, 12, 2223);
			attr(li11, "class", "svelte-1gz9aiu");
			add_location(li11, file$2, 125, 12, 2254);
			attr(li12, "class", "svelte-1gz9aiu");
			add_location(li12, file$2, 126, 12, 2291);
			attr(li13, "class", "svelte-1gz9aiu");
			add_location(li13, file$2, 127, 12, 2324);
			attr(li14, "class", "svelte-1gz9aiu");
			add_location(li14, file$2, 128, 12, 2364);
			attr(li15, "class", "svelte-1gz9aiu");
			add_location(li15, file$2, 129, 12, 2405);
			attr(li16, "class", "svelte-1gz9aiu");
			add_location(li16, file$2, 130, 12, 2438);
			attr(li17, "class", "svelte-1gz9aiu");
			add_location(li17, file$2, 131, 12, 2463);
			attr(ul, "class", "skills svelte-1gz9aiu");
			add_location(ul, file$2, 113, 8, 1876);
			attr(div, "class", "svelte-1gz9aiu");
			add_location(div, file$2, 109, 0, 1828);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h3, file$3, 88, 4, 1516);
			attr(span0, "class", "svelte-1cjafcw");
			add_location(span0, file$3, 92, 141, 1723);
			attr(i0, "class", "fab fa-github svelte-1cjafcw");
			add_location(i0, file$3, 92, 116, 1698);
			...
			add_location(a0, file$3, 92, 8, 1590);
			attr(span1, "class", "svelte-1cjafcw");
			add_location(span1, file$3, 93, 149, 1916);
			attr(i1, "class", "fab fa-linkedin svelte-1cjafcw");
			add_location(i1, file$3, 93, 122, 1889);
			...
			add_location(a1, file$3, 93, 8, 1775);
			attr(span2, "class", "svelte-1cjafcw");
			add_location(span2, file$3, 94, 145, 2109);
			attr(i2, "class", "fas fa-envelope svelte-1cjafcw");
			add_location(i2, file$3, 94, 118, 2082);
			...
			add_location(a2, file$3, 94, 8, 1972);
			attr(div0, "class", "social-container svelte-1cjafcw");
			add_location(div0, file$3, 91, 4, 1551);
			attr(div1, "class", "svelte-1cjafcw");
			add_location(div1, file$3, 87, 0, 1506);
		},
