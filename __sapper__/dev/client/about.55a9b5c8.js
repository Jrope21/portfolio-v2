...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-b8migy");
			add_location(h3, file$3, 90, 4, 1626);
			attr(span0, "class", "svelte-b8migy");
			add_location(span0, file$3, 94, 141, 1833);
			attr(i0, "class", "fab fa-github svelte-b8migy");
			add_location(i0, file$3, 94, 116, 1808);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-b8migy");
			add_location(a0, file$3, 94, 8, 1700);
			attr(span1, "class", "svelte-b8migy");
			add_location(span1, file$3, 95, 149, 2026);
			attr(i1, "class", "fab fa-linkedin svelte-b8migy");
			add_location(i1, file$3, 95, 122, 1999);
			...
			attr(a1, "class", "svelte-b8migy");
			add_location(a1, file$3, 95, 8, 1885);
			attr(span2, "class", "svelte-b8migy");
			add_location(span2, file$3, 96, 145, 2219);
			attr(i2, "class", "fas fa-envelope svelte-b8migy");
			add_location(i2, file$3, 96, 118, 2192);
			...
			attr(a2, "class", "svelte-b8migy");
			add_location(a2, file$3, 96, 8, 2082);
			attr(div0, "class", "social-container svelte-b8migy");
			add_location(div0, file$3, 93, 4, 1661);
			attr(div1, "class", "svelte-b8migy");
			add_location(div1, file$3, 89, 0, 1616);
		},
