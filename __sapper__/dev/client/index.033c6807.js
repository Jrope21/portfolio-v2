...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-xvuaon");
			add_location(img, file$3, 184, 8, 3394);
			attr_dev(a0, "href", "javascript:void(0)");
			attr_dev(a0, "class", "image-container svelte-xvuaon");
			add_location(a0, file$3, 183, 4, 3311);
			attr_dev(h2, "class", "heading svelte-xvuaon");
			add_location(h2, file$3, 187, 8, 3497);
			attr_dev(h3, "class", "subheading svelte-xvuaon");
			add_location(h3, file$3, 188, 8, 3571);
			attr_dev(p, "class", "svelte-xvuaon");
			add_location(p, file$3, 189, 8, 3645);
			attr_dev(a1, "class", "button svelte-xvuaon");
			attr_dev(a1, "href", "javascript:void(0)");
			add_location(a1, file$3, 193, 8, 3980);
			attr_dev(div, "class", "text-content svelte-xvuaon");
			add_location(div, file$3, 186, 4, 3462);
			attr_dev(section, "class", "text-with-image-cta svelte-xvuaon");
