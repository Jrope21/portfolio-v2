...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h2, "class", "svelte-ruleai");
			add_location(h2, file$1, 77, 4, 1289);
			attr_dev(span, "class", "year svelte-ruleai");
			add_location(span, file$1, 79, 8, 1328);
			html_tag = new HtmlTag(null);
			attr_dev(p, "class", "svelte-ruleai");
			add_location(p, file$1, 78, 4, 1316);
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", /*url*/ ctx[1]);
			attr_dev(a, "class", "svelte-ruleai");
			add_location(a, file$1, 82, 4, 1409);
			attr_dev(div, "class", "svelte-ruleai");
			add_location(div, file$1, 76, 0, 1279);
		},
		m: function mount(target, anchor) {
