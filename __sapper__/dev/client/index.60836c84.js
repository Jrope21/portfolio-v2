import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.fa099fe9.js';
import { P as Projects } from './Projects.14dbe211.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-1asmm0d");
			add_location(div0, file$3, 103, 4, 2915);
			attr_dev(h2, "class", "heading svelte-1asmm0d");
			add_location(h2, file$3, 107, 8, 3000);
			attr_dev(h3, "class", "subheading svelte-1asmm0d");
			add_location(h3, file$3, 108, 8, 3065);
			attr_dev(br0, "class", "svelte-1asmm0d");
			add_location(br0, file$3, 110, 287, 3430);
			attr_dev(br1, "class", "svelte-1asmm0d");
			add_location(br1, file$3, 110, 293, 3436);
			attr_dev(p, "class", "svelte-1asmm0d");
			add_location(p, file$3, 109, 8, 3139);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn svelte-1asmm0d");
			add_location(a, file$3, 113, 8, 3709);
			attr_dev(div1, "class", "text-content svelte-1asmm0d");
			add_location(div1, file$3, 106, 4, 2965);
			attr_dev(section, "class", "text-with-image-cta svelte-1asmm0d");
			add_location(section, file$3, 102, 0, 2873);
		},
		m: function mount(target, anchor) {
