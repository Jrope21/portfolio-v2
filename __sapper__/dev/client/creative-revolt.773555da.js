...
function create_if_block(ctx) {
	var div, t, img, img_src_value, div_intro;
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 102, 20, 1939);
		...
		i: function intro(local) {
			if (!div_intro) {
				add_render_callback(() => {
					div_intro = create_in_transition(div, fly$1, { x: -40, duration: 500, delay: 650, });
					div_intro.start();
				});
			}
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 108, 12, 2108);
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div1, file$3, 106, 4, 2035);
