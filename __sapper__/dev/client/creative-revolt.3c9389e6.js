...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 85, 20, 1584);
			attr(div, "class", "slide svelte-1rkoq0s");
			add_location(div, file$3, 84, 16, 1544);
		},
...
function create_each_block(ctx) {
	var span, t0, t1, span_data_key_value;
	...
	return {
		...
		l: function claim(nodes) {
			span = claim_element(nodes, "SPAN", { "data-key": true, class: true }, false);
			var span_nodes = children(span);
		...
		h: function hydrate() {
			attr(span, "data-key", span_data_key_value = ctx.img.key);
			attr(span, "class", "circle");
			add_location(span, file$3, 94, 12, 1876);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$3, 81, 4, 1438);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 92, 4, 1803);
			attr(div2, "class", "carousel-container svelte-1rkoq0s");
			add_location(div2, file$3, 80, 0, 1401);
		},
