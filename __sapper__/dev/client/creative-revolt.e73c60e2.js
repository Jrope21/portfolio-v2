...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p, "class", "headline svelte-cwk5z4");
			add_location(p, file$1, 15, 0, 311);
		},
