...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-7yql02");
			add_location(h3, file$3, 115, 4, 2807);
			attr(span0, "class", "svelte-7yql02");
			add_location(span0, file$3, 119, 141, 3014);
			attr(i0, "class", "fab fa-github svelte-7yql02");
			add_location(i0, file$3, 119, 116, 2989);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-7yql02");
			add_location(a0, file$3, 119, 8, 2881);
			attr(span1, "class", "svelte-7yql02");
			add_location(span1, file$3, 120, 149, 3207);
			attr(i1, "class", "fab fa-linkedin svelte-7yql02");
			add_location(i1, file$3, 120, 122, 3180);
			...
			attr(a1, "class", "svelte-7yql02");
			add_location(a1, file$3, 120, 8, 3066);
			attr(span2, "class", "svelte-7yql02");
			add_location(span2, file$3, 121, 145, 3400);
			attr(i2, "class", "fas fa-envelope svelte-7yql02");
			add_location(i2, file$3, 121, 118, 3373);
			...
			attr(a2, "class", "svelte-7yql02");
			add_location(a2, file$3, 121, 8, 3263);
			attr(div0, "class", "social-container svelte-7yql02");
			add_location(div0, file$3, 118, 4, 2842);
			attr(div1, "class", "svelte-7yql02");
			add_location(div1, file$3, 114, 0, 2797);
		},
