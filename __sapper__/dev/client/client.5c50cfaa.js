...
const components = [
	{
		js: () => Promise.all([import('./index.af0591b2.js'), __inject_styles(["client-edff56d5.css","halcyon-5-min-9ec22285.css","index-f9894ff4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./experience.c7822306.js'), __inject_styles(["client-edff56d5.css","experience-7af911e7.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./creative-revolt.0a2ce017.js'), __inject_styles(["client-edff56d5.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css","creative-revolt-387c384c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./university-park.16e2f1f7.js'), __inject_styles(["client-edff56d5.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./di-repairs.a9226da7.js'), __inject_styles(["client-edff56d5.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./stallion.d7892475.js'), __inject_styles(["client-edff56d5.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./halcyon.c180cea0.js'), __inject_styles(["client-edff56d5.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./projects.80fef0b8.js'), __inject_styles(["client-edff56d5.css","halcyon-5-min-9ec22285.css","PageTitle-fbf706b4.css","projects-61f9fec4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./about.441fa19f.js'), __inject_styles(["client-edff56d5.css","about-3acc9d53.css"])]).then(function(x) { return x[0]; })
	}
];
