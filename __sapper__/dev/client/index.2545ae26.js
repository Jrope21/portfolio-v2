...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "hero-image svelte-13s814s");
			add_location(div0, file, 83, 4, 1894);
			attr(div1, "class", "box svelte-13s814s");
			add_location(div1, file, 82, 0, 1872);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h2, file$5, 130, 4, 4177);
			attr(div, "class", "projects-container svelte-1w3h4qb");
			add_location(div, file$5, 131, 4, 4205);
			attr(section, "class", "svelte-1w3h4qb");
			add_location(section, file$5, 129, 0, 4163);
		},
