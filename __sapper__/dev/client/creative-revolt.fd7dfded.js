...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "container svelte-1h3fbkj");
			add_location(h1, file$2, 52, 8, 1321);
			attr(section, "class", "container");
			add_location(section, file$2, 55, 8, 1374);
		},
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file$2, 49, 0, 1206);
		},
