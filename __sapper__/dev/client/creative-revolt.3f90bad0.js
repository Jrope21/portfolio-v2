...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1q5r439");
			add_location(img, file$3, 119, 20, 2178);
			attr(div, "class", "slide svelte-1q5r439");
			add_location(div, file$3, 118, 16, 2093);
		},
...
// (117:8) {#each STATE.images as img}
...
// (125:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1q5r439");
			add_location(span, file$3, 125, 12, 2357);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1q5r439")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-1q5r439");
			add_location(div0, file$3, 115, 4, 1987);
			attr(div1, "class", "circles-container svelte-1q5r439");
			add_location(div1, file$3, 123, 4, 2274);
			attr(div2, "class", "carousel-container svelte-1q5r439");
			add_location(div2, file$3, 114, 0, 1950);
		},
