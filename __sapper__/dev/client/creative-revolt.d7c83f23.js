...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1lcgsr8");
			add_location(img, file$1, 267, 20, 5204);
			attr(div, "class", "slide svelte-1lcgsr8");
			add_location(div, file$1, 266, 16, 5119);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1lcgsr8");
			add_location(span, file$1, 273, 12, 5383);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1lcgsr8")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-1lcgsr8");
			add_location(span, file$1, 261, 0, 4817);
			attr(div0, "class", "box svelte-1lcgsr8");
			add_location(div0, file$1, 262, 4, 4864);
			attr(div1, "class", "circles-container svelte-1lcgsr8");
			add_location(div1, file$1, 271, 4, 5300);
			attr(div2, "class", "carousel-container svelte-1lcgsr8");
			add_location(div2, file$1, 260, 0, 4784);
		},
