...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-yn0fr4");
			add_location(img, file$3, 159, 20, 3164);
			attr(div, "class", "slide svelte-yn0fr4");
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-yn0fr4");
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-yn0fr4")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-yn0fr4");
			add_location(span, file$3, 154, 21, 2842);
			attr(div0, "class", "box svelte-yn0fr4");
			add_location(div0, file$3, 154, 4, 2825);
			attr(div1, "class", "circles-container svelte-yn0fr4");
			add_location(div1, file$3, 163, 4, 3260);
			attr(div2, "class", "carousel-container svelte-yn0fr4");
