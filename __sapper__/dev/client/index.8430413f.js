import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.f68ea05a.js';
import { P as Projects } from './Projects.90e2b1d8.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1dx7i8m");
			add_location(img, file$3, 132, 8, 3513);
			attr_dev(div0, "class", "image-container svelte-1dx7i8m");
			add_location(div0, file$3, 131, 4, 3475);
			attr_dev(h2, "class", "heading svelte-1dx7i8m");
			add_location(h2, file$3, 135, 8, 3618);
			attr_dev(h3, "class", "subheading svelte-1dx7i8m");
			add_location(h3, file$3, 136, 8, 3692);
			attr_dev(br0, "class", "svelte-1dx7i8m");
			add_location(br0, file$3, 139, 12, 4070);
			attr_dev(br1, "class", "svelte-1dx7i8m");
			add_location(br1, file$3, 139, 18, 4076);
			attr_dev(p, "class", "svelte-1dx7i8m");
			add_location(p, file$3, 137, 8, 3766);
			attr_dev(a, "class", "button svelte-1dx7i8m");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 143, 8, 4350);
			attr_dev(div1, "class", "text-content svelte-1dx7i8m");
			add_location(div1, file$3, 134, 4, 3583);
			attr_dev(section, "class", "text-with-image-cta svelte-1dx7i8m");
			add_location(section, file$3, 130, 0, 3433);
		},
		m: function mount(target, anchor) {
