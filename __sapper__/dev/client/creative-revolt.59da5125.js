...
import { I as Image } from './Image.95feaf11.js';
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "grid-element-container svelte-1dkhly");
			add_location(div0, file, 40, 4, 701);
			attr(div1, "class", "grid-element-container svelte-1dkhly");
			add_location(div1, file, 43, 4, 850);
			attr(div2, "class", "grid-element-container svelte-1dkhly");
			add_location(div2, file, 46, 4, 999);
			attr(div3, "class", "grid-element-container svelte-1dkhly");
			add_location(div3, file, 49, 4, 1148);
			attr(div4, "class", "grid-element-container full-width svelte-1dkhly");
			add_location(div4, file, 52, 4, 1297);
			attr(div5, "class", "image-grid svelte-1dkhly");
			add_location(div5, file, 39, 0, 672);
		},
