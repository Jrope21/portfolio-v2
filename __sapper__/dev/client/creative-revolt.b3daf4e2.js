...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 132, 20, 2488);
			attr(div, "class", "slide svelte-129iewz");
			add_location(div, file$3, 131, 16, 2403);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 138, 12, 2667);
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div1, file$3, 136, 4, 2584);
