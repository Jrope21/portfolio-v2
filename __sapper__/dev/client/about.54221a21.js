...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-fhkgy");
			add_location(h3, file$3, 84, 4, 1371);
			attr(span0, "class", "svelte-fhkgy");
			add_location(span0, file$3, 88, 141, 1578);
			attr(i0, "class", "fab fa-github svelte-fhkgy");
			add_location(i0, file$3, 88, 116, 1553);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-fhkgy");
			add_location(a0, file$3, 88, 8, 1445);
			attr(span1, "class", "svelte-fhkgy");
			add_location(span1, file$3, 89, 149, 1771);
			attr(i1, "class", "fab fa-linkedin svelte-fhkgy");
			add_location(i1, file$3, 89, 122, 1744);
			...
			attr(a1, "class", "svelte-fhkgy");
			add_location(a1, file$3, 89, 8, 1630);
			attr(span2, "class", "svelte-fhkgy");
			add_location(span2, file$3, 90, 145, 1964);
			attr(i2, "class", "fas fa-envelope svelte-fhkgy");
			add_location(i2, file$3, 90, 118, 1937);
			...
			attr(a2, "class", "svelte-fhkgy");
			add_location(a2, file$3, 90, 8, 1827);
			attr(div0, "class", "social-container svelte-fhkgy");
			add_location(div0, file$3, 87, 4, 1406);
			attr(div1, "class", "svelte-fhkgy");
			add_location(div1, file$3, 83, 0, 1361);
		},
