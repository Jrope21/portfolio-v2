...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "svelte-yic1qf");
			add_location(h1, file, 142, 8, 2903);
			attr(div0, "class", div0_class_value = "title-container " + ctx.sidePage + " svelte-yic1qf");
			add_location(div0, file, 141, 4, 2854);
			attr(div1, "class", "page-header container svelte-yic1qf");
		...
		p: function update(changed, ctx) {
			...
			if ((changed.sidePage) && div0_class_value !== (div0_class_value = "title-container " + ctx.sidePage + " svelte-yic1qf")) {
