...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-s8boq3");
			add_location(img, file$3, 153, 20, 2984);
			attr(div, "class", "slide svelte-s8boq3");
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-s8boq3");
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-s8boq3")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-s8boq3");
			add_location(span, file$3, 148, 21, 2662);
			attr(div0, "class", "box svelte-s8boq3");
			add_location(div0, file$3, 148, 4, 2645);
			attr(div1, "class", "circles-container svelte-s8boq3");
			add_location(div1, file$3, 157, 4, 3080);
			attr(div2, "class", "carousel-container svelte-s8boq3");
