...
import { I as Image } from './Image.3ebbea2a.js';
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "grid-element-container svelte-19vlwek");
			add_location(div0, file, 40, 4, 695);
			attr(div1, "class", "grid-element-container svelte-19vlwek");
			add_location(div1, file, 43, 4, 844);
			attr(div2, "class", "grid-element-container svelte-19vlwek");
			add_location(div2, file, 46, 4, 993);
			attr(div3, "class", "grid-element-container svelte-19vlwek");
			add_location(div3, file, 49, 4, 1142);
			attr(div4, "class", "grid-element-container full-width svelte-19vlwek");
			add_location(div4, file, 52, 4, 1291);
			attr(div5, "class", "image-grid svelte-19vlwek");
