...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1v6g00h");
			add_location(img, file$3, 150, 20, 2983);
			attr(div, "class", "slide svelte-1v6g00h");
			add_location(div, file$3, 149, 16, 2898);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1v6g00h");
			add_location(span, file$3, 156, 12, 3162);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1v6g00h")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-1v6g00h");
			add_location(span, file$3, 145, 21, 2661);
			attr(div0, "class", "box svelte-1v6g00h");
			add_location(div0, file$3, 145, 4, 2644);
			attr(div1, "class", "circles-container svelte-1v6g00h");
			add_location(div1, file$3, 154, 4, 3079);
			attr(div2, "class", "carousel-container svelte-1v6g00h");
			add_location(div2, file$3, 144, 0, 2607);
		},
