...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(section0, "class", "project-description svelte-18rlied");
			add_location(section0, file, 136, 16, 4109);
			attr(section1, "class", "skills-container svelte-18rlied");
			add_location(section1, file, 139, 16, 4271);
			attr(a, "href", a_href_value = ctx.STATE.url);
			attr(a, "target", "blank");
			attr(a, "class", "svelte-18rlied");
			add_location(a, file, 143, 20, 4443);
			attr(section2, "class", "cta svelte-18rlied");
			add_location(section2, file, 142, 16, 4401);
			attr(div0, "class", "inner-container svelte-18rlied");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "project-detail svelte-18rlied");
