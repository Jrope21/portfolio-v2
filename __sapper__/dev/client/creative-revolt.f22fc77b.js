...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-exqja5");
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-exqja5")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-exqja5");
			add_location(span, file$1, 280, 0, 5102);
			attr(div0, "class", "box svelte-exqja5");
			add_location(div0, file$1, 281, 4, 5149);
			attr(div1, "class", "circles-container svelte-exqja5");
			add_location(div1, file$1, 292, 4, 5689);
			attr(div2, "class", "carousel-container svelte-exqja5");
