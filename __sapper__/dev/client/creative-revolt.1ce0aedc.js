...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$2, 54, 8, 1330);
			attr(section, "class", "container");
			add_location(section, file$2, 57, 8, 1383);
		},
