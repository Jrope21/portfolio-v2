...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-w0hv77");
			add_location(div0, file$3, 58, 4, 903);
			attr(img, "src", "images/Jorden-Background-Gray.jpg");
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-w0hv77");
			add_location(img, file$3, 60, 8, 959);
			attr(div1, "class", "slide svelte-w0hv77");
			add_location(div1, file$3, 59, 4, 931);
			attr(div2, "class", "carousel-container svelte-w0hv77");
			add_location(div2, file$3, 57, 0, 866);
		},
