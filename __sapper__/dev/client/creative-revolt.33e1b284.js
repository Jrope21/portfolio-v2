...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-7t5a34");
			add_location(img, file$3, 150, 20, 2981);
			attr(div, "class", "slide svelte-7t5a34");
			add_location(div, file$3, 149, 16, 2896);
		},
...
// (148:8) {#each STATE.images as img}
...
// (156:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-7t5a34");
			add_location(span, file$3, 156, 12, 3160);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-7t5a34")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-7t5a34");
			add_location(span, file$3, 145, 21, 2659);
			attr(div0, "class", "box svelte-7t5a34");
			add_location(div0, file$3, 145, 4, 2642);
			attr(div1, "class", "circles-container svelte-7t5a34");
			add_location(div1, file$3, 154, 4, 3077);
			attr(div2, "class", "carousel-container svelte-7t5a34");
			add_location(div2, file$3, 144, 0, 2605);
		},
