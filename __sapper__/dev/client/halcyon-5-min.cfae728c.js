...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h2, "class", "svelte-6hy4db");
			add_location(h2, file$1, 125, 4, 3026);
			attr_dev(span, "class", "year svelte-6hy4db");
			add_location(span, file$1, 127, 8, 3065);
			html_tag = new HtmlTag(null);
			attr_dev(p, "class", "svelte-6hy4db");
			add_location(p, file$1, 126, 4, 3053);
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", /*url*/ ctx[1]);
			attr_dev(a, "class", "svelte-6hy4db");
			add_location(a, file$1, 130, 4, 3146);
			attr_dev(div, "class", "svelte-6hy4db");
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h2, "class", "svelte-1reaay7");
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-1reaay7");
			add_location(div0, file$2, 161, 16, 3791);
			attr_dev(div1, "class", "text-container svelte-1reaay7");
			add_location(div1, file$2, 170, 16, 4156);
			attr_dev(div2, "class", "card-container svelte-1reaay7");
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "projects-container svelte-1reaay7");
			add_location(div, file$2, 158, 4, 3647);
			attr_dev(section, "class", "svelte-1reaay7");
