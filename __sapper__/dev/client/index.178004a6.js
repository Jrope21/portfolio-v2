...
function create_fragment$4(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "class", "svelte-8juqis");
			add_location(h2, file$4, 78, 4, 1543);
			attr(span, "class", "year svelte-8juqis");
			add_location(span, file$4, 80, 8, 1582);
			html_tag = new HtmlTag(ctx.projectText, null);
			attr(p, "class", "svelte-8juqis");
			add_location(p, file$4, 79, 4, 1570);
			attr(a, "href", ctx.url);
			attr(a, "class", "svelte-8juqis");
			add_location(a, file$4, 83, 4, 1663);
			add_location(div, file$4, 77, 0, 1533);
		},
