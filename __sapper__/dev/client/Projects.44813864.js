...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h2, "class", "svelte-gwn4on");
			add_location(h2, file$2, 132, 8, 3455);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-gwn4on");
			add_location(div0, file$2, 138, 16, 3635);
			attr_dev(div1, "class", "text-container svelte-gwn4on");
			add_location(div1, file$2, 141, 16, 3785);
			attr_dev(div2, "class", "card-container svelte-gwn4on");
			attr_dev(div2, "index", div2_index_value = /*index*/ ctx[4]);
			add_location(div2, file$2, 137, 12, 3582);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "projects-container svelte-gwn4on");
			add_location(div, file$2, 135, 4, 3491);
			attr_dev(section, "class", "svelte-gwn4on");
			add_location(section, file$2, 130, 0, 3421);
		},
		m: function mount(target, anchor) {
