...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-50gf4k");
			add_location(h3, file$3, 119, 4, 3016);
			attr(span0, "class", "svelte-50gf4k");
			add_location(span0, file$3, 123, 141, 3223);
			attr(i0, "class", "fab fa-github svelte-50gf4k");
			add_location(i0, file$3, 123, 116, 3198);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-50gf4k");
			add_location(a0, file$3, 123, 8, 3090);
			attr(span1, "class", "svelte-50gf4k");
			add_location(span1, file$3, 124, 149, 3416);
			attr(i1, "class", "fab fa-linkedin svelte-50gf4k");
			add_location(i1, file$3, 124, 122, 3389);
			...
			attr(a1, "class", "svelte-50gf4k");
			add_location(a1, file$3, 124, 8, 3275);
			attr(span2, "class", "svelte-50gf4k");
			add_location(span2, file$3, 125, 145, 3609);
			attr(i2, "class", "fas fa-envelope svelte-50gf4k");
			add_location(i2, file$3, 125, 118, 3582);
			...
			attr(a2, "class", "svelte-50gf4k");
			add_location(a2, file$3, 125, 8, 3472);
			attr(div0, "class", "social-container svelte-50gf4k");
			add_location(div0, file$3, 122, 4, 3051);
			attr(div1, "class", "svelte-50gf4k");
			add_location(div1, file$3, 118, 0, 3006);
		},
