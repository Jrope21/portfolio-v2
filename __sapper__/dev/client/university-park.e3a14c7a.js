...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			a = claim_element(section2_nodes, "A", { href: true, target: true }, false);
