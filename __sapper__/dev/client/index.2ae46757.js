import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, T as TextAnimation, y as query_selector_all } from './client.a672ad62.js';
import { P as Projects } from './Projects.277cf843.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-bxlt42");
			add_location(img, file$3, 177, 8, 4646);
			attr_dev(div0, "class", "image-container svelte-bxlt42");
			add_location(div0, file$3, 176, 4, 4608);
			attr_dev(h2, "class", "heading svelte-bxlt42");
			add_location(h2, file$3, 180, 8, 4751);
			attr_dev(h3, "class", "subheading svelte-bxlt42");
			add_location(h3, file$3, 181, 8, 4825);
			attr_dev(p, "class", "svelte-bxlt42");
			add_location(p, file$3, 182, 8, 4899);
			attr_dev(a, "class", "button svelte-bxlt42");
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "");
			add_location(a, file$3, 188, 8, 5503);
			attr_dev(div1, "class", "text-content svelte-bxlt42");
			add_location(div1, file$3, 179, 4, 4716);
			attr_dev(section, "class", "text-with-image-cta svelte-bxlt42");
