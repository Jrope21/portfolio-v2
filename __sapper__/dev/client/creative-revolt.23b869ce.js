...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-2trdip");
			add_location(img, file$3, 147, 20, 2877);
			attr(div, "class", "slide svelte-2trdip");
			add_location(div, file$3, 146, 16, 2792);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-2trdip");
			add_location(span, file$3, 153, 12, 3056);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-2trdip")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-2trdip");
			add_location(span, file$3, 142, 21, 2555);
			attr(div0, "class", "box svelte-2trdip");
			add_location(div0, file$3, 142, 4, 2538);
			attr(div1, "class", "circles-container svelte-2trdip");
			add_location(div1, file$3, 151, 4, 2973);
			attr(div2, "class", "carousel-container svelte-2trdip");
			add_location(div2, file$3, 141, 0, 2501);
		},
