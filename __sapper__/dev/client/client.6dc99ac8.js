...
function create_if_block$4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file$b, 50, 1, 1549);
		},
		m: function mount(target, anchor) {
...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-kwe5ds");
			add_location(h1, file$b, 42, 1, 1420);
			attr_dev(h2, "class", "svelte-kwe5ds");
			add_location(h2, file$b, 43, 1, 1437);
			attr_dev(div, "class", "text-container container svelte-kwe5ds");
			add_location(div, file$b, 41, 0, 1380);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.a9197be6.js'), __inject_styles(["client-9ccc0d14.css","halcyon-5-min-9ec22285.css","index-f9894ff4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./experience.fd8e2d61.js'), __inject_styles(["client-9ccc0d14.css","experience-7af911e7.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./creative-revolt.cc559aa1.js'), __inject_styles(["client-9ccc0d14.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css","creative-revolt-387c384c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./university-park.861bb2c7.js'), __inject_styles(["client-9ccc0d14.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./di-repairs.567b168b.js'), __inject_styles(["client-9ccc0d14.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./stallion.715691e6.js'), __inject_styles(["client-9ccc0d14.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./halcyon.a6233b71.js'), __inject_styles(["client-9ccc0d14.css","PageTitle-fbf706b4.css","ProjectDetailTemplate-bae8ddb4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./projects.f83a51a8.js'), __inject_styles(["client-9ccc0d14.css","halcyon-5-min-9ec22285.css","PageTitle-fbf706b4.css","projects-61f9fec4.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./about.6f3c6666.js'), __inject_styles(["client-9ccc0d14.css","about-3acc9d53.css"])]).then(function(x) { return x[0]; })
	}
];
