...
import { a as fade } from './index.bae9a061.js';
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1wpvgli");
			add_location(img, file$3, 102, 20, 1909);
			attr(div, "class", "slide svelte-1wpvgli");
			add_location(div, file$3, 100, 16, 1841);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1wpvgli");
			add_location(span, file$3, 108, 12, 2078);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1wpvgli")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "box svelte-1wpvgli");
			add_location(div0, file$3, 97, 4, 1735);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 106, 4, 2005);
			attr(div2, "class", "carousel-container svelte-1wpvgli");
			add_location(div2, file$3, 96, 0, 1698);
		},
