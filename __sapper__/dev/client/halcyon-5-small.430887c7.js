...
function create_else_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img0, file$1, 95, 8, 2969);
			...
			add_location(img1, file$1, 100, 8, 3125);
			attr_dev(div, "class", "progressive-image svelte-1tkh93z");
			add_location(div, file$1, 94, 4, 2929);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, img0);
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$1, 82, 12, 2602);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$1, 74, 12, 2401);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
