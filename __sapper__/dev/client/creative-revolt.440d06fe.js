...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 95, 20, 1779);
			attr(div, "class", "slide svelte-1rkoq0s");
			add_location(div, file$3, 94, 16, 1739);
		},
...
// (104:8) {#each STATE.images as img, i}
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 104, 12, 2071);
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$3, 91, 4, 1633);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 102, 4, 1998);
			attr(div2, "class", "carousel-container svelte-1rkoq0s");
			add_location(div2, file$3, 90, 0, 1596);
		},
