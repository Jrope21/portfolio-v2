import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.667d22af.js';
import { P as Projects } from './Projects.57fa98c3.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-placeholder");
			add_location(div0, file$3, 15, 4, 218);
			add_location(h2, file$3, 19, 8, 305);
			attr_dev(h3, "class", "subheading");
			add_location(h3, file$3, 20, 8, 354);
			add_location(br, file$3, 22, 287, 701);
			add_location(p, file$3, 21, 8, 410);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn");
			add_location(a, file$3, 25, 8, 974);
			attr_dev(div1, "class", "text-content");
			add_location(div1, file$3, 18, 4, 270);
			attr_dev(section, "class", "text-with-image-cta svelte-1900opr");
			add_location(section, file$3, 14, 0, 176);
		},
		m: function mount(target, anchor) {
