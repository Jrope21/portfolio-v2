import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, c as claim_element, a as children, b as detach_dev, f as attr_dev, g as add_location, h as insert_dev, j as append_dev, n as noop, t as text, k as space, l as claim_text, m as claim_space, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component, y as query_selector_all } from './client.6ea14479.js';
import { P as Projects } from './Projects.729bfe6a.js';
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "image-container svelte-16r6stm");
			add_location(div0, file$3, 108, 4, 3022);
			attr_dev(h2, "class", "heading svelte-16r6stm");
			add_location(h2, file$3, 112, 8, 3107);
			attr_dev(h3, "class", "subheading svelte-16r6stm");
			add_location(h3, file$3, 113, 8, 3181);
			attr_dev(br0, "class", "svelte-16r6stm");
			add_location(br0, file$3, 115, 287, 3546);
			attr_dev(br1, "class", "svelte-16r6stm");
			add_location(br1, file$3, 115, 293, 3552);
			attr_dev(p, "class", "svelte-16r6stm");
			add_location(p, file$3, 114, 8, 3255);
			attr_dev(a, "href", "");
			attr_dev(a, "class", "btn svelte-16r6stm");
			add_location(a, file$3, 118, 8, 3825);
			attr_dev(div1, "class", "text-content svelte-16r6stm");
			add_location(div1, file$3, 111, 4, 3072);
			attr_dev(section, "class", "text-with-image-cta svelte-16r6stm");
			add_location(section, file$3, 107, 0, 2980);
		},
		m: function mount(target, anchor) {
