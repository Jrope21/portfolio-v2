	...
	return {
		...
		i: function intro(local) {
			...
			add_render_callback(() => {
				...
				if (!div1_intro) div1_intro = create_in_transition(div1, fly, { x: -40, duration: 500, delay: 400, });
				div1_intro.start();
			});
			...
			add_render_callback(() => {
				...
				if (!div2_intro) div2_intro = create_in_transition(div2, fly, { x: -40, duration: 500, delay: 600, });
				div2_intro.start();
			});
