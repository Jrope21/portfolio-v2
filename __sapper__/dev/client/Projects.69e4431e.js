...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1kzwkqs");
			add_location(img, file, 109, 6, 2966);
			attr_dev(div, "class", "img-container svelte-1kzwkqs");
			add_location(div, file, 108, 4, 2932);
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*width*/ ctx[3]) + " svelte-1kzwkqs"));
			attr_dev(a, "href", /*url*/ ctx[2]);
			add_location(a, file, 107, 0, 2882);
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*width*/ 8 && a_class_value !== (a_class_value = "" + (null_to_empty(/*width*/ ctx[3]) + " svelte-1kzwkqs"))) {
