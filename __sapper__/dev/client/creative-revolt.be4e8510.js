...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-dmd0cz");
			add_location(img, file$3, 154, 20, 3019);
			attr(div, "class", "slide svelte-dmd0cz");
			add_location(div, file$3, 153, 16, 2934);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-dmd0cz");
			add_location(span, file$3, 160, 12, 3198);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-dmd0cz")) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-dmd0cz");
			add_location(span, file$3, 149, 21, 2697);
			attr(div0, "class", "box svelte-dmd0cz");
			add_location(div0, file$3, 149, 4, 2680);
			attr(div1, "class", "circles-container svelte-dmd0cz");
			add_location(div1, file$3, 158, 4, 3115);
			attr(div2, "class", "carousel-container svelte-dmd0cz");
			add_location(div2, file$3, 148, 0, 2643);
		},
