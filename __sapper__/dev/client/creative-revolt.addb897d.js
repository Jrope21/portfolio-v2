...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 99, 20, 1826);
			attr(div, "class", "slide svelte-1rkoq0s");
			add_location(div, file$3, 98, 16, 1786);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 108, 12, 2118);
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$3, 95, 4, 1680);
			attr(div1, "class", "circles");
			add_location(div1, file$3, 106, 4, 2045);
			attr(div2, "class", "carousel-container svelte-1rkoq0s");
			add_location(div2, file$3, 94, 0, 1643);
		},
