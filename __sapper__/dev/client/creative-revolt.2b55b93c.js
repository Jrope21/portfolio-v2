...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "alt", "wassup");
			attr(img, "class", "svelte-1a9ivue");
			add_location(img, file$1, 267, 20, 5202);
			attr(div, "class", "slide svelte-1a9ivue");
			add_location(div, file$1, 266, 16, 5117);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1a9ivue");
			add_location(span, file$1, 273, 12, 5381);
		...
		p: function update(changed, new_ctx) {
			ctx = new_ctx;
			if ((changed.STATE) && span_class_value !== (span_class_value = "circle " + (ctx.img.visible ? 'active' : '') + " svelte-1a9ivue")) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "title svelte-1a9ivue");
			add_location(span, file$1, 261, 0, 4815);
			attr(div0, "class", "box svelte-1a9ivue");
			add_location(div0, file$1, 262, 4, 4862);
			attr(div1, "class", "circles-container svelte-1a9ivue");
			add_location(div1, file$1, 271, 4, 5298);
			attr(div2, "class", "carousel-container svelte-1a9ivue");
			add_location(div2, file$1, 260, 0, 4782);
		},
