...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-ipejgv");
			add_location(h3, file$3, 90, 4, 1598);
			attr(span0, "class", "svelte-ipejgv");
			add_location(span0, file$3, 94, 141, 1805);
			attr(i0, "class", "fab fa-github svelte-ipejgv");
			add_location(i0, file$3, 94, 116, 1780);
			attr(a0, "href", "https://www.github.com/Jrope21");
			attr(a0, "aria-label", "link to Joshua Roper's GitHub account");
			attr(a0, "target", "blank");
			attr(a0, "class", "svelte-ipejgv");
			add_location(a0, file$3, 94, 8, 1672);
			attr(span1, "class", "svelte-ipejgv");
			add_location(span1, file$3, 95, 149, 1998);
			attr(i1, "class", "fab fa-linkedin svelte-ipejgv");
			add_location(i1, file$3, 95, 122, 1971);
			...
			attr(a1, "class", "svelte-ipejgv");
			add_location(a1, file$3, 95, 8, 1857);
			attr(span2, "class", "svelte-ipejgv");
			add_location(span2, file$3, 96, 145, 2191);
			attr(i2, "class", "fas fa-envelope svelte-ipejgv");
			add_location(i2, file$3, 96, 118, 2164);
			...
			attr(a2, "class", "svelte-ipejgv");
			add_location(a2, file$3, 96, 8, 2054);
			attr(div0, "class", "social-container svelte-ipejgv");
			add_location(div0, file$3, 93, 4, 1633);
			attr(div1, "class", "svelte-ipejgv");
			add_location(div1, file$3, 89, 0, 1588);
		},
