...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "class", "svelte-3gjht");
			add_location(h3, file$1, 100, 4, 2608);
			attr(strong0, "class", "svelte-3gjht");
			add_location(strong0, file$1, 104, 43, 2691);
			attr(strong1, "class", "svelte-3gjht");
			add_location(strong1, file$1, 105, 12, 2780);
			attr(strong2, "class", "svelte-3gjht");
			add_location(strong2, file$1, 106, 30, 2922);
			attr(strong3, "class", "svelte-3gjht");
			add_location(strong3, file$1, 107, 28, 3001);
			attr(strong4, "class", "svelte-3gjht");
			add_location(strong4, file$1, 108, 30, 3121);
			attr(p, "class", "svelte-3gjht");
			add_location(p, file$1, 103, 4, 2644);
			attr(div, "class", "svelte-3gjht");
			add_location(div, file$1, 99, 0, 2598);
		},
