...
const css$8 = {
	code: "section.titles.svelte-1yq41gd{margin-bottom:40rem;top:230px}@media screen and (min-width: 40em){section.titles.svelte-1yq41gd{margin-bottom:60rem;position:-webkit-sticky;position:sticky}}@media(min-width: 64em){section.titles.svelte-1yq41gd{top:250px}}h1.svelte-1yq41gd{color:#3B3B3B;font-weight:800;font-size:23px}h2.svelte-1yq41gd{color:#3B3B3B;font-weight:800;font-size:18px;margin-bottom:5px;margin-top:-3px;opacity:.85}h3.svelte-1yq41gd{display:flex;align-items:center;font-size:14px;font-weight:400;opacity:.8;margin-bottom:15px}h3.svelte-1yq41gd::before{content:'';display:block;width:30px;border-bottom:3px solid black;margin-right:10px;opacity:.8}@media screen and (min-width: 40em) and (max-width: 64em){h1.svelte-1yq41gd{font-size:21px}h2.svelte-1yq41gd{font-size:16px;margin-bottom:7px}h3.svelte-1yq41gd{font-size:12px}}@media screen and (min-width: 64em){h1.svelte-1yq41gd{font-size:28px}h2.svelte-1yq41gd{font-size:22px;margin-bottom:7px}h3.svelte-1yq41gd{margin-bottom:0}}",
	map: "{\"version\":3,\"file\":\"LogoText.svelte\",\"sources\":[\"LogoText.svelte\"],\"sourcesContent\":[\"<script>\\nexport let addClass;\\n</script>\\n\\n<style>\\nsection.titles {\\n    margin-bottom: 40rem;\\n    top: 230px;\\n}\\n\\n@media screen and (min-width: 40em) {\\n    section.titles {\\n        margin-bottom: 60rem;\\n        position: -webkit-sticky;\\n        position: sticky;\\n    }\\n}\\n\\n@media (min-width: 64em) {\\n    section.titles {\\n        top: 250px;\\n    }\\n}\\n\\nh1 {\\n    color:#3B3B3B;\\n    font-weight: 800;\\n    font-size: 23px;\\n}\\nh2 {\\n    color:#3B3B3B;\\n    font-weight: 800;\\n    font-size: 18px;\\n    margin-bottom: 5px;\\n    margin-top: -3px;\\n    opacity: .85;\\n}\\n\\nh3 {\\n    display: flex;\\n    align-items: center;\\n    font-size: 14px;\\n    font-weight: 400;\\n    opacity: .8;\\n    margin-bottom: 15px;\\n}\\n\\nh3::before {\\n    content: '';\\n    display: block;\\n    width: 30px;\\n    border-bottom: 3px solid black;\\n    margin-right: 10px;\\n    opacity: .8;\\n}\\n\\n @media screen and (min-width: 40em) and (max-width: 64em){\\n    h1 {\\n        font-size: 21px;\\n        \\n    }\\n    h2 {\\n        font-size: 16px;\\n        margin-bottom: 7px;\\n    }\\n    h3 {\\n        font-size: 12px;\\n    }\\n}\\n\\n@media screen and (min-width: 64em) {\\n    h1 {\\n        font-size: 28px;\\n    }\\n    h2 {\\n        font-size: 22px;\\n        margin-bottom: 7px;\\n    }\\n    h3 {\\n        margin-bottom: 0;\\n    }\\n}\\n\\n</style>\\n\\n<section class=\\\"titles {addClass}\\\">\\n    <h1>Front End Developer</h1>\\n    <h2>React, Svelte, ES6</h2>\\n    <h3>Joshua Roper</h3>\\n</section>\"],\"names\":[],\"mappings\":\"AAKA,OAAO,OAAO,eAAC,CAAC,AACZ,aAAa,CAAE,KAAK,CACpB,GAAG,CAAE,KAAK,AACd,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACjC,OAAO,OAAO,eAAC,CAAC,AACZ,aAAa,CAAE,KAAK,CACpB,QAAQ,CAAE,cAAc,CACxB,QAAQ,CAAE,MAAM,AACpB,CAAC,AACL,CAAC,AAED,MAAM,AAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACtB,OAAO,OAAO,eAAC,CAAC,AACZ,GAAG,CAAE,KAAK,AACd,CAAC,AACL,CAAC,AAED,EAAE,eAAC,CAAC,AACA,MAAM,OAAO,CACb,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,IAAI,AACnB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,MAAM,OAAO,CACb,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,IAAI,CACf,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,GAAG,AAChB,CAAC,AAED,EAAE,eAAC,CAAC,AACA,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,OAAO,CAAE,EAAE,CACX,aAAa,CAAE,IAAI,AACvB,CAAC,AAED,iBAAE,QAAQ,AAAC,CAAC,AACR,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CAC9B,YAAY,CAAE,IAAI,CAClB,OAAO,CAAE,EAAE,AACf,CAAC,AAEA,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,CAAC,AACvD,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,IAAI,AAEnB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,IAAI,CACf,aAAa,CAAE,GAAG,AACtB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,IAAI,AACnB,CAAC,AACL,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,IAAI,CAAC,AAAC,CAAC,AACjC,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,IAAI,AACnB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,SAAS,CAAE,IAAI,CACf,aAAa,CAAE,GAAG,AACtB,CAAC,AACD,EAAE,eAAC,CAAC,AACA,aAAa,CAAE,CAAC,AACpB,CAAC,AACL,CAAC\"}"
};
...
const LogoText = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="titles ${escape(addClass)} svelte-1yq41gd">
	    <h1 class="svelte-1yq41gd">Front End Developer</h1>
	    <h2 class="svelte-1yq41gd">React, Svelte, ES6</h2>
	    <h3 class="svelte-1yq41gd">Joshua Roper</h3>
	</section>`;
});
