...
var index$1 = require('./index-6e16b4a2.js');
var TextAnimation = require('./TextAnimation-f1c2c735.js');
var experience = require('./experience-e2c2643d.js');
require('./ProjectDetailTemplate-152f2abe.js');
var creativeRevolt = require('./creative-revolt-f525fad2.js');
var universityPark = require('./university-park-c7964c77.js');
var stallion = require('./stallion-aae836f4.js');
var halcyon = require('./halcyon-ec5714a4.js');
var about = require('./about-f49f153a.js');
...
const components = [
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-6e16b4a2.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:index.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./experience-e2c2643d.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:experience.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./creative-revolt-f525fad2.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:projects/creative-revolt.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./university-park-c7964c77.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:projects/university-park.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./stallion-aae836f4.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:projects/stallion.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./halcyon-ec5714a4.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:projects/halcyon.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./about-f49f153a.js')); }),
...
const GoogleAnalytics = index.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    const { page } = stores(); $page = index.get_store_value(page);
	...
	return `${($$result.head += `<script async src="https://www.googletagmanager.com/gtag/js?id=${index.escape(id)}"></script>`, "")}`;
});
