...
let STATE = {
	...
	return `<div class="carousel-container svelte-1deq7s0">
	    <div class="box svelte-1deq7s0"></div> 
	        ${each(STATE.images, (img) => `${ img.visible ? `<div class="slide svelte-1deq7s0">
	                    <button aria-label="a button that shows the previous image in the carousel" class="back svelte-1deq7s0">
	                        <span class="arrow-left svelte-1deq7s0"></span>
	                    </button>
	                    <img${add_attribute("src", img.src, 0)}${add_attribute("alt", img.alt, 0)} class="svelte-1deq7s0">
	                    <button aria-label="a button that shows the next image in the carousel" class="next svelte-1deq7s0">
	                        <span class="arrow-right svelte-1deq7s0"></span>
	                    </button>
	                </div>` : `` }`)}
	    <div class="circles-container svelte-1deq7s0">
	        ${each(STATE.images, (img, i) => `<span class="circle ${escape(img.visible ? 'active' : '')} svelte-1deq7s0" aria-label="a button to go to a specific image in the carousel"></span>`)}
	    </div>
	</div>`;
});
